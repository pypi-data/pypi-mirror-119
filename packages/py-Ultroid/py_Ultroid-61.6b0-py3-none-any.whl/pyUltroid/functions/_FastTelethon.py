...
class ParallelTransferrer:
    ...
    def _get_connection_count(
        ...
        if file_size > (50 * (1024 ** 2)): # return 25 max connections if file size >= 100MB
            return 25
        return math.ceil((file_size / full_size) * 25)
    ...
    async def init_upload(
        ...
        is_large = file_size > 10 * (1024 ** 2) # return InputFileBig if file size >= 10MB
