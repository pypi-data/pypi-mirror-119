...
from unacastclient.unacast.maps.v1 import AddressComponentFilter
...
class Filter(object):
    ...
    def with_address_component(self, component: str, value: str):
        component_filter: AddressComponentFilter = AddressComponentFilter(component=component, values=[value])
