...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp-scaffold', '0.1.1-alpha.1631305125+c65c922b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp-scaffold 0.1.1-alpha.1631305125+c65c922b`
                """)
            else:
                raise
