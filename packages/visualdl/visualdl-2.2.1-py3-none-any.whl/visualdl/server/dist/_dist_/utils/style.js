import*as a from"../../__snowpack__/pkg/polished.js";import{colors as n,variables as m}from"./theme.js";import{createGlobalStyle as f,keyframes as x}from"../../__snowpack__/pkg/styled-components.js";import{css as b}from"../../__snowpack__/pkg/styled-components.js";export*from"../../__snowpack__/pkg/styled-components.js";export*from"../../__snowpack__/pkg/polished.js";export{borderRadius as borderRadiusShortHand,borderColor as borderColorShortHand,fontFace as fontFaceShortHand}from"../../__snowpack__/pkg/polished.js";const{math:g,size:c,normalize:v,transitions:u,border:y,position:s}=a,i="14px";export const rem=o=>a.rem(o,i),em=(o,r)=>a.em(o,r||i),half=o=>g(`(${o}) / 2`),headerHeight=rem(60),contentMargin=rem(20),contentHeight=`calc(100vh - ${g(`${contentMargin} * 2 + ${headerHeight}`)})`,asideWidth=rem(260),borderRadius="4px",progressSpinnerSize="20px",zIndexes={progress:99999,toast:9e4,tooltip:8e4,component:3e4,dialog:2e4,header:1e4},primaryColor=n.primary.default,primaryFocusedColor=n.primary.focused,primaryActiveColor=n.primary.active,duration="75ms",easing="ease-in",sameBorder=(o="1px",r="solid",t="var(--border-color)",e)=>{var p,l,d;return typeof o=="object"?(r=(p=o.type)!=null?p:"solid",t=(l=o.color)!=null?l:"var(--border-color)",e=o.radius===!0?borderRadius:o.radius,o=(d=o.width)!=null?d:"1px"):o===!0&&(o="1px",e=!0),Object.assign({},y(o,r,t),e?{borderRadius:e===!0?borderRadius:e}:void 0)},transitionProps=(o,r)=>{var t,e;return typeof o=="string"&&(o=[o]),typeof r!="string"&&(r=`${(t=r==null?void 0:r.duration)!=null?t:duration} ${(e=r==null?void 0:r.easing)!=null?e:easing}`),u(o,r)},link=b`
    a {
