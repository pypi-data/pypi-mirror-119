"""
demo_ARMA: Module for learning about  ARMA_class processes

This module provides a single function, ARMA_demo(), which creates a dash consisting of 7 plots to study the
theoretical properties of ARMA_class(p, q) process, as well as their estimated counterparts. The plots display
...
# Esta función se utiliza para calcular la varianza del proceso ARMA_class
...
class ARMA(ArmaProcess):
    """
    A class to represent stationary ARMA_class processes
    """
...
app.layout = html.Div(children=[
    html.H2("The ARMA_class model",
            style={'textAlign': 'center', 'color': colors['text']}),
    html.Div(children=[html.H4("ARMA_class Parameters"),
                       html.Table(children=[
                       ...
                       html.P('ARMA_class PROCESS DEMO', style={'textAlign': 'center', 'color': colors['text'],'marginTop':500}),
                       ],
