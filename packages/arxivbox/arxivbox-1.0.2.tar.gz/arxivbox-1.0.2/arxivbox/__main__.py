...
app.layout = dbc.Container([html.Br(),
    ...
    dbc.Tooltip('Show marked publications', target="check-all"),
    dbc.Tooltip('Select conference name',target="select"),
    dbc.Tooltip('Select maximum results',target="select_max"),
    dbc.Tooltip('Select matching algorithm',target="select_option"),
    dbc.Tooltip('Sort by', target="select_sort"),
    dbc.Tooltip('Show results based on code availability', target="code_option"),
