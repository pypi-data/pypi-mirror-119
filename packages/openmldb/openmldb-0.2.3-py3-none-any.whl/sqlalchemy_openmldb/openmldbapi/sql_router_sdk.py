...
class SQLRouterOptions(object):
    ...
    enable_debug = property(_sql_router_sdk.SQLRouterOptions_enable_debug_get, _sql_router_sdk.SQLRouterOptions_enable_debug_set)
    ...
    max_sql_cache_size = property(_sql_router_sdk.SQLRouterOptions_max_sql_cache_size_get, _sql_router_sdk.SQLRouterOptions_max_sql_cache_size_set)
    request_timeout = property(_sql_router_sdk.SQLRouterOptions_request_timeout_get, _sql_router_sdk.SQLRouterOptions_request_timeout_set)
...
class SQLRouter(object):
    ...
    def ExecuteSQL(self, db: "std::string const &", sql: "std::string const &", status: "Status") -> "std::shared_ptr< hybridse::sdk::ResultSet >":
        return _sql_router_sdk.SQLRouter_ExecuteSQL(self, db, sql, status)
...
def ConvertType(type: "::openmldb::type::DataType") -> "::hybridse::sdk::DataType":
    return _sql_router_sdk.ConvertType(type)
class SQLInsertRow(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, table_info: "std::shared_ptr< ::openmldb::nameserver::TableInfo >", schema: "std::shared_ptr< hybridse::sdk::Schema >", default_map: "openmldb::sdk::DefaultValueMap", default_str_length: "uint32_t"):
    ...
    def GetHoleIdx(self) -> "std::vector< uint32_t,std::allocator< uint32_t > > const":
...
class SQLInsertRows(object):
    ...
    def __init__(self, table_info: "std::shared_ptr< ::openmldb::nameserver::TableInfo >", schema: "std::shared_ptr< hybridse::sdk::Schema >", default_map: "openmldb::sdk::DefaultValueMap", str_size: "uint32_t"):
...
class ScanOption(object):
    ...
    at_least = property(_sql_router_sdk.ScanOption_at_least_get, _sql_router_sdk.ScanOption_at_least_set)
