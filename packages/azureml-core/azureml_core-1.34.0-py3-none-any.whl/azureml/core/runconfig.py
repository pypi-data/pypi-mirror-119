...
class Uri(_AbstractRunConfigElement):
    ...
    def _validate(self):
        if not self.path:
            raise UserErrorException("The Uri path can not be empty")
...
class RunConfiguration(_AbstractRunConfigElement):
    ...
    :var environment_variables: Runtime environment variables.
    ...
    _field_to_info_dict = collections.OrderedDict([
        ...
        ("environment_variables", _FieldInfo(dict, "Runtime environment variables",
