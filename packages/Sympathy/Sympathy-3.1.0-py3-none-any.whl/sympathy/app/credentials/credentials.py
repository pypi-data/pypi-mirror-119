...
class SettingsCredential:
    ...
    def edit_credentials_secrets(
            cls,
            credentials: List['SettingsCredentials'],
            secrets: dict) -> List['SettingsCredentials']:
        """
    ...
    def request_connection(self, connection: Connection
        ...
        if ok:
            ...
            if credentials_info:
                ...
                if credentials:
                    res = cls.credentials_secrets(stored_credentials)
        return ok, res
    ...
    def configure_connection(self, connection: Connection,
        ...
        if ok:
            ...
            if credentials_info:
                ...
                res = cls.credentials_configuration(credentials)
        return ok, res
