...
class WaitForData(QtCore.QObject):
    ...
    def __init__(self, socket_bundle, parent=None):
        ...
        self._comm = self._socket_bundle.reader
...
class LabelParameterWidget(NullParametersWidgetMixin, QtWidgets.QLabel):
    pass


class TabParameterWidget(NullParametersWidgetMixin, QtWidgets.QTabWidget):
    current_widget_changed = QtCore.Signal(QtWidgets.QWidget)
...
class FailedParameterWidget(NullParametersWidgetMixin, QtWidgets.QWidget):
    def __init__(self, parent=None):
