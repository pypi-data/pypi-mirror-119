...
@dataclasses.dataclass(frozen=True)
class AdditionalSparkProperties:
    """Map of Spark properties for the cluster."""
    
    @classmethod
    def json_schema(cls):
        """Return the JSON schema for AdditionalSparkProperties data.
    ...
    def from_json(cls, data: dict):
        """Validate and parse JSON data into an instance of AdditionalSparkProperties.
        
        Args:
            data (dict): JSON data to validate and parse.
        
        Returns:
            An instance of AdditionalSparkProperties.
        ...
        try:
            jsonschema.validate(data, cls.json_schema())
            return AdditionalSparkProperties(
                
            )
        except jsonschema.exceptions.ValidationError as ex:
            logging.debug(
                "Invalid JSON data received while parsing AdditionalSparkProperties",
                exc_info=ex
            )
            raise
...
class SparkConfig:
    ...
    Args:
        ...
        additionalSparkProperties (AdditionalSparkProperties): A data field.
    """
    ...
    def json_schema(cls):
        ...
        return {
            ...
            "properties": {
                ...
                "additionalSparkProperties": AdditionalSparkProperties.json_schema()
            },
            "required": [
                "enableHiveSupport",
    ...
    def from_json(cls, data: dict):
        ...
        try:
            ...
            return SparkConfig(
                ...
                hiveMetastoreUrl=(lambda v: v and str(v))(data.get("hiveMetastoreUrl", None)),
                additionalSparkProperties=AdditionalSparkProperties.from_json(data["additionalSparkProperties"]),
            )
        except jsonschema.exceptions.ValidationError as ex:
            logging.debug(
    ...
    def to_json(self):
        ...
        return {
            ...
            "hiveMetastoreUrl": (lambda v: v and str(v))(self.hiveMetastoreUrl),
            "additionalSparkProperties": self.additionalSparkProperties.to_json()
        }
