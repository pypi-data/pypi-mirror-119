...
class DevSetup(models.Model):
    ...
    email_verification = models.CharField(max_length = 2,choices = VerifcationChoice.choices,default=VerifcationChoice.EMAIL_LINK, verbose_name="Email Verification Method")
