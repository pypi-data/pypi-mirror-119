...
if TYPE_CHECKING:
    ...
    from ...models.abc import MessageableChannel
...
class Context(defectio.abc.Messageable, Generic[BotT]):
    ...
    This class implements the :class:`~defectio.abc.Messageable` ABC.
    ...
    async def _get_channel(self) -> defectio.abc.Messageable:
        return self.channel
    ...
    def me(self) -> Union[Member, ClientUser]:
        ...
        # return self.server.me if self.server is not None else self.bot.user  # type: ignore
