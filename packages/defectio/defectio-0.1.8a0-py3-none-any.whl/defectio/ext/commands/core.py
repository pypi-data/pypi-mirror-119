    ...
    async def _parse_arguments(self, ctx: Context) -> None:
        ...
        if self.cog is not None:
            ...
            try:
                ...
                raise defectio.ClientException(
...
def dynamic_cooldown(
    ...
    accepts a single parameter of type :class:`.defectio.Message` and must
    ...
    Parameters
    ------------
    cooldown: Callable[[:class:`.defectio.Message`], Optional[:class:`.Cooldown`]]
