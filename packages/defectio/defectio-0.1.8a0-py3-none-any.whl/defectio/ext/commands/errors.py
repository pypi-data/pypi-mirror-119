...
from defectio.errors import ClientException, DefectioException
...
if TYPE_CHECKING:
    ...
    from ...models.abc import ServerChannel
...
class CommandError(DefectioException):
    r"""The base exception type for all command related errors.

    This inherits from :exc:`defectio.RevoltException`.
...
class ConversionError(CommandError):
    ...
    Attributes
    ----------
    converter: :class:`defectio.ext.commands.Converter`
...
class ServerStickerNotFound(BadArgument):
...
class ExtensionError(DefectioException):
...
class CommandRegistrationError(ClientException):
    ...
    This inherits from :exc:`defectio.ClientException`
...
class TooManyFlags(FlagError):
    ...
    Attributes
    ------------
    flag: :class:`~defectio.ext.commands.Flag`
