...
setup(
 ...
 '* FormatableFormatter.FORMAT_RE_ARG_NAME_s: strings commencing with digits '    
 'now match \\d+(\\.\\d+)[a-z]+, eg "02d".\n'    
 '* Alias typed_str as s and typed_repr as r.\n'    
 '* FormatableFormatter: new .format_mode thread local state object initially '    
 'with strict=False, used to control whether unknown fields leave a '    
 'placeholder or raise KeyError.\n'    
 ...
 '    True\n'    
 '\n'    
 '## Function `format_as(format_s: str, format_mapping, formatter=None, '    
 'error_sep=None, strict=None)`\n'    
 '\n'    
 ...
 '  the term parse.\n'    
 '\n'    
 'The default implementation of `__format1__` just calls '    
 '`super().__format__`.\n'    
 ...
 '\n'    
 '## Class '    
 '`FStr(FormatableMixin,FormatableFormatter,string.Formatter,builtins.str)`\n'    
 '\n'    
 ...
 'mapper=<function slosh_mapper at 0x10d763790>, specials=None)`\n'    
 '\n'    
 ...
 '\n'    
 '*Release 20210906*:\n'    
 'New strip_prefix_n() function to strip a leading `prefix` and numeric value '    
 '`n` from the start of a string.\n'    
 '\n'    
 '*Release 20210717*:\n'    
 '* Many many changes to FormatableMixin, FormatableFormatter and friends '    
 'around supporting {foo|conv1|con2|...} instead of {foo!conv}. Still in '    
 'flux.\n'    
 ...
 'PyPI metadata and slight code cleanup.'),
  install_requires = ['cs.deco', 'cs.gimmicks', 'cs.pfx', 'cs.py.func', 'cs.py3', 'cs.seq>=20200914', 'typeguard'],
