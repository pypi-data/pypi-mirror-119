...
#     amqp_url = 'amqp://guest:guest@106.54.140.36:5672/%2F'
#     consumer = ReconnectingAsyncConsumer(amqp_url, queue='TEST01', routing_key='example.text', exchange='message',
#                                          exchange_type=ExchangeType.topic, loop=asyncio.new_event_loop(), durable=False)
#
