    ...
    for tl1 in target_label:
        ...
        for count in range(len_tar_l):
            ...
            for ii in range(max_n):
                for jj in range(max_n):
                    if ii == jj:
                        for gg in range(len_key_l): c_col[ii * max_n + jj, jj] = [int(250 * class_data2[ii * max_n + jj]),0,0]
                    else:
                        for gg in range(len_key_l): c_col[ii * max_n + jj, jj] = [0,0,int(250 * class_data2[ii * max_n + jj])]
