...
def test_corn():
    ...
    tea = module.corn_tea
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.3738282213261416, rtol=1e-2)
    ...
    assert np.allclose(tea.sales, 72934913.89320047, rtol=1e-2)
    assert np.allclose(tea.material_cost, 54210719.802370444, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 83342035.2736787, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 82539680.49952266, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 136.9448250004602, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 1205.6429385506908, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 2.419370941914406, rtol=1e-2)
...
def test_lipidcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.20684465139208186, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 108114570.7233085, rtol=1e-2)
    assert np.allclose(tea.material_cost, 59020325.51133198, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 237166978.2003065, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -33136329.29016732, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 265.2871297717993, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 273.6360999156439, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 16.15758311867809, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 121.61530865119501, rtol=1e-2)
    bst.process_tools.default()
...
def test_cornstover():
    ...
    assert np.allclose(product.price, 0.7316483243221017, rtol=1e-2)
    assert np.allclose(tea.sales, 133625962.56847268, rtol=1e-2)
    assert np.allclose(tea.material_cost, 82503906.88686624, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 215743369.99034595, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -10797200.351403674, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 307.99562590800815, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 357.7604463579032, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 24.255924557758227, rtol=1e-2)
...
def test_sugarcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.11940238997135098, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 86924100.80067463, rtol=1e-2)
    assert np.allclose(tea.material_cost, 59825908.82267224, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 203538386.61675727, rtol=1e-2)
    # assert np.allclose(tea.utility_cost, -18159414.546421293, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 298.4147830945971, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 290.55474998958834, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 15.460048286406321, rtol=1e-2)
...
def test_LAOs():
    ...
    assert np.allclose(product.price, 1.3076227953378616, rtol=1e-2)
    assert np.allclose(tea.sales, 158903649.39479366, rtol=1e-2)
    assert np.allclose(tea.material_cost, 135664645.249991, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 54369823.01192936, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 526586.0923074554, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 37.830529776838524, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 123.6319015292342, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 3.768946026408361, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 3.768946026408362, rtol=1e-2)
    bst.process_tools.default()
