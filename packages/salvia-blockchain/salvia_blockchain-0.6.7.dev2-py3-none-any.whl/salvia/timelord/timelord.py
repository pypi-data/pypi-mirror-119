...
from salvia.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from salvia.timelord.timelord_state import LastState
from salvia.timelord.types import Chain, IterationType, StateType
...
from salvia.types.blockchain_format.slots import (
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[SalviaServer] = None
