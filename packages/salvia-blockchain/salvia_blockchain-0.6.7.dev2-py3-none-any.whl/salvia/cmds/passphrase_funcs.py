...
from salvia.daemon.client import acquire_connection_to_daemon
from salvia.util.keychain import Keychain, obtain_current_passphrase
from salvia.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE
from salvia.util.ws_message import WsRpcMessage
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'salvia passphrase set' or 'salvia passphrase remove' to update or remove your passphrase")
        sys.exit(1)
