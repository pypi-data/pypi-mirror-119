...
from salvia.plotting.util import PlotInfo, parse_plot_info
from salvia.protocols import harvester_protocol
from salvia.protocols.farmer_protocol import FarmingInfo
from salvia.protocols.harvester_protocol import Plot
from salvia.protocols.protocol_message_types import ProtocolMessageTypes
from salvia.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSSalviaConnection
    ):
        """
