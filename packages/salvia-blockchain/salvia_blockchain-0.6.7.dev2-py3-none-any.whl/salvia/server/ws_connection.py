...
from salvia.cmds.init_funcs import salvia_full_version_str
from salvia.protocols.protocol_message_types import ProtocolMessageTypes
from salvia.protocols.shared_protocol import Capability, Handshake
from salvia.server.outbound_message import Message, NodeType, make_msg
from salvia.server.rate_limits import RateLimiter
...
from salvia.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from salvia.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSSalviaConnection:
    """
