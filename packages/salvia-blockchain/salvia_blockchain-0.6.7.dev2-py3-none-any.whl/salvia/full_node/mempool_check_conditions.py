...
from salvia.util.clvm import int_from_bytes, int_to_bytes
from salvia.util.condition_tools import ConditionOpcode, conditions_by_opcode
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see salvia/types/blockchain_format/program.py)
