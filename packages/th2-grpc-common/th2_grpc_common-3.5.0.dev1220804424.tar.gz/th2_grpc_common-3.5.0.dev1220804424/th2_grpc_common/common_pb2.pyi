...
class RootComparisonSettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"check_repeating_group_order",b"check_repeating_group_order",u"ignore_fields",b"ignore_fields"]) -> None: ...
