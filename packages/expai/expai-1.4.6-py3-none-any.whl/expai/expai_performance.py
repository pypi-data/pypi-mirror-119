...
class ExpaiModelPerformance:
    ...
    def launch_performance_dashboard(self, sample_name: str = None, sample_id: str = None, subset_indexes: list = None, protected_columns: list = None):
        ...
        response =  self.sess.post(self.server_name + "/api/fairness/{}/dashboard".format(self.model_id),
