...
class getSeverityCounts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i463 in range(_size459):
                        ...
                        _val465 = iprot.readI64()
                        self.success[_key464] = _val465
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter466, viter467 in self.success.items():
                oprot.writeI32(kiter466)
                oprot.writeI64(viter467)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i479 in range(_size475):
                        _key480 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val481 = iprot.readI64()
                        self.success[_key480] = _val481
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getReviewStatusCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter490 in self.runIds:
                oprot.writeI64(iter490)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    self.success = {}
                    (_ktype492, _vtype493, _size491) = iprot.readMapBegin()
                    for _i495 in range(_size491):
                        _key496 = iprot.readI32()
                        _val497 = iprot.readI64()
                        self.success[_key496] = _val497
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getDetectionStatusCounts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i511 in range(_size507):
                        ...
                        _val513 = iprot.readI64()
                        self.success[_key512] = _val513
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.I32, TType.I64, len(self.success))
            for kiter514, viter515 in self.success.items():
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i527 in range(_size523):
                        ...
                        _val529 = iprot.readI64()
                        self.success[_key528] = _val529
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i571 in range(_size567):
                        _key572 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val573 = iprot.readI64()
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i580 in range(_size576):
                        ...
                        self.sourceComponentFilter.append(_elem581)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter582 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i594 in range(_size590):
                        ...
                        self.fileHashes.append(_elem595)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter596 in self.fileHashes:
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i608 in range(_size604):
                        ...
                        self.trimPathPrefixes.append(_elem609)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter610 in self.trimPathPrefixes:
...
class getAnalysisStatisticsLimits_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i615 in range(_size611):
                        _key616 = iprot.readI32()
                        _val617 = iprot.readI64()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.I32, TType.I64, len(self.success))
            for kiter618, viter619 in self.success.items():
...
class getAnalysisStatistics_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i624 in range(_size620):
                        ...
                        _val626 = AnalyzerStatistics()
                        _val626.read(iprot)
                        self.success[_key625] = _val626
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter627, viter628 in self.success.items():
...
class setCleanupPlan_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i640 in range(_size636):
                        ...
                        self.reportHashes.append(_elem641)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            oprot.writeFieldBegin('reportHashes', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter642 in self.reportHashes:
...
class unsetCleanupPlan_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i647 in range(_size643):
                        ...
                        self.reportHashes.append(_elem648)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            oprot.writeFieldBegin('reportHashes', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter649 in self.reportHashes:
