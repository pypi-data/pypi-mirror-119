...
import luxor_openapi_asyncio.models
from luxor_openapi_asyncio import rest
from luxor_openapi_asyncio.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(luxor_openapi_asyncio.models, klass)
