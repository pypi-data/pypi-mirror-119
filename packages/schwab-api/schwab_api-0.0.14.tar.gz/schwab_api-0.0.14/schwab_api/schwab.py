...
class Schwab:
    ...
    def get_account_info(self):
        ...
        self.page.goto("https://client.schwab.com/Areas/Accounts/Positions")

        # Get summary information
        summary = self.page.query_selector(".total-summary")
        summary.

        # Get all tables
        tables = self.page.query_selector_all("table schwabTable")
