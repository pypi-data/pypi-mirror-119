...
T = TypeVar("T", bound="MixtureWriteParams")


@attr.s(auto_attribs=True, repr=False)
class MixtureWriteParams:
    """  """

    _aliases: Union[Unset, List[str]] = UNSET
    _amount: Union[Unset, MixtureAmount] = UNSET
    ...
    def __repr__(self):
        ...
        return "MixtureWriteParams({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        amount: Union[Unset, MixtureAmount] = UNSET
        _amount = d.pop("amount", UNSET)
        if not isinstance(_amount, Unset):
            amount = MixtureAmount.from_dict(_amount)
        ...
        mixture_write_params.additional_properties = d
        return mixture_write_params
