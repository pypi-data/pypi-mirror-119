...
from ..models.mixture_amount import MixtureAmount
from ..models.mixture_creator import MixtureCreator
from ..models.mixture_fields import MixtureFields
...
class Mixture:
    ...
    _allow_measured_ingredients: bool
    _amount: MixtureAmount
    _fields: MixtureFields
    _id: str
    _ingredients: List[Ingredient]
    _units: MixtureMeasurementUnits
    _registration_origin: Optional[RegistrationOrigin]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        field_dict.update(
            {
                "allowMeasuredIngredients": allow_measured_ingredients,
                "amount": amount,
                "fields": fields,
                "id": id,
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        amount = MixtureAmount.from_dict(d.pop("amount"))

        fields = MixtureFields.from_dict(d.pop("fields"))
        ...
        units = MixtureMeasurementUnits(d.pop("units"))
        ...
        if _registration_origin is not None:
    ...
    @property
    def amount(self) -> MixtureAmount:
        return self._amount

    @amount.setter
    def amount(self, value: MixtureAmount) -> None:
        self._amount = value

    @property
    def fields(self) -> MixtureFields:
        return self._fields

    @fields.setter
    def fields(self, value: MixtureFields) -> None:
        self._fields = value
