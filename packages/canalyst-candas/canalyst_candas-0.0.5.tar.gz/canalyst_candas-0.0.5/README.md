...
The Python SDK, is intended to provide users a way to interact with the
Canalyst public API. Additionally, users will be able to create scenarios and
analyze data from those what-if changes.
