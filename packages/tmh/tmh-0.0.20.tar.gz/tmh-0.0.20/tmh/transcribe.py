...
language_models = {
    ...
    "English": "speechbrain/asr-transformer-transformerlm-librispeech"
}
...
def transcribe_from_audio_path(audio_path, language='Swedish', check_language=False, classify_emotion=False):
