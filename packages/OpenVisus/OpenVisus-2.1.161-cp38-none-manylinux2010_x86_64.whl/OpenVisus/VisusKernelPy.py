...
class RamResource(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, RamResource, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, RamResource, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    if _newclass:
        getSingleton = staticmethod(_VisusKernelPy.RamResource_getSingleton)
    else:
        getSingleton = _VisusKernelPy.RamResource_getSingleton
    if _newclass:
        setSingleton = staticmethod(_VisusKernelPy.RamResource_setSingleton)
    else:
        setSingleton = _VisusKernelPy.RamResource_setSingleton
    if _newclass:
        allocSingleton = staticmethod(_VisusKernelPy.RamResource_allocSingleton)
    else:
        allocSingleton = _VisusKernelPy.RamResource_allocSingleton
    if _newclass:
        releaseSingleton = staticmethod(_VisusKernelPy.RamResource_releaseSingleton)
    else:
        releaseSingleton = _VisusKernelPy.RamResource_releaseSingleton
...
RamResource_swigregister = _VisusKernelPy.RamResource_swigregister
RamResource_swigregister(RamResource)

def RamResource_getSingleton():
    return _VisusKernelPy.RamResource_getSingleton()
RamResource_getSingleton = _VisusKernelPy.RamResource_getSingleton

def RamResource_setSingleton(value):
    return _VisusKernelPy.RamResource_setSingleton(value)
RamResource_setSingleton = _VisusKernelPy.RamResource_setSingleton

def RamResource_allocSingleton():
    return _VisusKernelPy.RamResource_allocSingleton()
RamResource_allocSingleton = _VisusKernelPy.RamResource_allocSingleton

def RamResource_releaseSingleton():
    return _VisusKernelPy.RamResource_releaseSingleton()
RamResource_releaseSingleton = _VisusKernelPy.RamResource_releaseSingleton
...
class FileUtils(_object):
    ...
    if _newclass:
        findFilesInDirectory = staticmethod(_VisusKernelPy.FileUtils_findFilesInDirectory)
    else:
        findFilesInDirectory = _VisusKernelPy.FileUtils_findFilesInDirectory
...
FileUtils_findFilesInDirectory = _VisusKernelPy.FileUtils_findFilesInDirectory
...
class TransferFunction(_object):
    ...
    if _newclass:
        fromColors = staticmethod(_VisusKernelPy.TransferFunction_fromColors)
    else:
        fromColors = _VisusKernelPy.TransferFunction_fromColors
    if _newclass:
...
TransferFunction_fromColors = _VisusKernelPy.TransferFunction_fromColors
