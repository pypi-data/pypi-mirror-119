...
class AccessStatistics(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, AccessStatistics, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, AccessStatistics, name)
    __repr__ = _swig_repr
    __swig_setmethods__["rok"] = _VisusDbPy.AccessStatistics_rok_set
    __swig_getmethods__["rok"] = _VisusDbPy.AccessStatistics_rok_get
    if _newclass:
        rok = _swig_property(_VisusDbPy.AccessStatistics_rok_get, _VisusDbPy.AccessStatistics_rok_set)
    __swig_setmethods__["rfail"] = _VisusDbPy.AccessStatistics_rfail_set
    __swig_getmethods__["rfail"] = _VisusDbPy.AccessStatistics_rfail_get
    if _newclass:
        rfail = _swig_property(_VisusDbPy.AccessStatistics_rfail_get, _VisusDbPy.AccessStatistics_rfail_set)
    __swig_setmethods__["wok"] = _VisusDbPy.AccessStatistics_wok_set
    __swig_getmethods__["wok"] = _VisusDbPy.AccessStatistics_wok_get
    if _newclass:
        wok = _swig_property(_VisusDbPy.AccessStatistics_wok_get, _VisusDbPy.AccessStatistics_wok_set)
    __swig_setmethods__["wfail"] = _VisusDbPy.AccessStatistics_wfail_set
    __swig_getmethods__["wfail"] = _VisusDbPy.AccessStatistics_wfail_get
    if _newclass:
        wfail = _swig_property(_VisusDbPy.AccessStatistics_wfail_get, _VisusDbPy.AccessStatistics_wfail_set)

    def reset(self):
        return _VisusDbPy.AccessStatistics_reset(self)

    def __init__(self):
        this = _VisusDbPy.new_AccessStatistics()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
AccessStatistics_swigregister = _VisusDbPy.AccessStatistics_swigregister
AccessStatistics_swigregister(AccessStatistics)
