...
class GLPhongObject(GLObject):
    ...
    __swig_setmethods__["point_size"] = _VisusGuiPy.GLPhongObject_point_size_set
    __swig_getmethods__["point_size"] = _VisusGuiPy.GLPhongObject_point_size_get
    if _newclass:
        point_size = _swig_property(_VisusGuiPy.GLPhongObject_point_size_get, _VisusGuiPy.GLPhongObject_point_size_set)
