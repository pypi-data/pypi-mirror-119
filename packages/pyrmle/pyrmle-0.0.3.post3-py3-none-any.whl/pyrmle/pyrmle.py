from pyrmle.pyrmle_hfuncs import *
...
def spline_fit(result,num_grid_points):
    ...
    if dim == 2:
        ...
        f = sp.interpolate.interp2d(spline_x, spline_y, spline_z, kind='quadratic')
        ...
        spline_f01_func = sp.interpolate.interp2d(spline_x, spline_y, f01, kind='quadratic')
        spline_f02_func = sp.interpolate.interp2d(spline_x, spline_z, f02, kind='quadratic')
        spline_f12_func = sp.interpolate.interp2d(spline_y, spline_z, f12, kind='quadratic')
