...
class AlertsController(BaseController):
    ...
    def get_active_alarms(self,
                          ...
                          page_size=50,
                          page=1):
        """Does a GET request to /activealarms.

        _**This endpoint is deprecated.** Please use the new endpoint
    ...
    def get_alarms(self,
                   ...
                   page_size=50,
                   page=1):
        """Does a GET request to /alarms.

        _**This endpoint is deprecated.** Please use the new endpoint
        `/alerts.json` instead._
