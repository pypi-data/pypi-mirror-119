...
class StatusItem(object):
    ...
    Attributes:
        ...
        category_contract_global (string): The status category as defined in
            the global availability contract assigned to the site.
        category_contract_custom (string): The status category as defined in
    ...
    _names = {
        ...
        "category_contract_global":'categoryContractGlobal',
        "category_contract_custom":'categoryContractCustom',
    ...
    def __init__(self,
                 ...
                 category_contract_global=None,
                 category_contract_custom=None,
                 sub_status=None,
                 acknowledged=None):
        ...
        self.category_contract_global = category_contract_global
        self.category_contract_custom = category_contract_custom
    ...
    def from_dictionary(cls,
        ...
        category_contract_global = dictionary.get('categoryContractGlobal')
        category_contract_custom = dictionary.get('categoryContractCustom')
        sub_status = None
        ...
        return cls(turbine_status_id,
                   ...
                   category_iec,
                   category_contract,
                   category_contract_global,
                   category_contract_custom,
                   sub_status,
                   acknowledged)
