...
class AlertsControllerTests(ControllerTestBase):
    ...
    def test_test_get_active_alarms(self):
        # Parameters for the API call
        device_ids = APIHelper.json_deserialize('[1,2,3]')
        fields = APIHelper.json_deserialize('["ruleId","timestampStart"]')
        sort_by = None
        ...
        # Perform the API call through the SDK function
        result = self.controller.get_active_alarms(device_ids, fields, sort_by, sort_asc, page_size, page)
    ...
    # _**This endpoint is deprecated.** Please use the new endpoint `/activealerts.json` instead._
    def test_test_get_active_alarms_1(self):
        # Parameters for the API call
        device_ids = APIHelper.json_deserialize('[1,2,3]')
        fields = APIHelper.json_deserialize('["ruleId","timestampStart"]')
        sort_by = None
    ...
    def test_test_get_alarms(self):
        ...
        # Perform the API call through the SDK function
        result = self.controller.get_alarms(device_ids, timestamp_start, timestamp_end, fields, sort_by, sort_asc, page_size, page)
    ...
    # _**This endpoint is deprecated.** Please use the new endpoint `/alerts.json` instead._
    def test_test_get_alarms_1(self):
        # Parameters for the API call
        device_ids = APIHelper.json_deserialize('[1,2,3]')
        timestamp_start = APIHelper.RFC3339DateTime.from_value('2020-01-01T00:00:00Z').datetime
        timestamp_end = APIHelper.RFC3339DateTime.from_value('2020-01-08T00:00:00Z').datetime
