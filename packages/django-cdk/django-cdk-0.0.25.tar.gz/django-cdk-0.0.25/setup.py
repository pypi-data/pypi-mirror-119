    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cloudformation>=1.122.0, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.122.0, <2.0.0",
        "aws-cdk.aws-cloudwatch>=1.122.0, <2.0.0",
        "aws-cdk.aws-ec2>=1.122.0, <2.0.0",
        "aws-cdk.aws-ecr-assets>=1.122.0, <2.0.0",
        "aws-cdk.aws-ecr>=1.122.0, <2.0.0",
        "aws-cdk.aws-ecs-patterns>=1.122.0, <2.0.0",
        "aws-cdk.aws-ecs>=1.122.0, <2.0.0",
        ...
        "aws-cdk.aws-s3-deployment>=1.122.0, <2.0.0",
        "aws-cdk.aws-s3>=1.122.0, <2.0.0",
        "aws-cdk.aws-secretsmanager>=1.122.0, <2.0.0",
        "aws-cdk.aws-ssm>=1.122.0, <2.0.0",
