...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.18.0-alpha.1631296060+ce0ec5fb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.18.0-alpha.1631296060+ce0ec5fb`
                """)
            else:
                raise
