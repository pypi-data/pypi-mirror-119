...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_labels=None, base_path=None, content_guard=None, repository=None, name=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
