...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, pulp_labels=None, description=None, pulp_created=None, latest_version_href=None, pulp_href=None, versions_href=None, name=None, local_vars_configuration=None):  # noqa: E501
