...
class HTTPConnection(Task):
    ...
    def create_app(self, **kwargs):
        ...
        app = Flask("redengine.api")
        app.register_blueprint(rest_api)
        app.json_encoder = RedengineJSONEncoder
    ...
    def _set_config(self, app, access_token=None):
        ...
        app.logger.name = "redengine.api.http" # We don't want it to pollute task logs (would be named as "redengine.tasks.api.http.task" otherwise)
