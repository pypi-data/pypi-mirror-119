...
**tasking** could always use more documentation, whether as
part of the official **tasking** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `tasking` for local
development.

1. Fork the `tasking` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/tasking.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd tasking
    (dvlpt) tasking$ flake8
    (dvlpt) tasking$ pytest
...
Before you submit a pull request, check that it meets these guidelines:
  ...
  3. The pull request should work for Python 39, 38, 37.
...
.. _issues: https://gitlab.com/revesansparole/tasking/issues
