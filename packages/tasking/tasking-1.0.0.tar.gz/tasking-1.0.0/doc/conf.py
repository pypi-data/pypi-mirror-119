...
# [howto/manual]).
latex_documents = [
    (u"index", u"tasking.tex",
     u"tasking Documentation",
     u"revesansparole",
     u"manual"),
]
...
texinfo_documents = [
    (u"index", u"tasking",
     ...
     u"revesansparole",
     u"tasking",
     u"Perform time simulation, using scheduled tasks to update current state",
     u"Miscellaneous"),
]
