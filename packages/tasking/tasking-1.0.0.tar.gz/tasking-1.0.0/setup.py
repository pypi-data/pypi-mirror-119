...
short_descr = "Perform time simulation, using scheduled tasks to update current state"
...
setup_kwds = dict(
    ...
    url='https://gitlab.com/revesansparole/tasking',
    license='cc_by_nc',
    zip_safe=False,
