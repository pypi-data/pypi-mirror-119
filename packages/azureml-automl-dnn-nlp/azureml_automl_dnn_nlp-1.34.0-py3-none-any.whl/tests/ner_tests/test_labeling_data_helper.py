...
class LabelingDataHelperTest(unittest.TestCase):
    ...
    def test_generate_results_for_labeling_service(self):
        ...
        with patch("azureml.automl.dnn.nlp.ner.io.read.labeling_data_helper.shutil.move"):
            with patch("azureml.automl.dnn.nlp.ner.io.read.labeling_data_helper.open", open_mock):
                with patch("azureml.automl.dnn.nlp.ner.io.read.labeling_data_helper._convert_to_spans",
