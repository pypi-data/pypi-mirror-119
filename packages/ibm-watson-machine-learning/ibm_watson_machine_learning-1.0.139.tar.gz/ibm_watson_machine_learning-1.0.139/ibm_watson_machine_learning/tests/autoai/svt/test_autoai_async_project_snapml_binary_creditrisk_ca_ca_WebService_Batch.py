...
class TestAutoAIRemote(AbstractTestAutoAIAsync, AbstractTestWebservice, AbstractTestBatch, unittest.TestCase):
    ...
    def test_40_deployment_target_space_setup(self):
        ...
        if TestAutoAIRemote.target_space_id is None:
            TestAutoAIRemote.target_space_id = self.space_id
        # end note
        self.wml_client.set.default_space(TestAutoAIRemote.target_space_id)
