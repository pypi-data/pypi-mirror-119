...
class HorseracelampListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        module_id = int(self.get_request_param("module_id", -1))
...
class SyncPayOrderHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        is_log = bool(self.get_request_param("is_log", False))
...
class SubmitSkuHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        app_id = self.get_taobao_param().source_app_id
        open_id = self.get_taobao_param().open_id
        user_prize_id = int(self.get_request_param("user_prize_id"))
        sku_name = self.get_request_param("sku_name")
        sku_id = self.get_request_param("sku_id")
