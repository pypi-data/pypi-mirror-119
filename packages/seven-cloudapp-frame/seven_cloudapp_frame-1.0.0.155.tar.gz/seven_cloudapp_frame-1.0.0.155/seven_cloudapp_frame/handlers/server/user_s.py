...
class UpdateUserStatusHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        """
        app_id = self.get_app_id()
        act_id = int(self.get_request_param("act_id"))
        tb_user_id = int(self.get_request_param("tb_user_id"))
        user_state = int(self.get_request_param("user_state"))
...
class AuditUserBlackHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        """
        app_id = self.get_app_id()
        black_id = int(self.get_request_param("black_id", 0))
        audit_status = int(self.get_request_param("audit_status", 0))
        audit_remark = self.get_request_param("audit_remark")
        user_base_model = UserBaseModel(context=self)
...
class UserBlackListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        audit_status = int(self.get_request_param("audit_status", -1))
        tb_user_id = int(self.get_request_param("tb_user_id", 0))
        user_nick = self.get_request_param("nick_name")
        open_id = self.get_request_param("user_open_id")
...
class UpdateUserAssetHandler(TaoBaseHandler):
    ...
    def post_async(self):
        ...
        asset_type = int(self.get_request_param("asset_type", 0))
        asset_value = int(self.get_request_param("asset_value", 0))
        asset_object_id = self.get_request_param("asset_object_id")
...
class BatchUpdateUserAssetHandler(TaoBaseHandler):
    ...
    def post_async(self):
        ...
        asset_object_json = self.get_request_param("asset_object_json")
...
class AssetLogListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        start_date = self.get_request_param("start_date")
        end_date = self.get_request_param("end_date")
        source_type = int(self.get_request_param("source_type", 0))
        source_object_id = self.get_request_param("source_object_id")
        asset_type = int(self.get_request_param("asset_type", 0))
        asset_object_id = self.get_request_param("asset_object_id")
...
class UserInfoListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        open_id = self.get_request_param("user_open_id")
        user_nick = self.get_request_param("nick_name")
        user_state = int(self.get_request_param("user_state", -1))
        page_index = int(self.get_request_param("page_index", 0))
        page_size = int(self.get_request_param("page_size", 20))
        start_date = self.get_request_param("start_date")
        end_date = self.get_request_param("end_date")
