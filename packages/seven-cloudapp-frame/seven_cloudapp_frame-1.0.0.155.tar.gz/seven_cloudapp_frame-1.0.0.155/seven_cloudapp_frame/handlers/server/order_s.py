...
@LastEditTime: 2021-09-14 19:47:20
...
class PayOrderListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        tb_user_id = self.get_request_param("tb_user_id")
        user_open_id = self.get_request_param("user_open_id")
        nick_name = self.get_request_param("nick_name")
        pay_date_start = self.get_request_param("pay_date_start")
        pay_date_end = self.get_request_param("pay_date_end")
        ...
        return self.response_json_success(order_base_model.get_tao_pay_order_list(app_id, act_id, tb_user_id, user_open_id, nick_name, pay_date_start, pay_date_end, page_size, page_index))
...
class PrizeOrderListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        real_name = self.get_request_param("real_name")
        order_status = int(self.get_request_param("order_status",-10))
        create_date_start = self.get_request_param("create_date_start")
        create_date_end = self.get_request_param("create_date_end")
        order_by = self.get_request_param("order_by","create_date desc")
        is_search_roster = self.get_request_param("is_search_roster", False)
        page_index = int(self.get_request_param("page_index", 0))
        page_size = int(self.get_request_param("page_size", 20))

        order_base_model = OrderBaseModel(context=self)
        return self.response_json_success(order_base_model.get_prize_order_list(app_id, act_id, tb_user_id, user_open_id, nick_name, order_no, real_name, telephone, address, order_status, create_date_start, create_date_end, page_size, page_index, order_by, is_search_roster=is_search_roster, is_cache=False))
...
class PrizeRosterListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        app_id = self.get_app_id()
        act_id = int(self.get_request_param("act_id", 0))
        module_id = int(self.get_request_param("module_id", 0))
        user_id = int(self.get_request_param("tb_user_id", 0))
        user_open_id = self.get_request_param("user_open_id")
        order_no = self.get_request_param("order_no")
        user_nick = self.get_request_param("nick_name")
        is_order = self.get_request_param("is_order",False)
        goods_type = int(self.get_request_param("goods_type", -1))
        prize_type = int(self.get_request_param("prize_type", -1))
        logistics_status = int(self.get_request_param("logistics_status", -1))
        prize_status = int(self.get_request_param("prize_status", -1))
        pay_status = int(self.get_request_param("pay_status", -1))
        create_date_start = self.get_request_param("create_date_start")
        create_date_end = self.get_request_param("create_date_end")
        page_index = int(self.get_request_param("page_index", 0))
        page_size = int(self.get_request_param("page_size", 500))
        if is_order:
            prize_status = 1
        condition = ""
        params = []
...
class UpdatePrizeOrderSellerRemarkHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        seller_remark = self.get_request_param("seller_remark")
        order_base_model = OrderBaseModel(context=self)
...
class UpdatePrizeOrderStatusHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        express_company = self.get_request_param("express_company")
        express_no = self.get_request_param("express_no")
...
class ImportPrizeOrderHandler(TaoBaseHandler):
    ...
    def post_async(self):
        ...
        app_id = self.get_app_id()
        act_id = int(self.get_request_param("act_id", 0))
        content = self.get_request_param("content")
        ref_head_name = self.get_request_param("ref_head_name", "小程序订单号")
...
class PrizeOrderExportHandler(TaoBaseHandler):
    """
    ...
    def get_async(self):
        ...
        address = self.get_request_param("address")
        real_name = self.get_request_param("real_name")
        order_status = int(self.get_request_param("order_status", -1))
        create_date_start = self.get_request_param("create_date_start")
        create_date_end = self.get_request_param("create_date_end")
        order_by = self.get_request_param("order_by", "create_date desc")
        page_index = int(self.get_request_param("page_index", 0))
        ...
        order_base_model = OrderBaseModel(context=self)
        prize_order_list_dict = order_base_model.get_prize_order_list(app_id, act_id, tb_user_id, user_open_id, nick_name, order_no, real_name, telephone, address, order_status, create_date_start, create_date_end, page_size, page_index, order_by, is_search_roster=True, is_cache=False).data
...
class PrizeRosterExportHandler(TaoBaseHandler):
    """
    ...
    def get_async(self):
        ...
        user_nick = self.get_request_param("nick_name")
        user_open_id = self.get_request_param("user_open_id")
        is_order = self.get_request_param("is_order")
        goods_type = int(self.get_request_param("goods_type", -1))
        prize_type = int(self.get_request_param("prize_type", -1))
        logistics_status = int(self.get_request_param("logistics_status", -1))
        prize_status = int(self.get_request_param("prize_status", -1))
