...
@LastEditTime: 2021-09-09 14:49:47
...
class StatReportListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        return self.response_json_success(self.business_process_executed(stat_base_model.get_stat_report_list(app_id, act_id, module_id, start_date, end_date), self.request_params))
...
class TrendReportListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        stat_base_model = StatBaseModel(context=self)
        return self.response_json_success(self.business_process_executed(stat_base_model.get_trend_report_list(app_id, act_id, module_id, start_date, end_date), self.request_params))
