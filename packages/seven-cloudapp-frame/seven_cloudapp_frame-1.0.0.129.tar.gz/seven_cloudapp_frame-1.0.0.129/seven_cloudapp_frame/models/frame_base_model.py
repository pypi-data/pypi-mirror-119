...
@LastEditTime: 2021-09-06 16:40:30
...
class FrameBaseModel():
    ...
    def business_process_executing(self,app_id,act_id,module_id,user_id,login_token,handler_name,check_new_user=False,check_user_nick=True,continue_request_expire=5,acquire_lock_name=""):
        """
        ...
        if not app_id or not act_id or not user_id or not login_token or not handler_name:
    ...
    def business_process_executed(self,act_id,module_id,user_id,handler_name,acquire_lock_name="",identifier=""):
        """
