...
@LastEditTime: 2021-07-29 18:36:31
...
class StatOrm:
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'module_id', 'group_name', 'group_sub_name', 'key_name', 'key_value', 'repeat_type', 'sort_index', 'create_date', 'is_show', 'i1', 'i2', 's1', 's2']
