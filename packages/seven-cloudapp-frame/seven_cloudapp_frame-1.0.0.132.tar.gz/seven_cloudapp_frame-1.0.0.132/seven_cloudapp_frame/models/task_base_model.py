...
@LastEditTime: 2021-09-07 16:00:00
...
class TaskBaseModel(FrameBaseModel):
    ...
    def get_client_task_list(self,app_id,act_id,module_id,user_id,task_types="",app_key="",app_secret="",is_log=False):
        """
        :description: 获取任务列表
        :param app_id:应用标识
        :param act_id:活动标识
        ...
        for task_info_dict in task_info_list:
            ...
            #收藏商品
                ...
                if task_info_dict["complete_type"] == 1:
                    condition = "act_id=%s and user_id=%s and create_day=%s"
                    params = [act_id,user_id, now_day]
                    ...
                    condition = "act_id=%s and user_id=%s and create_day>=%s and create_day<=%s"
                    params = [act_id,user_id, start_day,end_day]
                else:
            ...
            #浏览网址
                ...
                for sub_config_json in range(len(config_json)):
    ...
    def process_receive_reward(self,app_id,act_id,module_id,user_id,login_token,task_id,task_sub_type,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5):
        """
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if task_invoke_result_data.success == True:
                    ...
                    if task_sub_type:
                        config_json = [sub_config_json for sub_config_json in config_json if sub_config_json["id"] == task_sub_type]
                    ...
                    satisfy_num = config_json["satisfy_num"] if config_json.__contains__("satisfy_num") else 1
                    limit_num = config_json["limit_num"] if config_json.__contains__("limit_num") else 1
    ...
    def process_free_gift(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5):
        """
    ...
    def process_one_sign(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5):
        """
    ...
    def process_weekly_sign(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5):
        """
    ...
    def process_cumulative_sign(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_new_user=False,check_user_nick=True,continue_request_expire=5):
        """
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if task_invoke_result_data.success == True:
                    ...
                    asset_object_id = config_json["asset_object_id"] if config_json.__contains__("asset_object_id") else ""
                    day_list = config_json["day_list"] if config_json.__contains__("day_list") else {}
                    is_loop = config_json["is_loop"] if config_json.__contains__("is_loop") else 1 #是否循环 1是0否
                    act_info_dict = invoke_result_data.data["act_info_dict"]
                    act_module_dict = invoke_result_data.data["act_module_dict"]
                    user_info_dict = invoke_result_data.data["user_info_dict"]
                    identifier = invoke_result_data.data["identifier"]
    ...
    def process_favor_store(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_user_nick=True,continue_request_expire=5):
        """
            ...
            if invoke_result_data.success == True:
                ...
                if user_info_dict["is_favor"] ==1:
                    ...
                    if task_invoke_result_data.success == True:
                        ...
                        once_favor_reward = config_json["once_favor_reward"] if config_json.__contains__("once_favor_reward") else 1
                        asset_object_id = config_json["asset_object_id"] if config_json.__contains__("asset_object_id") else ""
    ...
    def process_join_member(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,check_user_nick=True,continue_request_expire=5):
        """
            ...
            if invoke_result_data.success == True:
                ...
                if user_info_dict["is_member"] ==1:
                    ...
                    if task_invoke_result_data.success == True:
                        ...
                        config_json = task_info_dict["config_json"]
                        reward_value = config_json["reward_value"] if config_json.__contains__("reward_value") else 0
                        once_member_reward = config_json["once_member_reward"] if config_json.__contains__("once_member_reward") else 1
                        asset_object_id = config_json["asset_object_id"] if config_json.__contains__("asset_object_id") else ""
