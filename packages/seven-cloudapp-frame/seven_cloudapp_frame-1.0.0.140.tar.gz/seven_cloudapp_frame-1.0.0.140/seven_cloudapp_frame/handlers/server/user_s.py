...
@LastEditTime: 2021-09-09 11:01:39
...
class UserInfoListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        return self.reponse_json_success(self.business_process_executed(page_info, app_id, act_id, page_size, page_index, user_state, user_id, start_date, end_date, user_nick, open_id))

    def business_process_executed(self, page_info, app_id, act_id, page_size, page_index, user_state, user_id, start_date, end_date, user_nick, open_id):
        """
        :description: 执行后事件
