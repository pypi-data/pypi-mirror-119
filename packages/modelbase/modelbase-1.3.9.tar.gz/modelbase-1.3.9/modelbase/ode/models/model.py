...
class Model(_AbstractRateModel):
    ...
    def get_full_concentration_dict(
        self,
        y: Union[Dict[str, float], Dict[str, np.ndarray], List[float], np.ndarray],
        t: Union[float, List[float], np.ndarray] = 0.0,
    ) -> Dict[str, np.ndarray]:
    ...
    def get_fluxes_dict(
        self,
        y: Union[Dict[str, float], Dict[str, List[float]], Dict[str, np.ndarray], np.ndarray, List[float]],
        t: Union[float, List[float], np.ndarray] = 0.0,
    ) -> Dict[str, np.ndarray]:
    ...
    def _get_rhs(self, t: Union[float, List[float], np.ndarray], y: List[np.ndarray]) -> np.ndarray:
