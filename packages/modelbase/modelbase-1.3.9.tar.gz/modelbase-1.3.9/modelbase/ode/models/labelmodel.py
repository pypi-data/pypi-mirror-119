...
def total_concentration(*args: float) -> List[np.ndarray]:
...
class LabelModel(Model):
    ...
    def __init__(
        ...
        rate_stoichiometries: Dict[str, Dict[str, int]] = None,
        rates: dict = None,
        meta_info: dict = None,
    ):
    ...
    def update_labelmap_reaction(
        ...
        stoichiometry: Dict[str, int] = None,
        labelmap: List[int] = None,
        modifiers: List[str] = None,
        parameters: List[str] = None,
    ...
    def generate_y0(
        ...
        label_positions: Dict[str, Union[int, List[int]]] = None,
    ) -> Dict[str, float]:
