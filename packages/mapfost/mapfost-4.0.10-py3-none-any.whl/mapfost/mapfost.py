...
def est_aberr(test_ims, test_aberrs, pix_size_um=0.08, num_aperture=0.004, stig_rot_deg=0,stig_scale=1,use_bessel=False,crop_ref=(0,0),crop_size=(512,512),test_ims_aligned=0):
    test_ims_cropped = [
...
def test_installation():
    ...
    res = est_aberr([im1, im2], [[-4,0,0],[4,0,0]])
