...
from domain.xlsx_elements.sheet import Sheet
...
from domain.engine.engine_cell_value_types import EngineCellValueTypes
from modules.format_cell_value import format_cell_value
...
class EngineSheet(Sheet):
    ...
    def get_electronic_elements(
        ...
        while True:
            ...
            # TODO: Create distribution section and return engine and distribution sections
            ...
            if cell_value_type is EngineCellValueTypes.ENGINE_SECTION:
                ...
                elements[-1].section_elements.append(self.get_element_component(col_index, row_index))
            elif cell_value_type is EngineCellValueTypes.ELEMENT_ATTRIBUTE:
                elements[-1].section_elements[-1].element_attributes.append(self.get_component_attribute(col_index, row_index))
