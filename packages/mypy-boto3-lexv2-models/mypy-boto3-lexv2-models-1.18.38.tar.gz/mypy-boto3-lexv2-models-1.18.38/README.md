...
[boto3.LexModelsV2 1.18.38](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/lexv2-models.html#LexModelsV2)
...
def check_value(value: BotAliasAvailableWaiterName) -> bool:
    ...
```
