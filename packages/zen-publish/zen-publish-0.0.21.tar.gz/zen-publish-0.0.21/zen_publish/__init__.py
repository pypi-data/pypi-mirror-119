...
@click.command()
@click.option('--path', prompt='path of report or dashboard?', default=os.getcwd(), help="folder to look into")
@click.option('--type', prompt='which type of document are you creating?', default="python", help="which type of document are you creating?")
...
cli.add_command(create_config_w)
