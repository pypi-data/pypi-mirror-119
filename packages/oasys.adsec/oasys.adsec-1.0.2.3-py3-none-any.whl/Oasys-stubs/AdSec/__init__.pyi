...
class IAdSec(metaclass=ABCMeta):
    ...
    def Flatten(self, section: ISection) -> ISection:
        ...
        that has perimeter profiles for all its section components. In case of a reinforced section,
        the reinforcement that lie within a section component are grouped into multiple
...
class IServiceabilityResult(metaclass=ABCMeta):
    ...
    def MaximumWidthCrack(self) -> ICrack:
        ...
        :exception System.ArgumentNullException: If MaximumWidthCrack is set to null
        """
        pass
