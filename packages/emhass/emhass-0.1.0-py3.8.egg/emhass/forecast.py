...
from emhass.utils import get_root, get_logger, get_days_list
...
class forecast(ABC):
    ...
    def __init__(self, retrieve_hass_conf, optim_conf, plant_conf, opt_time_delta=24):
        """
    ...
    def get_power_from_weather(self, df_weather):
        ...
        mc = ModelChain(system, location, orientation_strategy="None", aoi_model="physical")
    ...
    def get_load_forecast(self, days_min_load_forecast=3, method='naive',
        ...
        if method == 'csv' or method == 'naive': # using a naive approach
            ...
            if method == 'csv': # reading from a csv file
                ...
                load_csv_file_path = root + csv_path
