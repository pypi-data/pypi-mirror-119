...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.toolButton_select_sqlite_file = QToolButton(self.groupBox_3)
        ...
        sizePolicy2.setHeightForWidth(self.toolButton_select_sqlite_file.sizePolicy().hasHeightForWidth())
        self.toolButton_select_sqlite_file.setSizePolicy(sizePolicy2)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/Spine_symbol.png", QSize(), QIcon.Normal, QIcon.Off)
