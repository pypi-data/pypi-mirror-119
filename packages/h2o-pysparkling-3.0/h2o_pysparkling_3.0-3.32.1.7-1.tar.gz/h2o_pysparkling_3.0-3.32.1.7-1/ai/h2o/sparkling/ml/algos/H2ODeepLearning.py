...
class H2ODeepLearning(H2ODeepLearningParams, H2OCommonParams, H2OSupervisedAlgorithmWithFoldColumn, DistributionBasedH2OTrainFramePreparation):
    ...
    def __init__(self,
        ...
        if 'variableImportances' in kwargs:
            if 'calculateFeatureImportances' not in kwargs:
                kwargs['calculateFeatureImportances'] = kwargs['variableImportances']
            del kwargs['variableImportances']
            warn("The parameter 'variableImportances' is deprecated and will be removed in the version 3.36.")
