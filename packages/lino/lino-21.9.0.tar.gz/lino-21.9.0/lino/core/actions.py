...
class Action(Parametrizable, Permittable):
    ...
    argument and should return a JavaScript runnable wrapped inside a function.
    An example use case is defined in
    :class:`lino.modlib.help.models.OpenHelpWindow` where the return string
    follows the format::
    ...
    Callable Example::
        ...
        def js_handler(self, actor):
            ...
            return JS_RUNABLE_INSIDE_A_WRAPPER_FUNCTION
