class Flavor:
    ...
    @staticmethod
    def get_js():
        return """var container_md = document.getElementById('container_md');
var copy_md = document.getElementById('copy_md');
var action_md = document.getElementById('action_md');;

// Refresh Form State
function refresh() {
    if (container_md.style.display == '') {
        action_md.innerText = '-';
        copy_md.style.display = '';
    } else {
        action_md.innerText = '+';
        copy_md.style.display = 'none';
    }
};
...
function func_md() {
    if (container_md.style.display == '') {
        container_md.style.display = 'none';
    } else {
        container_md.style.display = '';
    }
    refresh();
};
...
function copy() {
    ...
    r.selectNode(document.getElementById('container_md'));
    window.getSelection().removeAllRanges();
    window.getSelection().addRange(r);
    document.execCommand('copy');
    window.getSelection().removeAllRanges();
    alert('Markdown data copied to clipboard.');
}

// Download Markdown
function downloadCurrentDocument() {
    var base64doc = btoa(unescape(encodeURIComponent(container_md.innerText))),
        a = document.createElement('a'),
        e = new MouseEvent('click');

    a.download = 'blmarkdown-output.md';
    ...
    @staticmethod
    def get_css():
        return """/* repo-name : sindresorhus/github-markdown-css */

/* source : https://github.com/sindresorhus/github-markdown-css */

/* source-file : https://github.com/sindresorhus/github-markdown-css/blob/main/github-markdown.css */
