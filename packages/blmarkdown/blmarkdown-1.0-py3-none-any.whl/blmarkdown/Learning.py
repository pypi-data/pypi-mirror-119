...
class Learning:
    ...
    def compile(self, keep_file_on_complete=False, file_name='-preview'):
        Utill.compile_viewer(self.get_markdown(),
                             keep_file_on_complete, App.APP_INFO['APP_NAME'] + file_name)

    # Save Function
    # def save_html(self, file_name=''):
    #     return Utill.save_html(self.get_markdown(), file_name)

    def save_markdown(self, file_name=''):
        return Utill.save_markdown(self.get_markdown(), file_name)

    # Get Function
    # def get_html(self):
    #     return Utill.get_html(self.get_markdown())
