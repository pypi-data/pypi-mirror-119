...
"")
        ...
        self.comboBox_ee.addItem("")
        self.comboBox_ee.addItem("")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.comboBox_ee)
        ...
        self.comboBox_obsmodel.addItem("")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.comboBox_obsmodel)
        ...
        self.horizontalLayout_3.addWidget(self.lineEdit_signal)
        self.pushButton_signal = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_signal.setObjectName("pushButton_signal")
        self.horizontalLayout_3.addWidget(self.pushButton_signal)
        self.verticalLayout.addLayout(self.horizontalLayout_3)
        self.label_gt = QtWidgets.QLabel(self.groupBox)
        self.label_gt.setEnabled(False)
        self.label_gt.setObjectName("label_gt")
        self.verticalLayout.addWidget(self.label_gt)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setContentsMargins(11, 11, 11, 11)
        self.horizontalLayout_2.setSpacing(6)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.lineEdit_gt = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_gt.setEnabled(False)
        self.lineEdit_gt.setReadOnly(True)
        self.lineEdit_gt.setObjectName("lineEdit_gt")
        self.horizontalLayout_2.addWidget(self.lineEdit_gt)
        self.pushButton_gtSearch = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_gtSearch.setEnabled(False)
        self.pushButton_gtSearch.setAutoDefault(False)
        self.pushButton_gtSearch.setObjectName("pushButton_gtSearch")
        self.horizontalLayout_2.addWidget(self.pushButton_gtSearch)
        self.verticalLayout.addLayout(self.horizontalLayout_2)
        self.pushButton_signal.raise_()
        self.label_7.raise_()
        self.lineEdit_signal.raise_()
        self.lineEdit_gt.raise_()
        self.label_gt.raise_()
        self.verticalLayout_2.addWidget(self.groupBox)
        spacerItem = QtWidgets.QSpacerItem(17, 9, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.gridLayout.addWidget(self.checkBox_save, 1, 0, 1, 1)
        self.checkBox_save_error = QtWidgets.QCheckBox(self.centralWidget)
        self.checkBox_save_error.setEnabled(False)
        self.checkBox_save_error.setObjectName("checkBox_save_error")
        self.gridLayout.addWidget(self.checkBox_save_error, 2, 0, 1, 1)
        ...
        self.checkBox_save_error.raise_()
        MainWindow.setCentralWidget(self.centralWidget)
        self.menuBar = QtWidgets.QMenuBar(MainWindow)
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 468, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Select input file or webcam video"))
        self.lineEdit_signal.setText(_translate("MainWindow", "webcam"))
        self.pushButton_signal.setText(_translate("MainWindow", "Examine ..."))
        self.label_gt.setText(_translate("MainWindow", "Select annotations file to calculate the algorithm error"))
        self.pushButton_gtSearch.setText(_translate("MainWindow", "Examine ..."))
        self.label_runs.setText(_translate("MainWindow", "Number of algorithm runs:"))
        self.checkBox_save.setText(_translate("MainWindow", "Save estimation"))
        self.checkBox_save_error.setText(_translate("MainWindow", "Save error"))
