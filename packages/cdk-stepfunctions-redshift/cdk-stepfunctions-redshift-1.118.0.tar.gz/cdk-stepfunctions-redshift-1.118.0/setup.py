    ...
    """
{
    ...
    "package_data": {
        "cdk_stepfunctions_redshift._jsii": [
            "cdk-stepfunctions-redshift@1.118.0.jsii.tgz"
        ],
        "cdk_stepfunctions_redshift": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-stepfunctions-tasks==1.118.0",
        "aws-cdk.aws-stepfunctions==1.118.0",
        "aws-cdk.core==1.118.0",
        "aws-solutions-constructs.aws-eventbridge-sqs==1.118.0",
        "aws-solutions-constructs.aws-lambda-dynamodb==1.118.0",
        "aws-solutions-constructs.aws-sqs-lambda==1.118.0",
