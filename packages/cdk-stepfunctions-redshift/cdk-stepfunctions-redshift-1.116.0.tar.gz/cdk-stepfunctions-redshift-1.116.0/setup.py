    ...
    """
{
    ...
    "package_data": {
        "cdk_stepfunctions_redshift._jsii": [
            "cdk-stepfunctions-redshift@1.116.0.jsii.tgz"
        ],
        "cdk_stepfunctions_redshift": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-python==1.116.0",
        ...
        "aws-solutions-constructs.aws-eventbridge-sqs==1.116.0",
        "aws-solutions-constructs.aws-lambda-dynamodb==1.116.0",
        "aws-solutions-constructs.aws-sqs-lambda==1.116.0",
