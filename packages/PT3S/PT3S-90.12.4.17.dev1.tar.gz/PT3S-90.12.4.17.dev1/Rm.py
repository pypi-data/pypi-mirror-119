...
def dfSegsNodesNDataDpkt(
    ...
    try:      
        ...
        dfSegsNodes=dfSegsNodes[['SEGName','SEGNodes','SEGOnlyInLDSPara','NODEsRef_max','NODEsSEGLfdNr','NODEsSEGLfdNrType','NODEsName','OBJTYPE']]
...
def plotDfAlarmEreignisse(    
    ...
    try:                     
        ...
        df=dfAlarmEreignisse[['Nr','LDSResBaseType','Voralarm','Type','NrSD','tA','tE','tD','ZHKNR','Name','Orte','tD_ZHKNR','NrName','NrSEGName','SEGName']].copy()
        ...
        df=df[['Nr','LDSResBaseType','NrSD','tA','tE','tD','ZHKNR','Name','NrName','NrSEGName','SEGName','tD_ZHKNR']]#,'Orte']]
        ...
        df=df[['Nr','ResTyp - Voralarm','NrSD','tA','tD','ZHKNR','ZHKName','NrName','NrSEGName (SEGName)','ZHKZeit']]
