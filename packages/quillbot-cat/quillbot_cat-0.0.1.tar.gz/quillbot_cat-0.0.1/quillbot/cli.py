...
from quillbot.api.main import Server
from quillbot.api.appbuilder import BuildServerApp
...
def execute():
    parser = argparse.ArgumentParser(prog="quillbot_api", description='Quillbot API')
    ...
    api_parser.add_argument("-t", "--timeout", type=int, default=600, help='Timeout value')
