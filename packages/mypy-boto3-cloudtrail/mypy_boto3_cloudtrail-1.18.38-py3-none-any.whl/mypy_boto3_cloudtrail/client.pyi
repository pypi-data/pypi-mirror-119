...
class CloudTrailClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client)
    ...
    def add_tags(self, *, ResourceId: str, TagsList: List["TagTypeDef"] = None) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.add_tags)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.can_paginate)
    ...
    def create_trail(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.create_trail)
    ...
    def delete_trail(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.delete_trail)
    ...
    def describe_trails(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.describe_trails)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.generate_presigned_url)
    ...
    def get_event_selectors(self, *, TrailName: str) -> GetEventSelectorsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.get_event_selectors)
    ...
    def get_insight_selectors(self, *, TrailName: str) -> GetInsightSelectorsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.get_insight_selectors)
    ...
    def get_trail(self, *, Name: str) -> GetTrailResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.get_trail)
    ...
    def get_trail_status(self, *, Name: str) -> GetTrailStatusResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.get_trail_status)
    ...
    def list_public_keys(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.list_public_keys)
    ...
    def list_tags(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.list_tags)
    ...
    def list_trails(self, *, NextToken: str = None) -> ListTrailsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.list_trails)
    ...
    def lookup_events(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.lookup_events)
    ...
    def put_event_selectors(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.put_event_selectors)
    ...
    def put_insight_selectors(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.put_insight_selectors)
    ...
    def remove_tags(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.remove_tags)
    ...
    def start_logging(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.start_logging)
    ...
    def stop_logging(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.stop_logging)
    ...
    def update_trail(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Client.update_trail)
    ...
    def get_paginator(self, operation_name: Literal["list_public_keys"]) -> ListPublicKeysPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Paginator.ListPublicKeys)
    ...
    def get_paginator(self, operation_name: Literal["list_tags"]) -> ListTagsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Paginator.ListTags)
    ...
    def get_paginator(self, operation_name: Literal["list_trails"]) -> ListTrailsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Paginator.ListTrails)
    ...
    def get_paginator(self, operation_name: Literal["lookup_events"]) -> LookupEventsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.38/reference/services/cloudtrail.html#CloudTrail.Paginator.LookupEvents)
