...
class Orm:
    ...
    @classmethod
    def required_arrow_duration(cls, description: str = None) -> ArrowDurationField:
        return ArrowDurationField(required=True, description=description)

    @classmethod
    def nullable_arrow_duration(cls, description: str = None) -> ArrowDurationField:
        return ArrowDurationField(required=False, description=description)
