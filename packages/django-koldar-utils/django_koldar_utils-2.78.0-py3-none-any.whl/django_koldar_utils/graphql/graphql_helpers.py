...
class ArrowDateTimeScalar(Scalar):
    ...
    @staticmethod
    def serialize(dt: Union[Arrow, datetime.datetime, str]) -> str:
...
def create_graphql_class(cls, fields=None, specify_fields: Dict[str, Tuple[type, Callable[[any, any], any]]]=None) -> type:
    """
