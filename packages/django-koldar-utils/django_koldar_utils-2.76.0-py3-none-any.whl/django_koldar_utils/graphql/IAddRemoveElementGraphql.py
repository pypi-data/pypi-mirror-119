...
from django_koldar_utils.django import django_helpers, auth_decorators
...
# todo create class that manages only nn, only 0-1 and so on
# class
#
#
# class SimpleNNAddRemoveElementGraphQL(StandardObjectFetching, PassMutationClassNameFromKwArgs, AllowsAuthentication, IAddRemoveElementGraphql):
#     """
#     create adds and remve mutation that manage a particular NN relation that does not have a through table
#     """
#
