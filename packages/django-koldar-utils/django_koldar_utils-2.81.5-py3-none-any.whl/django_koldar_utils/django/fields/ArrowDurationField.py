...
from django_koldar_utils.django.fields import ArrowDateFieldForm
from django_koldar_utils.django.fields.ArrowDurationFieldForm import ArrowDurationFieldForm
from django_koldar_utils.django.fields.ArrowFieldForm import ArrowFieldForm
...
class ArrowDurationField(models.DurationField):
    ...
    def from_db_value(self, value, expression, connection) -> Optional[float]:
        """
        ...
        if value is None:
            ...
            delta: datetime.timedelta = aniso8601.parse_duration(value)
    ...
    def get_prep_value(self, value: Optional[arrow.Arrow]) -> Optional[float]:
        """
    ...
    def to_python(self, value: Optional[Union[arrow.Arrow, str]]) -> Optional[timedelta]:
        """
