...
class ICrudOperationNamer(abc.ABC):
    ...
    def get_read_all_return_value_name(self, django_type: type, django_filter_type: type) -> Optional[str]:
        ...
        :param django_type: type of the django model (the one extending models.Model)
        :param django_filter_type: type of a class representing a django query set filter (the one that will be
...
class GraphQLHelper(object):
    ...
    @classmethod
    def create_authenticated_list_from_callable(cls, django_type: type, django_graphql_type: type,
                                  permissions_required: List[str],
                                  query_description: str = None,
                                  query_arguments: Dict[str, type] = None,
    ...
    def create_query(cls, query_class_name: str, description: str, arguments: Dict[str, type],
        ...
        assert not isinstance(return_type,
                              graphene.Field), f"return type {return_type} of {query_class_name} does not need to be a field, but a plain ObjectType!"
    ...
    @classmethod
    def generate_query_from_lambda(cls, django_type: type, django_graphql_type: type,
                                       return_single: bool,
                                       query_description: str = None,
                                       query_arguments: Dict[str, graphene.Field] = None,
                                       ...
                                       query_output_return_type: type = None,
                                       token_name: str = None) -> type:
        """
