...
class GraphQLHelper(object):
    ...
    def create_query(cls, query_class_name: str, description: str, arguments: Dict[str, type],
        ...
        assert hasreturn_type._meta.isinstance(return_type, (graphene.List, graphene.Scalar, graphene.ObjectType, graphene_django.DjangoObjectType)), \
             f"return type {type(return_type)} of {query_class_name} does not need to be a field, but a plain ObjectType!"
