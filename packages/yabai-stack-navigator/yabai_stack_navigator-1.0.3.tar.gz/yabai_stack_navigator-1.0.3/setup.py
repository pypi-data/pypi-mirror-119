...
long_description = """
A simple script to make navigating between stacks and windows in Yabai(https://github.com/koekeishiya/yabai) easier. 

Details at https://github.com/sendhil/yabai-stack-navigator.
"""
