from kraken_aliyun_api_gateway_sdk.com.aliyun.api.gateway.sdk.http.request import Request
import ssl
...
class Response(Request):
    def __init__(self, host=None, url=None, method=constant.GET, headers={}, protocol=constant.HTTP, content_type=None,
        ...
        Request.__init__(self, host=host, protocol=protocol, url=url,
                         headers=headers, method=method, time_out=time_out)
