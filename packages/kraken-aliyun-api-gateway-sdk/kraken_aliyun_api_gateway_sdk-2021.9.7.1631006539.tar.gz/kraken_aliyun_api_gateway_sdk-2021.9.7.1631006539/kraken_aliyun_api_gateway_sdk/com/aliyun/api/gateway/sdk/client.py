...
import json
from kraken_aliyun_api_gateway_sdk.com.aliyun.api.gateway.sdk.util import UUIDUtil, DateUtil
from kraken_aliyun_api_gateway_sdk.com.aliyun.api.gateway.sdk.http.response import Response
from kraken_aliyun_api_gateway_sdk.com.aliyun.api.gateway.sdk.common import constant
from kraken_aliyun_api_gateway_sdk.com.aliyun.api.gateway.sdk.auth import md5_tool, signature_composer, sha_hmac256
...
class DefaultClient:
    ...
    def build_headers(self, request=None):
        ...
        if constant.POST == request.get_method() and constant.CONTENT_TYPE_STREAM == request.get_content_type():
            headers[constant.HTTP_HEADER_CONTENT_MD5] = md5_tool.get_md5_base64_str(
                request.get_body())
