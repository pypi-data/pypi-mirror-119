...
def update(
    ...
    NOTICE: Any customer fields in the CSV file itself will be ignored. The customer specified in the CLI will be used regardless.

    :param customer: Customer shortname or ID
    :param file: Path to CSV file
    :param format: CSV format (available fields: address (alias Network), description, subnet_mask (optional, can be part of the address), zone, LocationShortName, Flags)
    :param first_line_defines_format: If set, --format will be ignored and the CSV file is assumed to define the fields on the first line. Must include the fields mentioned in --format.
