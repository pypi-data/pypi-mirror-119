...
class ServerApi:
            ...
            while 1:
                try:
                    ...
                    if r.status_code == 200:
                        ...
                        logging.error(f'【client/data】服务器异常,状态码：{r.text}')
        ...
        while 1:
            ...
            try:
                ...
                if r.status_code == 200:
                    ...
                    logging.error(f'【/client/task】服务器异常 {r.text}')
            except OSError:
    ...
    def task_callback(self, value, is_success=True):
        ...
        while 1:
            ...
            try:
                ...
                if r.status_code == 200:
                    logging.error(f'【/client/task/callback】 code is 200 {r.text} instance_id: {self.instance_id}')
                    return
                else:
    ...
    def nginx_store_api(self, item, data_type):
        ...
        self.session.request(method='POST', url=store_url, headers=headers, json=data)
