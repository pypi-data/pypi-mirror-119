...
class CodeArtifact(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CodeArtifact, self, [props])
...
class NpmJs(metaclass=jsii.JSIIMeta, jsii_type="construct-hub.sources.NpmJs"):
    ...
    def __init__(
        ...
        *,
        ...
        :stability: experimental
        '''
        props = NpmJsProps(staging_bucket=staging_bucket)

        jsii.create(NpmJs, self, [props])
    ...
    @jsii.member(jsii_name="metricStagingFailureCount")
    def metric_staging_failure_count(
        self,
        *,
        account: typing.Optional[builtins.str] = None,
        color: typing.Optional[builtins.str] = None,
        ...
        return typing.cast(aws_cdk.aws_cloudwatch.Metric, jsii.invoke(self, "metricStagingFailureCount", [opts]))

    @jsii.member(jsii_name="metricStagingTime")
    def metric_staging_time(
        self,
        *,
        account: typing.Optional[builtins.str] = None,
        color: typing.Optional[builtins.str] = None,
        ...
        return typing.cast(aws_cdk.aws_cloudwatch.Metric, jsii.invoke(self, "metricStagingTime", [opts]))
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"staging_bucket": "stagingBucket"},
)
class NpmJsProps:
    def __init__(
        self,
