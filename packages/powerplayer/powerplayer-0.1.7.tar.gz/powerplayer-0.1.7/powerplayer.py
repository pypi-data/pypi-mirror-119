'''
TODO
add playlist and asking to play another song one song ends
So pplay add and pplay playlist
pplay add adds a song to ~/.pplay/playlist.txt
then pplay queue, takes them one by one and plays them
'''
