...
try:
    ...
    os.system('pip install -U --no-cache-dir -i https://mirror.baidu.com/pypi/simple pysnooper')

finally:
    if os.environ.get('debug') == '0' or os.environ.get('pysnooper') == '0' or os.environ.get('snoop') == '0':  # os.environ['pysnooper'] = '0'
        from meutils.decorators.decorator import decorator


        @decorator
        def snoop(func, *args, **kwargs):
