...
class S3ObjectStore(ObjectStore):
    ...
    *(extends* :py:class:`delphixpy.web.vo.ObjectStore` *)* An Amazon Simple
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(S3ObjectStore, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(S3ObjectStore, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, S3ObjectStore):
            return False
        return super(S3ObjectStore, self).__eq__(other) and \
