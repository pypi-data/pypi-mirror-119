...
class IscsiTarget(PersistentObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.PersistentObject` *)* Configuration
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(IscsiTarget, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._iqn[0] is not None and obj._iqn[0] is not obj.__undef__:
            assert isinstance(obj._iqn[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._iqn[0], type(obj._iqn[0])))
        ...
        if obj._portal[0] is not None and obj._portal[0] is not obj.__undef__:
            assert isinstance(obj._portal[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._portal[0], type(obj._portal[0])))
        ...
        if obj._chap_username[0] is not None and obj._chap_username[0] is not obj.__undef__:
            assert isinstance(obj._chap_username[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._chap_username[0], type(obj._chap_username[0])))
        ...
        if obj._chap_password[0] is not None and obj._chap_password[0] is not obj.__undef__:
            assert isinstance(obj._chap_password[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._chap_password[0], type(obj._chap_password[0])))
        ...
        if obj._chap_username_in[0] is not None and obj._chap_username_in[0] is not obj.__undef__:
            assert isinstance(obj._chap_username_in[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._chap_username_in[0], type(obj._chap_username_in[0])))
        ...
        if obj._chap_password_in[0] is not None and obj._chap_password_in[0] is not obj.__undef__:
            assert isinstance(obj._chap_password_in[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._chap_password_in[0], type(obj._chap_password_in[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(IscsiTarget, self).to_dict(dirty, belongs_to_parent)
        ...
        if "iqn" == "type" or (self.iqn is not self.__undef__ and (not (dirty and not self._iqn[1]) or isinstance(self.iqn, list) or belongs_to_parent)):
            dct["iqn"] = dictify(self.iqn)
        if "portal" == "type" or (self.portal is not self.__undef__ and (not (dirty and not self._portal[1]) or isinstance(self.portal, list) or belongs_to_parent)):
        ...
        if "port" == "type" or (self.port is not self.__undef__ and (not (dirty and not self._port[1]) or isinstance(self.port, list) or belongs_to_parent)):
            ...
            dct["port"] = 3260
        if "chap_username" == "type" or (self.chap_username is not self.__undef__ and (not (dirty and not self._chap_username[1]) or isinstance(self.chap_username, list) or belongs_to_parent)):
            dct["chapUsername"] = dictify(self.chap_username)
        if "chap_password" == "type" or (self.chap_password is not self.__undef__ and (not (dirty and not self._chap_password[1]) or isinstance(self.chap_password, list) or belongs_to_parent)):
            dct["chapPassword"] = dictify(self.chap_password)
        if "chap_username_in" == "type" or (self.chap_username_in is not self.__undef__ and (not (dirty and not self._chap_username_in[1]) or isinstance(self.chap_username_in, list) or belongs_to_parent)):
            dct["chapUsernameIn"] = dictify(self.chap_username_in)
        if "chap_password_in" == "type" or (self.chap_password_in is not self.__undef__ and (not (dirty and not self._chap_password_in[1]) or isinstance(self.chap_password_in, list) or belongs_to_parent)):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IscsiTarget):
            return False
        return super(IscsiTarget, self).__eq__(other) and \
