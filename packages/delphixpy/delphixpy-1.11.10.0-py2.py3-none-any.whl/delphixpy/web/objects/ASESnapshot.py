    ...
    *(extends* :py:class:`delphixpy.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._db_encryption_key[0] is not None and obj._db_encryption_key[0] is not obj.__undef__:
            assert isinstance(obj._db_encryption_key[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._db_encryption_key[0], type(obj._db_encryption_key[0])))
