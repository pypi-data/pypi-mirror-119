...
class Tunable(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The name of the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(Tunable, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(Tunable, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Tunable):
            return False
        return super(Tunable, self).__eq__(other) and \
