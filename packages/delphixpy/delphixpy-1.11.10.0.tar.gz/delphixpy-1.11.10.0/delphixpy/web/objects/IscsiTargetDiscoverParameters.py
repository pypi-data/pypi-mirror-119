...
class IscsiTargetDiscoverParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Parameters for
    ...
    def __init__(self, undef_enabled=True):
        super(IscsiTargetDiscoverParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(IscsiTargetDiscoverParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(IscsiTargetDiscoverParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IscsiTargetDiscoverParameters):
            return False
        return super(IscsiTargetDiscoverParameters, self).__eq__(other) and \
