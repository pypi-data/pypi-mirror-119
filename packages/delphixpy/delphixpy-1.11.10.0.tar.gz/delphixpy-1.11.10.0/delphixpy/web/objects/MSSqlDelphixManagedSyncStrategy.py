...
class MSSqlDelphixManagedSyncStrategy(MSSqlSourceSyncStrategy):
    ...
    *(extends* :py:class:`delphixpy.web.vo.MSSqlSourceSyncStrategy` *)* MSSQL
    ...
    def __init__(self, undef_enabled=True):
        super(MSSqlDelphixManagedSyncStrategy, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(MSSqlDelphixManagedSyncStrategy, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MSSqlDelphixManagedSyncStrategy, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MSSqlDelphixManagedSyncStrategy):
            return False
        return super(MSSqlDelphixManagedSyncStrategy, self).__eq__(other) and \
