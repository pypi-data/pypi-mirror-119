...
class MSSqlExternalManagedSourceSyncStrategy(MSSqlSourceSyncStrategy):
    ...
    *(extends* :py:class:`delphixpy.web.vo.MSSqlSourceSyncStrategy` *)* MSSQL
    ...
    def __init__(self, undef_enabled=True):
        super(MSSqlExternalManagedSourceSyncStrategy, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(MSSqlExternalManagedSourceSyncStrategy, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(MSSqlExternalManagedSourceSyncStrategy, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MSSqlExternalManagedSourceSyncStrategy):
            return False
        return super(MSSqlExternalManagedSourceSyncStrategy, self).__eq__(other) and \
