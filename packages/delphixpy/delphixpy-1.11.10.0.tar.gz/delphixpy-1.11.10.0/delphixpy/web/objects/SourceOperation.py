...
class SourceOperation(Operation):
    ...
    *(extends* :py:class:`delphixpy.web.vo.Operation` *)* A user-specifiable
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "credentials_env_vars_list" == "type" or (self.credentials_env_vars_list is not self.__undef__ and (not (dirty and not self._credentials_env_vars_list[1]) or isinstance(self.credentials_env_vars_list, list) or belongs_to_parent)):
