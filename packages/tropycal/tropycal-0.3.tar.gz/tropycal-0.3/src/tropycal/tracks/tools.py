...
def calculate_distance(lat1,lat2,lon1,lon2):
    ...
    step1 = math.cos(math.radians(90.0-lat1))
    step2 = math.cos(math.radians(90.0-lat2))
    step3 = math.sin(math.radians(90.0-lat1))
    step4 = math.sin(math.radians(90.0-lat2))
    step5 = math.cos(math.radians(lon1-lon2))
    dist = math.acos(step1 * step2 + step3 * step4 * step5) * r_earth
