...
class TestLimStrategies(unittest.TestCase):
    ...
    def test_quarterly_all(self):
        res = limstrategies.quarterly('Show 1: FP/7.45-FB', quarter=0, start_date=pd.to_datetime('2020-01-01'),
                                      start_year=2020)
    ...
    def test_spread_formula_standard(self):
    ...
    def test_spread_formula_quarterly(self):
    ...
    def test_spread_formula_calendar(self):
    ...
    def test_multi_spread(self):
        res = limstrategies.multi_spread('Show 1: FP/7.45-FB', spreads=[[6, 6], [12, 12]], start_year=2020,
    ...
    def test_fly2(self):
        res = limstrategies.fly('Show 1: FP/7.45-FB', x=1, y=2, z=3, start_year=2019, end_year=2020,
