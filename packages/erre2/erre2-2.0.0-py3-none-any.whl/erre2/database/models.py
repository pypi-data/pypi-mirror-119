...
from erre2_0.database.schemas import User as UserSchema
from erre2_0.database.schemas import Course as CourseSchema
from erre2_0.database.schemas import Commit as CommitSchema

from erre2_0.database.db import Base
