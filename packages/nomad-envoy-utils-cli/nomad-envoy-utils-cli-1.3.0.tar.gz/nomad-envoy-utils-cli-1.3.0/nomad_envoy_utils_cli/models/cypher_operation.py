...
class CypherOperation(object):
    ...
    allowed enum values
    """
    AREALLENCRYPTED = "AreAllEncrypted"
    ENCRYPTBATCH = "EncryptBatch"
    DECRYPTBATCH = "DecryptBatch"

    allowable_values = [AREALLENCRYPTED, ENCRYPTBATCH, DECRYPTBATCH]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CypherOperation - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CypherOperation):
            return False
