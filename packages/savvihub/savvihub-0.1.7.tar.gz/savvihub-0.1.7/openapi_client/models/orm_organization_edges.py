...
class OrmOrganizationEdges(object):
    ...
    def __init__(self, billing_histories=None, default_kernel_cluster=None, default_storage=None, default_volume=None, notification_configs=None, primary_owner=None, user_organization=None, local_vars_configuration=None):  # noqa: E501
