...
from savvihub.util.constant import WEB_HOST
...
def format_size(value: int, suffix="B") -> str:
    ...
    for unit in ["", "K", "M", "G", "T", "P", "E", "Z"]:
        ...
        value /= 1024.0
    return f"{value:.1f} Yi{suffix}" % (value, "Yi", suffix)
...
def generic_prompter(text: str, type: click.ParamType = click.STRING) -> Callable:
    def prompter(ctx: click.Context, param: click.Parameter, value: str):
        return click.prompt(text, type=type)
