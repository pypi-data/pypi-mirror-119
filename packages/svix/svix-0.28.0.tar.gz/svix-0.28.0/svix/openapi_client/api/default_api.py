...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __webhook_model_api_v1_internal_webhook_model_openapi_get(
            self,
            webhook_types,
            **kwargs
        ):
            """Webhook Model  # noqa: E501

            A helper to automatically generate OpenAPI models for the webhook schemas  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.webhook_model_api_v1_internal_webhook_model_openapi_get(webhook_types, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['webhook_types'] = \
                webhook_types
            return self.call_with_http_info(**kwargs)

        self.webhook_model_api_v1_internal_webhook_model_openapi_get = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/v1/internal-webhook-model-openapi/',
                'operation_id': 'webhook_model_api_v1_internal_webhook_model_openapi_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__webhook_model_api_v1_internal_webhook_model_openapi_get
        )
