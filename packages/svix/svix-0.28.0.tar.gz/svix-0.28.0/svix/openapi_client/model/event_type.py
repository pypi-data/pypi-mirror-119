...
class EventType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.., must be one of ["message.attempt.exhausted", "endpoint.disabled", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["message.attempt.exhausted", "endpoint.disabled", ]  # noqa: E501
