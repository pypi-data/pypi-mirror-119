...
===========
    ...
    **BOTD** an attempt to achieve OS level integration of bot technology directly
    ...
    "display in your irc channel" functionality to the unix programmer.
    **BOTD** runs on both BSD and Linux, is placed in the Public Domain, and,
    one day, will be the thing you cannot do without ;]
