...
class AmlLabeledDatasetHelper:
    ...
    def get_file_name_list(self) -> List[str]:
        ...
        :rtype: list(str)
        """
        return cast(List[str], self.images_df[AmlLabeledDatasetHelper.PORTABLE_PATH_COLUMN_NAME].tolist())
    ...
    def create(run: Run, datastore: Datastore, labeled_dataset_file: str, target_path: str,
               task: str, labeled_dataset_factory: _LabeledDatasetFactory,
    ...
    def _get_column_name(ds: AmlDataset,
        ...
        if parent_column_property in ds._properties:
            ...
            if AmlLabeledDatasetHelper.COLUMN_PROPERTY in image_property:
                return cast(str, image_property[AmlLabeledDatasetHelper.COLUMN_PROPERTY])
