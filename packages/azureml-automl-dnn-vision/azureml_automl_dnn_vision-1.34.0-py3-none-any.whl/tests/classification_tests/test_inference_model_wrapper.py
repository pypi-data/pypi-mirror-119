...
class TestInferenceModelWrapper:
    ...
    def test_score(self, root_dir, image_dir, src_image_list_file_name):
        ...
        model_factory = ModelFactory()
        for model_name in model_factory._models_dict.keys():
            self._score_test(model_name, root_dir, image_dir, image_class_list_file_path, 4, 10)
    ...
    def test_score_invalid_image_file(self, root_dir, image_dir, image_list_file_name):
        with tempfile.TemporaryDirectory() as tmp_output_dir:
            ...
            default_model_name = ModelFactory()._default_model
            self._score_test(default_model_name, root_dir, image_dir, temp_image_class_list_file_path,
                             expected_score_file_length, 10)
            self._score_test(default_model_name, root_dir, image_dir, temp_image_class_list_file_path,
                             expected_score_file_length, 1)

    @staticmethod
    def _score_test(model_name, root_dir, image_dir, image_class_list_file_path,
