...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', '3.1.0-alpha.1631186436+3f8b8a7e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq 3.1.0-alpha.1631186436+3f8b8a7e`
                """)
            else:
                raise
