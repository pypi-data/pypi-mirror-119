...
def load_resource(filename):
    path = str(Path("static", "resources", filename))
    with pkg_resources.resource_stream(__name__, path) as stream:
...
class Webdriver:
    ...
    def _load_resources(self):
        self.resources = {
            ...
            "guide": load_resource("guide.html"),
        }
    ...
    def show_guide(self):
        guide = self.resources["guide"].encode("utf-8")
