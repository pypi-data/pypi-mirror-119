...
feature_serialize_parameters = {
    ...
    1: {
        ...
        "return_value": {"geometry": geometry_to_wkb(feature_dpt_geometry_only_a['geometry'])}
    },
    2: {
...
feature_deserialize_parameters = {
    0: {
        "serialized_feature": {"attributes": str(feature_dpt_data_only_a['attributes'])},
        "bbox": True,
    ...
    2: {
        "serialized_feature": {"geometry": geometry_to_wkb(feature_dpt_geometry_only_a['geometry'])},
        "bbox": True,
    ...
    3: {
        "serialized_feature": {"geometry": geometry_to_wkb(feature_dpt_geometry_only_a['geometry'])},
        "bbox": False,
        "return_value": {"geometry": {'type':  feature_dpt_geometry_only_a['geometry']['type'], 'coordinates': feature_dpt_geometry_only_a['geometry']['coordinates']}},
    },
    4: {
        "serialized_feature": {
            "geometry": geometry_to_wkb(feature_dpt_geometry_only_a['geometry']),
    ...
    5: {
        ...
        "return_value": {
            ...
            "geometry": {
                ...
                "coordinates": feature_dpt_data_and_geometry_a['geometry']['coordinates']
            },
        }
    }
}
...
features_geometry_ref_scan_parameters = {
    ...
    4: {
        ...
        'extent': False,
        'return_value': {'type': {'Point', 'LineString', 'Polygon', 'MultiPoint', 'MultiLineString', 'MultiPolygon', 'GeometryCollection'}, "extent": None},
    },
    5: {
        'geolayer_or_feature_list': geolayer_fr_dept_geometry_only,
        'extent': False,
    ...
    8: {
        'geolayer_or_feature_list': feature_list_geometry_only,
        'extent': True,
        'return_value': {'type': {'Polygon', 'MultiPolygon'}, "extent": (202166.0, 6704696.0, 790134.0, 6997000.0)},
    },
    9: {
        'geolayer_or_feature_list': feature_list_geometry_only_with_all_geometries,
        'extent': True,
        'return_value': {'type': {'Point', 'LineString', 'Polygon', 'MultiPoint', 'MultiLineString', 'MultiPolygon', 'GeometryCollection'}, "extent": (-157.97, -34.29, 35.12, 77.95)},
    }
}
...
features_fields_type_scan_parameters = {
    ...
    45: {
        "geolayer_or_feature_list": [{'attributes': {"shape_leng": 3358.17440629}},{'attributes': {"shape_leng": 58.1744062917440629}}],
...
feature_list_to_geolayer_parameters = {
            ...
            "features": {
                0: {
                    "attributes": {
                        ...
                        "field_string": None,
                        "field_date": datetime.datetime(year=2020, month=3, day=31, hour=11, minute=22, second=10, microsecond=999).date(),  # 5
                        "field_time": '18:41:04',
                ...
                1: {
                    "attributes": {
                        ...
                        "field_datetime": datetime.datetime(year=2020, month=3, day=31, hour=11, minute=22, second=10, microsecond=999),
                ...
                2: {
                    "attributes": {
                        ...
                        "field_string_list": "['hi', 'mister']",
                        "field_time": "11:22:10.000999",
                        "field_datetime": datetime.datetime(year=2020, month=3, day=31, hour=0, minute=0, second=0, microsecond=0),
        ...
        "return_value": {
            "metadata": {
                ...
                "fields": {
                    ...
                    'field_real_list': {'type': 'RealList', 'width': 9, 'precision': 4, 'index': 3},
                    'field_string': {'type': 'String', 'width': 26, 'index': 4},
                    'field_date': {'type': 'Date', 'index': 5},
                    'field_time': {'type': 'Time', 'index': 6},
                    'field_binary': {'type': 'Binary', 'index': 7},
                    'field_boolean': {'type': 'Boolean', 'index': 8},
                    'field_string_list': {'type': 'StringList', 'width': 16, 'index': 9},
        ...
        "return_value": {
            "metadata": {
                ...
                "fields": {
                    ...
                    'field_real': {'index': 2, 'precision': 5, 'type': 'Real', 'width': 9},
                    'field_real_list': {'index': 3, 'precision': 5, 'type': 'RealList', 'width': 10},
        ...
        "return_value": {
            "metadata": {
                ...
                "fields": {
                    ...
                    'field_integer': {'index': 0, 'type': 'Integer'},
                    'field_integer_list': {'index': 1, 'type': 'IntegerList'},
                    'field_real': {'index': 2, 'type': 'Real', 'precision':5, 'width': 9},
                    'field_real_list': {'index': 3, 'precision': 5, 'type': 'RealList', 'width': 10},
                    'field_string': {'index': 4, 'type': 'String', 'width': 5},
                    'field_string_list': {'index': 5, 'type': 'StringList', 'width': 8},
                    'field_time': {'index': 7, 'type': 'Time'}
    ...
    6: {
        ...
        "return_value": {
            ...
            "features": {                0: feature_geometry_only_point,
    ...
    7: {
        ...
        "return_value": {
            ...
            "features": {
                0: {"geometry": {"type": "Point", "coordinates": point_coordinates, 'bbox': (-115.81, 37.24, -115.81, 37.24)}},
                1: feature_geometry_only_point_empty,
                2: {"geometry": {"type": "LineString", "coordinates": linestring_coordinates, 'bbox': (8.919, 44.4074, 8.923, 44.4075)}},
                3: feature_geometry_only_linestring_empty,
                4: {"geometry": {"type": "Polygon", "coordinates": polygon_coordinates, 'bbox': (-120.43, -20.28, 23.194, 57.322)}},
                5: feature_geometry_only_polygon_empty,
                6: {"geometry": {"type": "MultiPoint", "coordinates": multipoint_coordinates, 'bbox': (-157.97, 19.61, -155.52, 21.46)}},
                7: feature_geometry_only_multipoint_empty,
                8: {"geometry": {"type": "MultiLineString", "coordinates": multilinestring_coordinates, 'bbox': (-130.95, -34.25, 23.15, 77.95)}},
                9: feature_geometry_only_multilinestring_empty,
                10: {"geometry": {"type": "MultiPolygon", "coordinates": multipolygon_coordinates, 'bbox': (-130.91, -34.29, 35.12, 77.91)}},
                11: feature_geometry_only_multipolygon_empty,
                12: {"geometry": {'type': 'GeometryCollection', 'geometries': [{'type': 'Point', 'coordinates': [-115.81, 37.24], 'bbox': (-115.81, 37.24, -115.81, 37.24)}, {'type': 'LineString', 'coordinates': [[8.919, 44.4074], [8.923, 44.4075]], 'bbox': (8.919, 44.4074, 8.923, 44.4075)}, {'type': 'Polygon', 'coordinates': [[[2.38, 57.322], [23.194, -20.28], [-120.43, 19.15], [2.38, 57.322]], [[-5.21, 23.51], [15.21, -10.81], [-20.51, 1.51], [-5.21, 23.51]]], 'bbox': (-120.43, -20.28, 23.194, 57.322)}, {'type': 'MultiPoint', 'coordinates': [[-155.52, 19.61], [-156.22, 20.74], [-157.97, 21.46]], 'bbox': (-157.97, 19.61, -155.52, 21.46)}, {'type': 'MultiLineString', 'coordinates': [[[3.75, 9.25], [-130.95, 1.52]], [[23.15, -34.25], [-1.35, -4.65], [3.45, 77.95]]], 'bbox': (-130.95, -34.25, 23.15, 77.95)}, {'type': 'MultiPolygon', 'coordinates': [[[[3.78, 9.28], [-130.91, 1.52], [35.12, 72.234], [3.78, 9.28]]], [[[23.18, -34.29], [-1.31, -4.61], [3.41, 77.91], [23.18, -34.29]]]], 'bbox': (-130.91, -34.29, 35.12, 77.91)}], 'bbox': (-157.97, -34.29, 35.12, 77.95)}},
                13: feature_geometry_only_collection_empty,
                14: {"geometry": {'type': 'GeometryCollection', 'geometries': [{'type': 'Point', 'coordinates': []}, {'type': 'LineString', 'coordinates': [[8.919, 44.4074], [8.923, 44.4075]], 'bbox': (8.919, 44.4074, 8.923, 44.4075)}, {'type': 'Polygon', 'coordinates': [[[2.38, 57.322], [23.194, -20.28], [-120.43, 19.15], [2.38, 57.322]], [[-5.21, 23.51], [15.21, -10.81], [-20.51, 1.51], [-5.21, 23.51]]], 'bbox': (-120.43, -20.28, 23.194, 57.322)}, {'type': 'MultiPoint', 'coordinates': []}, {'type': 'MultiLineString', 'coordinates': [[[3.75, 9.25], [-130.95, 1.52]], [[23.15, -34.25], [-1.35, -4.65], [3.45, 77.95]]], 'bbox': (-130.95, -34.25, 23.15, 77.95)}, {'type': 'MultiPolygon', 'coordinates': []}], 'bbox': (-130.95, -34.25, 23.194, 77.95)}},
            }
        }
    },
    8: {
...
feature_filter_geometry_parameters = {
    ...
    27: {
        ...
        "return_value": {'type': 'GeometryCollection', 'geometries': [
            ...
            {'type': 'LineString', 'coordinates': [[8.919, 44.4074], [8.923, 44.4075]],
             'bbox': (8.919, 44.4074, 8.923, 44.4075)}, {'type': 'Polygon', 'coordinates': [
                [[2.38, 57.322], [23.194, -20.28], [-120.43, 19.15], [2.38, 57.322]],
                [[-5.21, 23.51], [15.21, -10.81], [-20.51, 1.51], [-5.21, 23.51]]],
                                                         'bbox': (-120.43, -20.28, 23.194, 57.322)},
            {'type': 'MultiPoint', 'coordinates': [[-155.52, 19.61], [-156.22, 20.74], [-157.97, 21.46]],
             'bbox': (-157.97, 19.61, -155.52, 21.46)}, {'type': 'MultiLineString',
                                                         'coordinates': [[[3.75, 9.25], [-130.95, 1.52]],
                                                                         [[23.15, -34.25], [-1.35, -4.65],
                                                                          [3.45, 77.95]]],
                                                         'bbox': (-130.95, -34.25, 23.15, 77.95)},
            {'type': 'MultiPolygon', 'coordinates': [[[[3.78, 9.28], [-130.91, 1.52], [35.12, 72.234], [3.78, 9.28]]], [
                [[23.18, -34.29], [-1.31, -4.61], [3.41, 77.91], [23.18, -34.29]]]],
             'bbox': (-130.91, -34.29, 35.12, 77.91)}], 'bbox': (-157.97, -34.29, 35.12, 77.95)}
    },
    28: {
        ...
        "bbox_filter": None,
        "bbox": True,
        "return_value": {'type': 'GeometryCollection', 'geometries': [{'type': 'Point', 'coordinates': []},
                                                                      {'type': 'LineString',
                                                                       'coordinates': [[8.919, 44.4074],
                                                                                       [8.923, 44.4075]],
    ...
    29: {
        ...
        "return_value": {
            ...
            'geometries': [
                ...
                {'type': 'LineString','coordinates': [[8.919, 44.4074], [8.923, 44.4075]]},
                {'type': 'Polygon', 'coordinates': [[[2.38, 57.322], [23.194, -20.28], [-120.43, 19.15],
                                                     [2.38, 57.322]], [[-5.21, 23.51], [15.21, -10.81],
                                                                       [-20.51, 1.51], [-5.21, 23.51]]],
                },
                {'type': 'MultiPoint', 'coordinates': []},
                {'type': 'MultiLineString', 'coordinates': [[[3.75, 9.25], [-130.95, 1.52]], [[23.15, -34.25],
                                                                                              [-1.35, -4.65],
                                                                                              [3.45, 77.95]]],
                },
                {'type': 'MultiPolygon', 'coordinates': []}],
    ...
    33: {
        ...
        "geometry_type_filter": 'Point',
        "bbox_filter": ((-115.81, 37.24, -115.81, 37.24), (23.194, -20.28, 23.194, -20.28)),
        "bbox": False,
        "return_value": {'type': 'Point', 'coordinates': [-115.81, 37.24]}
    },
    34: {
        ...
        "bbox_filter": ((-115.81, 37.24, -115.81, 37.24), (23.194, -20.28, 23.194, -20.28)),
        "bbox": False,
        "return_value": {'type': 'Polygon', 'coordinates': [[[2.38, 57.322], [23.194, -20.28], [-120.43, 19.15], [2.38, 57.322]], [[-5.21, 23.51], [15.21, -10.81], [-20.51, 1.51], [-5.21, 23.51]]]}
    },
    35: {
        "feature": feature_geometry_only_collection,
        "geometry_type_filter": None,
        "bbox_filter": ((-115.81, 37.24, -115.81, 37.24), (23.194, -20.28, 23.194, -20.28)),
        "bbox": False,
        "return_value": {'type': 'GeometryCollection', 'geometries': [{'type': 'Point', 'coordinates': [-115.81, 37.24]}, {'type': 'LineString', 'coordinates': [[8.919, 44.4074], [8.923, 44.4075]]}, {'type': 'Polygon', 'coordinates': [[[2.38, 57.322], [23.194, -20.28], [-120.43, 19.15], [2.38, 57.322]], [[-5.21, 23.51], [15.21, -10.81], [-20.51, 1.51], [-5.21, 23.51]]]}, {'type': 'MultiPoint', 'coordinates': [[-155.52, 19.61], [-156.22, 20.74], [-157.97, 21.46]]}, {'type': 'MultiLineString', 'coordinates': [[[3.75, 9.25], [-130.95, 1.52]], [[23.15, -34.25], [-1.35, -4.65], [3.45, 77.95]]]}, {'type': 'MultiPolygon', 'coordinates': [[[[3.78, 9.28], [-130.91, 1.52], [35.12, 72.234], [3.78, 9.28]]], [[[23.18, -34.29], [-1.31, -4.61], [3.41, 77.91], [23.18, -34.29]]]]}]}
    }
}
...
feature_filter_parameters = {
    ...
    18: {
        ...
        "bbox": False,
        "return_value": {
            "attributes": {'NOM_DEPT': feature_dpt_data_and_geometry_a['attributes']['NOM_DEPT']},
    ...
    27: {
        ...
        "bbox_filter": [(-10, -10, 10, 10), (382900, 6743400, 474400, 6834000)],
        "bbox": False,
        "return_value": {"attributes": {'NOM_DEPT': feature_dpt_data_and_geometry_a['attributes']['NOM_DEPT']},
                         'geometry': feature_dpt_data_and_geometry_a['geometry']}
    },
}
...
def test_all():
    ...
    # features_geometry_ref_scan
    print(test_function(features_geometry_ref_scan, features_geometry_ref_scan_parameters))

    # features_fields_type_scan
    print(test_function(features_fields_type_scan, features_fields_type_scan_parameters))
    ...
    # feature_filter_attributes
    print(test_function(feature_filter_attributes, feature_filter_attributes_parameters))
    ...
    # check_if_value_is_from_datetime_lib
    print(test_function(check_if_value_is_from_datetime_lib, check_if_value_is_from_datetime_lib_parameters))
    ...
    # check_if_value_is_datetime
    print(test_function(check_if_value_is_datetime, check_if_value_is_datetime_parameters))

    # return_if_value_is_time_date_or_datetime
    print(test_function(return_if_value_is_time_date_or_datetime, return_if_value_is_time_date_or_datetime_parameters))
