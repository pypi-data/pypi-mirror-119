...
# Industry Info
path =  pathlib.Path(__file__).parent.parent / pathlib.Path('data/china_industries.json')
# with open(path, 'r', encoding='utf-8') as f:
#     d = json.load(f)
#     for i1 in d:
#         d1 = copy.deepcopy(i1)
#         CHINA_INDUSTRY_INFO[i1['name']] = d1
#         d1['children'] = {}
#         for i2 in i1['children']:
#             d2 = copy.deepcopy(i2)
#             d1['children'][i2['name']] = d2
#             d2['children'] = {}
#             for i3 in i2['children']:
#                 d3 = copy.deepcopy(i3)
#                 d2['children'][i3['name']] = d3
#                 d3['children'] = {}
#                 for i4 in i3['children']:
#                     d4 = copy.deepcopy(i4)
#                     d3['children'][i4['name']] = d4
#                     d4['children'] = {}


with open(path, 'r', encoding='utf-8') as f:
    CHINA_INDUSTRY_INFO = json.load(f)
