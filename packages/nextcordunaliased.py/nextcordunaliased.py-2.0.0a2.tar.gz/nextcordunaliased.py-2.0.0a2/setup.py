...
names = ["nextcord", "nextcord.py", "nextcordunaliased", "nextcordunaliased.py"]
...
#pr = {}
for i in names:
    run_setup(i, "unalised" not in i)
    #pr[i] = mp.Process(target=run_setup, args=(i, "unalised" not in i))
    #pr[i].start()
#for i in names:
    #pr[i].join()
