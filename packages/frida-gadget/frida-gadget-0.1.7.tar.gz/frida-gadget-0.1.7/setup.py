...
setuptools.setup(
    ...
    install_requires=['click', 'frida==15.1.1', 'androguard'],
    long_description=long_description,
    long_description_content_type="text/x-rst",
    url="https://github.com/ksg97031/frida-gadget",
    packages=setuptools.find_packages(),
    package_data={'scripts':
             ["files/libfrida-gadget-15.1.1-android-arm.so", "files/libfrida-gadget-15.1.1-android-arm64.so", "files/libfrida-gadget-15.1.1-android-x86.so"]},
    entry_points={
        'console_scripts': [
