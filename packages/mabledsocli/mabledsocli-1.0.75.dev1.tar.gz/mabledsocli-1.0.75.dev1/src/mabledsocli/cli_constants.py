...
CLI_PARAMETERS_HELP = {
    'common': {
        ...
        'stage' : "Requested a specific stage using the stage identifier, which is combination of a name and an optional number, where name must conform to ^([a-zA-Z][a-zA-Z0-9]+)$ regex expression. If no /<number> is specified, the default environment (/0) in the given context will be requested.",
        ...
        'project_scope': "Use the project scope.",
        ...
        'project': "Override the project in the context.",
    ...
    'config': {
        ...
        'override_locally': "Explicitly override inherited configurations locally. If mixed with '-i' / '--input' option, it will casue the local configuration to be merged with the provided input configuration.",
...
CLI_MESSAGES = {
    ...
    'ParameterNotFound': "Parameter '{0}' not found in the given context: namespace={1}, project={2}, application={3}, stage={4}",
    'SecretNotFound': "Secret '{0}' not found in the given context: namespace={1}, project={2}, application={3}, stage={4}",
    'TemplateNotFound': "Template '{0}' not found in the given context: namespace={1}, project={2}, application={3}, stage={4}",
