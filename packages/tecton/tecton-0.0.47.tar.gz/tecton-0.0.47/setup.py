...
setuptools.setup(
    ...
    extras_require={'databricks-connect': ['databricks_connect~=6.4.28'], 'databricks-connect7': ['databricks-connect~=7.3.22'], 'pyspark': ['pyspark==2.4.4'], 'pyspark3': ['pyspark==3.0.1']},
    packages=packages,
)
