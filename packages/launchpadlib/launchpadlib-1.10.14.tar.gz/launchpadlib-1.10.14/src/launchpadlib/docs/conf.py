...
latex_documents = [
    (master_doc, 'launchpadlib.tex', u'launchpadlib Documentation',
...
man_pages = [
    (master_doc, 'launchpadlib', u'launchpadlib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'launchpadlib', u'launchpadlib Documentation',
     author, 'launchpadlib', 'One line description of project.',
     'Miscellaneous'),
]
