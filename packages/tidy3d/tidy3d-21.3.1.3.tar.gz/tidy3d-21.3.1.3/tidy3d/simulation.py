...
class Simulation(object):
    ...
    def __init__(
        ...
        self.Np = np.prod(self.grid_sym.Nxyz)
    ...
    def _update_freq_range(self):
        ...
        for source in self.sources:
            ...
            fmins.append(src_time.frequency - src_time.fwidth)
            fmaxs.append(src_time.frequency + src_time.fwidth)
    ...
    def compute_modes(self, mode_object, Nmodes, target_neff=None,
        ...
        pml_layers : tuple, optional
            Number of PML layers to be added in each direction.
