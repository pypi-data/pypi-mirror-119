...
def find_elements_by_text(driver, text, tag_name=''):
    ...
    text_elements = []
    if len(tag_name) > 0:
        text_elements = driver.find_elements_by_xpath(
    ...
    #     value_elements = driver.find_elements_by_xpath("//*[@value='{0}']".format(text))
    #     if value_elements and len(value_elements) > 0:
    #         elements.extend(value_elements)

    #     placeholder_elements = driver.find_elements_by_xpath("//*[@placeholder='{0}']".format(text))
    #     if placeholder_elements and len(placeholder_elements) > 0:
    #         elements.extend(placeholder_elements)
