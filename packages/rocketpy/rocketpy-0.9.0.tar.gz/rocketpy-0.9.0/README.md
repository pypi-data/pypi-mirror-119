...
The main Python library is kept under the **_nkbs_** folder and is currently named **_rocketpy.py_**. Keep in mind that the files are still being organized for a proper release.
