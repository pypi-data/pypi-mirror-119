...
from graml.template_parser import TemplateParser
from graml.node import Node
from graml.routing import Router
from graml.utils import print_warning
...
class GraphRuntime(Node):
    ...
    def add_graph(self, graph_name: str, template: dict, template_settings: dict):
        """
        ...
        new_graph = TemplateParser(template, template_settings, self.router)
