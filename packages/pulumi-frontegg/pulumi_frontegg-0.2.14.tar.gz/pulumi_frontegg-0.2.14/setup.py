...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'frontegg', '0.2.14', '--server', 'https://github.com/benesch/pulumi-frontegg/releases/download/v0.2.14/'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource frontegg 0.2.14`
                """)
            else:
                raise
...
setup(name='pulumi_frontegg',
      ...
      url='https://github.com/benesch/pulumi-frontegg',
      project_urls={
