...
class TQueryOptions(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.enabled_runtime_filter_types = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 105:
                if ftype == TType.BOOL:
    ...
    def write(self, oprot):
        ...
        if self.enabled_runtime_filter_types is not None:
            oprot.writeFieldBegin('enabled_runtime_filter_types', TType.I32, 104)
            oprot.writeI32(self.enabled_runtime_filter_types)
            oprot.writeFieldEnd()
...
class TPlanExecInfo(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i25 in range(_size21):
                        _elem26 = Planner.ttypes.TPlanFragment()
                        _elem26.read(iprot)
                ...
                if ftype == TType.MAP:
                    ...
                    for _i31 in range(_size27):
                        ...
                        _val33 = Planner.ttypes.TScanRangeSpec()
                        _val33.read(iprot)
                        self.per_node_scan_ranges[_key32] = _val33
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.per_node_scan_ranges is not None:
            ...
            for kiter35, viter36 in self.per_node_scan_ranges.items():
...
class TQueryExecRequest(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i41 in range(_size37):
                        _elem42 = TPlanExecInfo()
                        _elem42.read(iprot)
                        self.plan_exec_info.append(_elem42)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i47 in range(_size43):
                        _elem48 = Types.ttypes.TNetworkAddress()
                        _elem48.read(iprot)
                        self.host_list.append(_elem48)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.plan_exec_info is not None:
            ...
            for iter49 in self.plan_exec_info:
                iter49.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
TQueryOptions.thrift_spec = (
    ...
    (104, TType.I32, 'enabled_runtime_filter_types', None, 3, ),  # 104
