...
class TEnabledRuntimeFilterTypes(object):
    BLOOM = 1
    MIN_MAX = 2
    ALL = 3
...
class TRuntimeFilterTargetDesc(object):
    ...
    def __init__(self, node_id=None, target_expr=None, is_bound_by_partition_columns=None, target_expr_slotids=None, is_local_target=None, kudu_col_name=None, kudu_col_type=None, low_value=None, high_value=None, is_min_max_value_present=None,):
...
class THdfsScanNode(object):
    ...
    def __init__(self, tuple_id=None, collection_conjuncts=None, replica_preference=None, random_replica=None, skip_header_line_count=None, use_mt_scan_node=None, min_max_conjuncts=None, min_max_tuple_id=None, dictionary_filter_conjuncts=None, parquet_count_star_slot_offset=None, is_partition_key_scan=None, file_formats=None, overlap_predicate_descs=None,):
    ...
    def write(self, oprot):
        ...
        if self.min_max_conjuncts is not None:
            ...
            for iter70 in self.min_max_conjuncts:
                iter70.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TPlanNode(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i248 in range(_size244):
                        ...
                        self.row_tuples.append(_elem249)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i254 in range(_size250):
                        ...
                        self.nullable_tuples.append(_elem255)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i260 in range(_size256):
                        _elem261 = Exprs.ttypes.TExpr()
                        _elem261.read(iprot)
                        self.conjuncts.append(_elem261)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i266 in range(_size262):
                        _elem267 = TPipelineMembership()
                        _elem267.read(iprot)
                        self.pipelines.append(_elem267)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i272 in range(_size268):
                        _elem273 = TRuntimeFilterDesc()
                        _elem273.read(iprot)
                        self.runtime_filters.append(_elem273)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 25:
    ...
    def write(self, oprot):
        ...
        if self.row_tuples is not None:
            ...
            for iter274 in self.row_tuples:
        ...
        if self.nullable_tuples is not None:
            ...
            for iter275 in self.nullable_tuples:
        ...
        if self.runtime_filters is not None:
            ...
            for iter277 in self.runtime_filters:
                iter277.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.resource_profile is not None:
