...
class TUpdateExecutorMembershipRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.ip_addresses is not None:
            ...
            for iter174 in self.ip_addresses:
...
class TGetJvmMemoryMetricsResponse(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i179 in range(_size175):
                        _elem180 = TJvmMemoryPool()
                        _elem180.read(iprot)
                        self.memory_pools.append(_elem180)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.memory_pools is not None:
            ...
            for iter181 in self.memory_pools:
                iter181.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i186 in range(_size182):
                        _elem187 = TJvmThreadInfo()
                        _elem187.read(iprot)
                        self.threads.append(_elem187)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetAllHadoopConfigsResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.configs is not None:
            ...
            for kiter196, viter197 in self.configs.items():
...
class TBuildTestDescriptorTableParams(object):
                ...
                if ftype == TType.LIST:
                    ...
                    for _i209 in range(_size205):
                        ...
                        for _i215 in range(_size211):
                            _elem216 = Types.ttypes.TColumnType()
                            _elem216.read(iprot)
                            _elem210.append(_elem216)
                        iprot.readListEnd()
                        self.slot_types.append(_elem210)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.slot_types is not None:
            ...
            for iter217 in self.slot_types:
                oprot.writeListBegin(TType.STRUCT, len(iter217))
...
class TTestCaseData(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i223 in range(_size219):
                        _elem224 = CatalogObjects.ttypes.TTable()
                        _elem224.read(iprot)
                        self.tables_and_views.append(_elem224)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i229 in range(_size225):
                        _elem230 = CatalogObjects.ttypes.TDatabase()
                        _elem230.read(iprot)
                        self.dbs.append(_elem230)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.tables_and_views is not None:
            ...
            for iter231 in self.tables_and_views:
                iter231.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dbs is not None:
...
class TWrappedHttpRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.params is not None:
            ...
            for kiter254, viter255 in self.params.items():
        ...
        if self.headers is not None:
            ...
            for kiter256, viter257 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            for kiter258, viter259 in self.cookies.items():
...
class TWrappedHttpResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.headers is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.headers))
            for kiter274, viter275 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.cookies))
            for kiter276, viter277 in self.cookies.items():
