...
class TDdlExecRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.debug_action is not None:
            oprot.writeFieldBegin('debug_action', TType.STRING, 26)
...
class TPartialPartitionInfo(object):
    ...
    def __init__(self, id=None, name=None, hms_partition=None, file_descriptors=None, insert_file_descriptors=None, delete_file_descriptors=None, partition_stats=None, has_incremental_stats=None, is_marked_cached=None, hms_parameters=None, write_id=None, hdfs_storage_descriptor=None, location=None,):
        self.id = id
        self.name = name
...
class TPartialTableInfo(object):
    ...
    def __init__(self, hms_table=None, partitions=None, column_stats=None, storage_metadata_load_time_ns=None, network_addresses=None, sql_constraints=None, valid_write_ids=None, is_marked_cached=None, partition_prefixes=None,):
...
TDdlExecRequest.thrift_spec = (
    ...
    (26, TType.STRING, 'debug_action', None, None, ),  # 26
)
