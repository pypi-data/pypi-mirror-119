...
class TIcebergTable(object):
    ...
    def __init__(self, table_location=None, partition_spec=None, default_partition_spec_id=None, path_hash_to_file_descriptor=None, snapshot_id=None, parquet_compression_codec=None, parquet_row_group_size=None, parquet_plain_page_size=None, parquet_dict_page_size=None,):
    ...
    def write(self, oprot):
        ...
        if self.snapshot_id is not None:
            oprot.writeFieldBegin('snapshot_id', TType.I64, 5)
...
TIcebergTable.thrift_spec = (
    ...
    (5, TType.I64, 'snapshot_id', None, None, ),  # 5
