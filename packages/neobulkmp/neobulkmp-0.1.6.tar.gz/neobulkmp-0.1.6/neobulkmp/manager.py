...
class Manager:
    ...
    def log_status(self):
        ...
        cache_storage_level_data = f"{round(100 - ((self.strategy._get_cache_size() * 100) / self.strategy._get_cache_size_total()))}% ({humanfriendly.format_size(self.strategy._get_available_memory())} free of {humanfriendly.format_size(self.strategy._get_cache_size_total())})"
