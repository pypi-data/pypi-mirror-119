...
with open(join(CURDIR, 'src', 'lab_orchestrator_ws_proxy', '__init__.py'), "r", encoding="utf-8") as f:
...
setup(
    ...
    description="A Proxy for KubeVirts VNC Websockets. Uses JWT Tokens for Authentication and to transfer data.",
    long_description=LONG_DESCRIPTION,
    long_description_content_type="text/markdown",
    url="https://github.com/LabOrchestrator/WebsocketProxy",
