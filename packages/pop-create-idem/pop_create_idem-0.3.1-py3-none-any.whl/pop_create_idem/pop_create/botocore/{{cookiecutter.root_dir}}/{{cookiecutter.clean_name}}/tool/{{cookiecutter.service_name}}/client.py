...
async def exec_(hub, ctx, service_name:str, operation:str, op_kwargs:Dict[str, Any]) -> Dict[str, Any]:
    with ctx.acct.session.create_client(service_name=service_name, **ctx.acct.client_kwargs) as client:
