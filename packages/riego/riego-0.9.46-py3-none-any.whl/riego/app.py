...
# Put app as subapp under main_app and create an approbiate redirection
    ...
    async def on_startup(app):
        ...
        # Todo finde den Grund der xecption
...
def _setup_logging(options=None):
    ...
    if options.enable_aiohttp_access:
        #Funktioniert nicht, da  weiter oben u.U. "access_log=None"
...
# Logging
    ...
    p.add('--log_backup_count', help='How many files to rotate, -1 to disable',
          default=20, type=int)
# Secrets & Scurity
...
# Debug
    ...
    p.add('--enable_aiohttp_access', action='store_true')
