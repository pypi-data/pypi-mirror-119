...
class unsupervisedInterface:
    ...
    def generate_dataset(self):
        filesFolder = os.path.join(os.path.dirname(self.configini),'csv','features_extracted')
    ...
    def perform_DR(self):
        ...
        behaviour = concatDf.pop('Attack').values
        ...
        if (self.algorithm.getChoices() == 'UMAP'):
                ...
                for neigh in neighbors:
                    for spr in spread:
                        for index, comps in enumerate(UMAP_dimensions):
                            ...
                            npyName = os.path.join(outputDirectory, 'UMAP_reduced_features_spread_' + str(
                            ...
                            #plt.show()
                            pngName = os.path.join(outputDirectory, 'UMAP_reduced_features_spread_' + str(
                                spr) + '_neighbors_' + str(neigh) + '_dist_' + str(dist) + '_dimensions_' + str(
                                comps) + '.png')
                            plt.savefig(pngName)
            ...
            for perp in perplexity:
                for iter in iterations:
                    for index, comps in enumerate(TSNE_dimensions):
                        ...
                        npyName = os.path.join(outputDirectory, 't-SNE_reduced_features_perplexity_' + str(
                        ...
                        pngName = os.path.join(outputDirectory, 't-SNE_reduced_features_perplexity_' + str(
            ...
            npyName = os.path.join(outputDirectory, 'PCA_reduced_features' + '.npy')
            np.save(npyName, outputNp)
            print('Saved ' + str(npyName))
