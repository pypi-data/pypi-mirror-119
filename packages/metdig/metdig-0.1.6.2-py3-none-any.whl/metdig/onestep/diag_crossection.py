...
if __name__ == '__main__':
    ...
    wind_theta_absv(init_time='2016070620',st_point=[20,115],ed_point=[40,115.1],data_source='cds',data_name='era5',
                    absv_contourf_kwargs={'xdim':'lat_cross','levels':range(-14,15,2)} ,
                    theta_contour_kwargs={'xdim':'lat_cross'},
                    uv_barbs_kwargs={'xdim':'lat_cross'},
