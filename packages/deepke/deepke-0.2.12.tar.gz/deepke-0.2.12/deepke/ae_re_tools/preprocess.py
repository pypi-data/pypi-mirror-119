...
from ae_re_utils import save_pkl, load_csv
...
#     attribute_data = load_csv('/home/tlk/deepke_ae/data/origin/attribute.csv')
#     atts = _handle_attribute_data(attribute_data)
#     print(atts)
#     train_data = load_csv('/home/tlk/deepke_ae/data/origin/train.csv')
#     _add_attribute_data(atts, train_data)
#     print(train_data)
