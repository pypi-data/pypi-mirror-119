...
from re_re_utils import save_pkl, load_csv
...
# def preprocess_data(cfg , predata):
#     """
#     Args:
#         cfg :配置文件
#         predata : 待处理数据集
#     """
#     predata_fp = os.path.join(cfg.cwd, cfg.data_path, predata)
#     predata_data = load_csv(predata_fp)
#     if predata == 'relation.csv':
#         rels = _handle_relation_data(predata_data)
#     else:
#         _add_relation_data(rels,predata_data)
#     if cfg.model_name == 'lm':
#         _lm_serialize(predata_data, cfg)
#     else:
#         serializer = Serializer(do_chinese_split=cfg.chinese_split, do_lower_case=True)
#         serial = serializer.serialize
#         _serialize_sentence(predata_data, serial, cfg)
