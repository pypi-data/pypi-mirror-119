...
class SdkInterface():
    ...
    def GetChestBoxSize(self, pos, dimensionId=-1):
    ...
    def SetChestBoxItemNum(self, pos, slotPos, num, dimensionId=-1):
    ...
    def GetEntitiesInArea(self, startPos, endPos, dimensionId=-1):
    ...
    def SetEntityModAttr(self, entityId, paramName, paramValue):
