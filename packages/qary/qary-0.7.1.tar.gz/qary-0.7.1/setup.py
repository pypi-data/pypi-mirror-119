...
{'': ['*'],
 'qary.data': ['book_smarts/*',
               ...
               'testsets/dialog_parser.input.v2.dialog.yml',
               'testsets/dialog_parser.input.v2.dialog.yml',
               'testsets/dialog_parser.input.v3.dialog.yml',
               'testsets/dialog_parser.input.v3.dialog.yml',
               'testsets/dialog_parser.input.v3.dialog.yml',
               'testsets/dialog_parser.input.v3.dialog.yml',
               'testsets/dialog_parser.input.v3.dialog.yml',
