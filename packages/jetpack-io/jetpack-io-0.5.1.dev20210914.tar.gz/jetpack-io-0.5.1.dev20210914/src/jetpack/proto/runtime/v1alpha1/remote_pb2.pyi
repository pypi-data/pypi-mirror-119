...
class RemoteJob(google.protobuf.message.Message):
    ...
    # Target module id where the qualified symbol is located
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"container_image",b"container_image",u"encoded_args",b"encoded_args",u"module_id",b"module_id",u"namespace",b"namespace",u"qualified_symbol",b"qualified_symbol"]) -> None: ...
