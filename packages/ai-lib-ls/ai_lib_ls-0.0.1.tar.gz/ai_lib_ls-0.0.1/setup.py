...
setuptools.setup(
    name="ai_lib_ls",                                     # 包的分发名称，使用字母、数字、_、-
    version="0.0.1",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="qaufue",                                       # 作者名字
    author_email="qaufue@gmail.com",                      # 作者邮箱
    description="PyPI Tutorial python  封装包",                            # 包的简介描述
    ...
    url="https://gitee.com/qaufue/python_lib.git",                              # 项目开源地址，大家可以写自己真实的开源网址
