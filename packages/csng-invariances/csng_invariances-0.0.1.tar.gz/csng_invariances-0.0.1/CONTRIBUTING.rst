...
CSNG-Invariances could always use more documentation, whether as part of the
official CSNG-Invariances docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_csng_invariances
