...
static PyObject* alpha_calculation(PyObject *self, PyObject *args){
...
static char alpha_docs[] =
    "usage: starkit.alpha_calculation(xt, yt, zt, x, y, z, w, sizes, limAlpha)";

/* deprecated: 
static PyMethodDef uniqueCombinations_funcs[] = {
    {"alpha_calculation", (PyCFunction)alpha_calculation, 
     METH_NOARGS, alpha_calculation_docs},
    {NULL}
};
...
/* deprecated : 
PyMODINIT_FUNC init_alpha_calculation(void)
{
    Py_InitModule3("alpha_calculation", alpha_calculation_funcs,
                   "Extension module alpha_calculation v. 1.0");
}
*/
...
static struct PyModuleDef starkit =
{
    ...
    "usage: starkit.alpha_calculation(a5, b5, c5, a6, a7, a8, a9, a10, b10, c10, sizes, limAlpha)\n", /* module documentation, may be NULL */
