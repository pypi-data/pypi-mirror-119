...
d_nconv = {
    ...
    # tiff codex
    's_round_codex': 'cyc',
    's_quenching_codex': None,  # one character string used to label quenching rounds, the first and last round is Blank
    's_sep_marker_codex': None,  #!
    's_sep_markerclone_codex': None,  #!
    ...
    # bue 20210914: what is reallt essential?
    # slide, mscene, round, marker(s), color, imagetype! 
    ...
    # @ codex tiff fils
    's_regex_tiff_codex': r'(reg[^_]+_cyc[^_]+)_(ch[^_]+)_([^\.]+)\.(tiff?)',
    'di_regex_tiff_codex': {'mscene':1, 'round':2, 'color':3, 'marker':4, 'filetype':5}, # used? filetype
    # slide: foldername
    ...
    #'s_format_tiff_afsubreg': is same as s_regex_tiff_reg but imagetype differs
    #'s_regex_tiff_afsubreg': is same as s_regex_tiff_reg but imagetype differs
    #'di_regex_tiff_afsubreg': is same as s_regex_tiff_reg but imagetype differs
