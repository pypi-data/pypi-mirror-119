...
from hestia_earth.models.schererPfister2015.nErosionAllOrigins import MODEL, TERM_ID, run, _should_run
...
def test_should_run(mock_pcorr, mock_ef_p_c2, mock_p_ef_c1, mock_practice_factor, mock_measurement, _m):
    cycle = {
        'inputs': [],
        'measurements': [],
        'site': {
