...
Example: in the Canadian concrete design code it is recognized that `sqrt(1*MPa)` results in units of `MPa` instead of `MPa⁰'⁵`. Here is one way this can be managed in `forallpeople`:
