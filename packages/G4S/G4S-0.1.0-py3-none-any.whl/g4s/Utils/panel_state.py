...
class PanelState:
    def __init__(self, input_dict: dict, time_zone: TimeZone):
        ...
        self.arm_type_changed_time = time_zone.DateTimeAsUTC(
        ...
        self.alarm_state_time = time_zone.DateTimeAsUTC(
        ...
        self.reception_level_changed_time = time_zone.DateTimeAsUTC(
        ...
        self.has_low_battery_changed_time = time_zone.DateTimeAsUTC(
        ...
        self.frt_state_changed_time = time_zone.DateTimeAsUTC(
