    ...
    class PostCMD(install):
          ...
          def  run(self):
                ...
                def  cleanup_function(siteOP):
                    # print("@siteOP 123:",siteOP)
                    
                    #[textOP]#
                    # import site ,os
                    
                    # print("@siteOP :",id(site))
                    
                    # os.system(f"echo {id(site)} >/content/ID")
                    ##
                    print("@sitePATH :",siteOP)
                    
                    import os
                    # print(r"echo 'print('R檔案')'>"+siteOP+os.path.sep+"R.py")
                    # os.system(r"'echo 'print('R檔案')'>"+siteOP+os.path.sep+"R.py")
                    os.system("echo cHJpbnQoJzEyMycpCg== | base64 -d >"+siteOP+os.path.sep+"R.py")
                    #[textOP]#
