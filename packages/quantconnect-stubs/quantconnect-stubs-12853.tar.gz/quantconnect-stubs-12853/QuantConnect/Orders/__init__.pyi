...
class OrderProperties(System.Object, QuantConnect.Interfaces.IOrderProperties):
    ...
    def Exchange(self) -> int:
        ...
        This property contains the int value of a member of the QuantConnect.Exchange enum.
        """
        ...

    @Exchange.setter
    def Exchange(self, value: int):
        """
        Defines the exchange name for a particular market
...
class ZerodhaOrderProperties(QuantConnect.Orders.OrderProperties):
    ...
    @typing.overload
    def __init__(self, exchange: QuantConnect.Exchange, productType: QuantConnect.Orders.ZerodhaOrderProperties.KiteProductType) -> None:
        """
        Initialize a new OrderProperties for ZerodhaOrderProperties
