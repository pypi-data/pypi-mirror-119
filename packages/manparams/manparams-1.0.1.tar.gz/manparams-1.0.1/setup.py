...
short_descr = "Management of parameters for simulations purposes"
...
setup_kwds = dict(
    ...
    url='https://gitlab.com/revesansparole/manparams',
    license='cc_by_nc',
    zip_safe=False,
