...
**manparams** could always use more documentation, whether as
part of the official **manparams** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `manparams` for local
development.

1. Fork the `manparams` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/manparams.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd manparams
    (dvlpt) manparams$ flake8
    (dvlpt) manparams$ pytest
...
.. _issues: https://gitlab.com/revesansparole/manparams/issues
