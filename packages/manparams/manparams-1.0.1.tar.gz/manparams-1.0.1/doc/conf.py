...
htmlhelp_basename = "manparamsdoc"
...
# [howto/manual]).
latex_documents = [
    (u"index", u"manparams.tex",
     u"manparams Documentation",
     u"revesansparole",
     u"manual"),
]
...
texinfo_documents = [
    (u"index", u"manparams",
     ...
     u"revesansparole",
     u"manparams",
     u"Management of parameters for simulations purposes",
     u"Miscellaneous"),
]
