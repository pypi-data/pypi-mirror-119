...
RiscvCPU = ['rv32emc', 'rv32ec', 'rv32i', 'rv32iac', 'rv32im', 'rv32imac', 'rv32imafc', 'rv64imac', 'rv64imacxcki', 'rv64imafdc', 'e902', 'e902m', 'e902t', 'e902mt', 'e906', 'e906f', 'e906fd', 'c906', 'c906fd', 'c906fdv', 'c906v', 'c910', 'c910v', 'c906d']
...
class Builder(object):
    ...
    def set_cpu(self, cpu):
        ...
        if self.CPU in CkcoreCPU:
            ...
            if self.CPU == 'c906fd':
                set_rv_cpu_flag(flags, 'rv64imafdcvxtheadc', 'lp64d', 'medany', 'c906')
            if self.CPU == 'c906fdv':
