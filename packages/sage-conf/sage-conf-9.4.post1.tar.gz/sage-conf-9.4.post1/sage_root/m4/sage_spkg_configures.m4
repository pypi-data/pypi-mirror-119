...
SAGE_SPKG_ENABLE([llvm], [optional], [llvm: The LLVM Compiler Infrastructure, including the Clang C/C++/Objective-C compiler])
...
SAGE_SPKG_ENABLE([perl_mongodb], [optional], [perl_mongodb: A prerequisite for polymake's PolyDB feature])
