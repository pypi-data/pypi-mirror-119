...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '2.2.0-alpha.1631186459+5684b2ab'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 2.2.0-alpha.1631186459+5684b2ab`
                """)
            else:
                raise
