...
class StatusCode(Enum):
    ...
    FLASH_EXEC_IN_RAM_NOT_READY = (
        109,
        "FlashExecuteInRamFunctionNotReady",
    ...
    RELIABLE_UPDATE_INACIVE = (
        10602,
        "ReliableUpdateInacive",
        "Reliable Update: Inacive",
    )
    ...
    FLEXSPINOR_NOT_SUPPORTED = (
        20104,
        "FLEXSPINORPageSizeOverTheMaxSupportedSize",
    ...
    FLEXSPI_SEQUENCE_EXECUTION_TIMEOUT = (
        70000,
        "FLEXSPI_SequenceExecutionTimeout",
        "FLEXSPI: Sequence Execution Timeout",
    )
    FLEXSPI_INVALID_SEQUENCE = (
        70001,
        "FLEXSPI_InvalidSequence",
