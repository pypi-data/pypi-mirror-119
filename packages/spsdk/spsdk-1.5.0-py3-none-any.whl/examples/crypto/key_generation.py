...
def main() -> None:
    ...
    pub_key_2048 = generate_rsa_public_key(priv_key_2048)
    save_rsa_private_key(
        priv_key_2048, path.join(data_dir, "private_rsa2048.der"), encoding=Encoding.DER
    )
    save_rsa_public_key(
        pub_key_2048, path.join(data_dir, "public_rsa2048.der"), encoding=Encoding.DER
    )
    print(
    ...
    pub_key_3072 = generate_rsa_public_key(priv_key_3072)
    save_rsa_private_key(
        priv_key_3072, path.join(data_dir, "private_rsa3072.der"), encoding=Encoding.DER
    )
    save_rsa_public_key(
        pub_key_3072, path.join(data_dir, "public_rsa3072.der"), encoding=Encoding.DER
    )
    print(
    ...
    pub_key_4096 = generate_rsa_public_key(priv_key_4096)
    save_rsa_private_key(
        priv_key_4096, path.join(data_dir, "private_rsa4096.der"), encoding=Encoding.DER
    )
    save_rsa_public_key(
        pub_key_4096, path.join(data_dir, "public_rsa4096.der"), encoding=Encoding.DER
    )
    print(
