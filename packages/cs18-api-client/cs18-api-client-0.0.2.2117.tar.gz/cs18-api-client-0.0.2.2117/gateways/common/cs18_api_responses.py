...
class RepositoryProviderResponse:
    def __init__(self, provider_id: str, name: str, details, status: str, account_id: str,
                 repositories, errors: List[Error]):
...
class AccountRepositoryResponse:
    def __init__(self, repository_id: str, name: str, provider_id: str, allow_sharing: str, open_access: str,
                 account_id: str, is_valid: bool, connection_details, repository_url: str, errors: List[Error]):
        self.repository_url = repository_url
...
class RepositoryRelationshipResponse:
    def __init__(self, repo_relationship_id: str, space_id: str, deployment_type: str,
                 account_id: str, branch: str, is_valid: bool, errors: List[Error]):
