...
class name():
    def getname(self):
        ...
        ming = '伟刚勇毅俊峰强军平保东文辉力明永健世广志义兴良海山仁波宁贵福生龙元全国胜学祥才发武新利清' \
            ...
            '飘育馥琦晶妍茜秋珊莎锦黛青倩婷宁蓓纨苑婕馨瑗琰韵融园艺咏卿聪澜纯毓悦昭冰爽琬茗羽希汗寒函'\
            '听风余生萧飒国宝时光车午后的月光舟离江我与我相惜愚人自欺国韵芸边中玉玲龙海香磊森梦杰含涵'
        X=random.choice(xing)
        M="".join( random.choice(ming) for i in range(random.choice(range(1,4))))
        name = X+M
        return name
