...
from fsharadar.utils import maybe_show_progress
...
class SharadarDailyBcolzWriter(BcolzDailyBarWriter):
    ...
    def write(self,
        ...
        ctx = maybe_show_progress(
            ...
            desc=self.progress_bar_message,
            total=len(assets) if assets is not None else None,
        )
        with ctx as it:
    ...
    def to_ctable(self, sid, raw_data, invalid_data_behavior):
        ...
        processed.insert(loc=0, column='day', value=dates.astype('float64'))
