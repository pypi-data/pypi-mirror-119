...
def get_pipeline_loader(bundle_data):
    return SharadarPipelineLoader(bundle_data)

class SharadarPipelineLoader(implements(PipelineLoader)):
    
    """A Sharadar PipelineLoader for loading daily raw data.
    ...
    def load_adjusted_array(self, domain, columns, dates, sids, mask):
        ...
        if self.adjustments_reader is None:
