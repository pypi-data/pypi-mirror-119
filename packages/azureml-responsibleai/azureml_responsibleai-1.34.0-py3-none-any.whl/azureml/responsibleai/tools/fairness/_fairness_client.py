...
from azureml.responsibleai.common._errors.error_definitions import MissingDatastoreError
...
def upload_dashboard_dictionary(run,
    ...
    :param datastore_name: The datastore for the uploads
    ...
    y_true_artifact = upload_y_true(run,
                                    datastore_name,
                                    dashboard_dict,
                                    upload_id)
    ...
    y_pred_artifacts = upload_y_preds(run,
                                      datastore_name,
                                      dashboard_dict,
                                      upload_id)
    ...
    sf_artifacts = upload_sensitive_features(run,
                                             datastore_name,
                                             dashboard_dict,
                                             upload_id)
