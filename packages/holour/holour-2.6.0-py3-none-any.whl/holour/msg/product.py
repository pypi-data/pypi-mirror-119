...
class Product:
    ...
    def __init__(self, uuid: str, name: str, image: str, category: str, process_uuid: str = "", tags: [str] = None,
    ...
    def __repr__(self):
        return f"<id={self.uuid},name={self.name},image={self.image},category={self.category}" \
               f",process_uuid={self.process_uuid},tags={self.tags},description={self.description}>"
