...
class Process(object):
    ...
    def __init__(self, id=None, type=None, project_id=None, process_jobs=None, analysis_id=None, analysis=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
