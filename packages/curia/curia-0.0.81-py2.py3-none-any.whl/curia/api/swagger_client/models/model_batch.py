...
class ModelBatch(object):
    ...
    def __init__(self, id=None, project_id=None, models=None, analysis_id=None, analysis=None, jobs=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
