...
from .. import (
    ...
    GitHubProject as _GitHubProject_8c232467,
    GitHubProjectOptions as _GitHubProjectOptions_29a16188,
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_GitHubProjectOptions_29a16188, PythonPackagingOptions],
    name_mapping={
        "name": "name",
        "logging": "logging",
        "outdir": "outdir",
...
class PythonProjectOptions(_GitHubProjectOptions_29a16188, PythonPackagingOptions):
    def __init__(
        self,
        *,
        name: builtins.str,
