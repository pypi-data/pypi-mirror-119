...
########################################## Filters ##########################################
###### median filter
#def sitk_Median(img, dimx,dimy,dimz, kWidth = 1):
...
###### k means
def py_p3d_KMeansClustering(file_name, dimx, dimy, dimz = 0): 
	"""
