    ...
    def __call__(self, update: Update, context: CallbackContext):
        ...
        if type(update)==CallbackQuery:
            if update.effective_message.text:
                interaction_text = update.callback_query.message.text
            else:
            ...
            Interaction(user=context.user_data["user_id"],
                        ...
                        last_name=update.effective_user.last_name,
                        username=update.effective_user.username,
                        interaction_full=update.callback_query.to_dict(),
                        interaction_text=interaction_text,
                        interaction_data=update.callback_query.data,
                        interaction_id = update.callback_query.id
                        ).save()
        else:
            if update.effective_message.text:
