...
class Askdata(SignUp):
    ...
    def get_columns(self, dataset, workspace=''):
        ...
        url = base_url + '/smartbot/agents/agentslug/' + workspace + '/datasetslug/' + slug
        ...
        url = base_url + '/smartdataset/datasets/' + dataset_id + '/measures'
        ...
        url = base_url + '/smartdataset/datasets/' + dataset_id + '/entityTypes'
    ...
    def get(self, query, workspace='', dataset='', lang="en"):
        ...
        display(HTML("<p>{} from the dataset: {} / {}</p>".format(self.extract_fields(filtered_result[0]["attachment"]["body"][0]["details"]["columns"]), workspace, filtered_result[0]["attachment"]["body"][0]["details"]["datasetName"])))
        ...
        if(len(filtered_result)>1):
            ...
            for r in filtered_result[1:]:
                display(HTML("<p>     {} from the dataset: {} / {}</p>".format(self.extract_fields(r["attachment"]["body"][0]["details"]["columns"]), workspace, r["attachment"]["body"][0]["details"]["datasetName"])))
