...
class Stock_Scraping_Space(Scraping_Space):
   ...
   # def check_format_change(change_of_format, second_driver):
    ...
    def complete_stock_scrape(self):
        ...
        return self.scrape_through_edit_list(edit_list, driver, complete_list, list_of_locations, completed_months_and_years)
    ...
    def scrape_through_edit_list(self, edit_list, driver, complete_list, list_of_locations, completed_months_and_years):
        """
        ...
        for link in edit_list:
            ...
            if self.check_end_date(written_date_text) == True:
                ...
                break
        save_data('Stock information', complete_list)
        save_data('Locations list', list_of_locations)
        save_data('Month and locations', month_location_match)
