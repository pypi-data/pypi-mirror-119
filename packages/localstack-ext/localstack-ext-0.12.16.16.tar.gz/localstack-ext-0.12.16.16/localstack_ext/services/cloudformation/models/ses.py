...
class SESTemplate(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return(template or[NWKux])[0]
 def get_physical_resource_id(self,attribute=NWKux,**kwargs):
 ...
 def update_resource(self,new_resource,stack_name,resources):
  ...
  if NWKua(template.get(attr,"")==new_template.get(attr,"")for attr in["SubjectPart","TextPart","HtmlPart"]):
   return
