...
class SESTemplate(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return(template or[YgxTP])[0]
 def get_physical_resource_id(self,attribute=YgxTP,**kwargs):
 ...
 def update_resource(self,new_resource,stack_name,resources):
  ...
  if YgxTU(template.get(attr,"")==new_template.get(attr,"")for attr in["SubjectPart","TextPart","HtmlPart"]):
   return
