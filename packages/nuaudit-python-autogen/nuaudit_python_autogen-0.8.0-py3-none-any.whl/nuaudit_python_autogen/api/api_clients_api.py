...
class APIClientsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_api_clients = _Endpoint(
            settings={
                'response_type': ([APIClient],),
                'auth': [
                    'APIKeyHeader'
            ...
            api_client=api_client,
            callable=__list_api_clients
        )

        def __list_roles_for_api_client(
            self,
            organization_id,
            api_client_id,
            **kwargs
        ...
        self.list_roles_for_api_client = _Endpoint(
            settings={
                'response_type': ([Role],),
                'auth': [
                    'APIKeyHeader'
            ...
            api_client=api_client,
            callable=__list_roles_for_api_client
        )
