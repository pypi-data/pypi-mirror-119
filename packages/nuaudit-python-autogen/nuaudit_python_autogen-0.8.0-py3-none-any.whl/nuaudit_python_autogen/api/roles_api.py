...
class RolesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_api_client_to_role = _Endpoint(
            settings={
            ...
            callable=__add_api_client_to_role
        )
        ...
        def __list_api_clients_for_role(
            self,
            organization_id,
            role_id,
            **kwargs
        ...
        self.list_api_clients_for_role = _Endpoint(
            settings={
                'response_type': ([User],),
                'auth': [
                    'APIKeyHeader'
            ...
            api_client=api_client,
            callable=__list_api_clients_for_role
        )
        ...
        self.list_users_for_role = _Endpoint(
            settings={
                'response_type': ([User],),
                'auth': [
                    'APIKeyHeader'
            ...
            api_client=api_client,
            callable=__list_users_for_role
        )

        def __remove_api_client_from_role(
            self,
            organization_id,
            role_id,
            api_client_id,
        ...
        self.remove_api_client_from_role = _Endpoint(
            settings={
                'response_type': ([APIClient],),
                'auth': [
                    'APIKeyHeader'
            ...
            api_client=api_client,
            callable=__remove_api_client_from_role
        )
