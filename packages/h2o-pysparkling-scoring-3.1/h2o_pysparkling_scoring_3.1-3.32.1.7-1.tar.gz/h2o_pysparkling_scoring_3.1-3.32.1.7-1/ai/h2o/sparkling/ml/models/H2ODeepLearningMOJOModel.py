...
from ai.h2o.sparkling.ml.params.HasDeprecatedVariableImportancesOnMOJO import HasDeprecatedVariableImportancesOnMOJO


class H2ODeepLearningMOJOModel(H2OSupervisedMOJOModelParams, HasIgnoredColsOnMOJO, HasDeprecatedVariableImportancesOnMOJO):
