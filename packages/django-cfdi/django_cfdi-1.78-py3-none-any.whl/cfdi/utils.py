...
def get_xml_object(xml_text):
                        ...
                        if tasa_iva:
                            ...
                            if es_combustible:
                                ...
                                xml.total_no_objeto_iva += (
                                    ...
                                    to_precision_decimales(base_traslado)
                                )
                            else:
    ...
    carta_porte = complemento.find("cartaporte", "cartaporte")
    ...
    if carta_porte.exists:
        ...
        autotransporte_federal = carta_porte.find("mercancias").find("autotransportefederal")
        ...
        carta_porte_dic["figura_transporte"]["operadores"] = []

        for op in figura_transporte.find("operadores").find_list("operador"):
            operador_dic = op.to_dict()
            operador_dic["domicilio"] = op.find("domicilio").to_dict()
            carta_porte_dic["figura_transporte"]["operadores"].append(operador_dic)
