...
#                 print(f'resize Exception new size: {size}')
    ...
    def predict(self, impath, mode='mobile', resize=True, dsize=(1500,2000),
                ...
                min_size_percent=5, use_scanline=True, draw_bbox_image=False):
        ...
        segment_img, bbox_mask_img, mask_img = self._segment_predictor(impath)
        ...
        data, clean, raw = self.info_extractor.predict(data_annoset)  
...
#         data, dframe, img, boxes_list, text_list, score_text, score_list
        ...
        if draw_bbox_image:
            ...
            img = self._draw_bbox_image(img, raw)
        ...
        return {
            ...
            'segment_mask': mask_img,
            'segment_bbox_mask': bbox_mask_img,
            ...
            'times':{
                ...
                'deskew': f'{(normdesk_etime - normdesk_stime):.4f} s',
