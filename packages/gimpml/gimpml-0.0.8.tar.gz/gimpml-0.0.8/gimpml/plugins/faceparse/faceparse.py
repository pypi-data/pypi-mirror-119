...
def run(procedure, run_mode, image, n_drawables, layer, args, data):
    ...
    if run_mode == Gimp.RunMode.INTERACTIVE:
        ...
        python_path = config_path_output["python_path"]
        config_path_output["plugin_path"] = os.path.join(config_path, "faceparse.py")
        ...
        dialog = GimpUi.Dialog(use_header_bar=use_header_bar, title=_("Face Parse..."))
    ...
    def do_create_procedure(self, name):
        ...
        if name == "faceparse":
            ...
            procedure.set_documentation(
                N_(
                    "Performs semantic segmentation for a portrait in the current layer."
                ),
                globals()[
                    "__doc__"
