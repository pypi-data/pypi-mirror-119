...
Performs image matting using mask layer.
"""
import gi
...
def run(procedure, run_mode, image, n_drawables, layer, args, data):
    ...
    if run_mode == Gimp.RunMode.INTERACTIVE:
        ...
        python_path = config_path_output["python_path"]
        config_path_output["plugin_path"] = os.path.join(config_path, "matting.py")
        ...
        dialog = GimpUi.Dialog(use_header_bar=use_header_bar, title=_("Matting..."))
        ...
        # Show License
        license_text = _("PLUGIN LICENSE : CC BY-NC 4.0")
    ...
    def do_create_procedure(self, name):
        ...
        if name == "matting":
            ...
            procedure.set_documentation(
                N_("Performs image matting using mask layer."),
                globals()[
                    "__doc__"
