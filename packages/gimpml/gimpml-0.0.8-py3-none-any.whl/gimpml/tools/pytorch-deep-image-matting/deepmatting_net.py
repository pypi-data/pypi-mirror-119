...
class VGG16(nn.Module):
    ...
    def forward(self, x):
        ...
        x1p, id1 = F.max_pool2d(
            x12, kernel_size=(2, 2), stride=(2, 2), return_indices=True
        )
        ...
        x2p, id2 = F.max_pool2d(
            x22, kernel_size=(2, 2), stride=(2, 2), return_indices=True
        )
        ...
        x3p, id3 = F.max_pool2d(
            x33, kernel_size=(2, 2), stride=(2, 2), return_indices=True
        )
        ...
        x4p, id4 = F.max_pool2d(
            x43, kernel_size=(2, 2), stride=(2, 2), return_indices=True
        )
        ...
        x5p, id5 = F.max_pool2d(
            x53, kernel_size=(2, 2), stride=(2, 2), return_indices=True
        )
