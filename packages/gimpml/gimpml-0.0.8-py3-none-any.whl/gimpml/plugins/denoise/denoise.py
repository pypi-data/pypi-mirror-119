...
def run(procedure, run_mode, image, n_drawables, layer, args, data):
    ...
    if run_mode == Gimp.RunMode.INTERACTIVE:
        ...
        python_path = config_path_output["python_path"]
        config_path_output["plugin_path"] = os.path.join(config_path, "denoise.py")
        ...
        dialog = GimpUi.Dialog(use_header_bar=use_header_bar, title=_("Denoise..."))
        ...
        # Show License
        license_text = _("PLUGIN LICENSE : GPL3")
