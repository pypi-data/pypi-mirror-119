# build-in imports
from napplib.vtex.v2.models.order import VtexInvoice
import sys
...
class VtexController:
    ...
    def post_invoice(self, order_id: str, invoice: VtexInvoice):
        headers = dict(self.headers)
        headers["Accept"] = "application/json"
        headers["Content-Type"] = "application/json"
        ...
        return requests.post({endpoint}, data=unpack_payload_dict(invoice,remove_null=True))
