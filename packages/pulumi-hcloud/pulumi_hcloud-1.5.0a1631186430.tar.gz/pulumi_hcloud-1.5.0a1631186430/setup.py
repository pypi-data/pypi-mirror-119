...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '1.5.0-alpha.1631186430+d29ceaea'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 1.5.0-alpha.1631186430+d29ceaea`
                """)
            else:
                raise
