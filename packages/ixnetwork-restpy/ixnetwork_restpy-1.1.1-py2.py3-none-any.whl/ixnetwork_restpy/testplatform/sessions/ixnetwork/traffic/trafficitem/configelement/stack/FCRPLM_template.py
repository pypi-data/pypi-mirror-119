...
class FCRPLM(Base):
    ...
    _SDM_NAME = 'fCRPLM'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCRPLM.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCRPLM.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCRPLM.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCRPLM.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCRPLM.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCRPLM.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCRPLM.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCRPLM.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCRPLM.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCRPLM.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCRPLM.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCRPLM.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCRPLM.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCRPLM.header.fcHeader.type-14',
        'FCTLCustom': 'fCRPLM.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCRPLM.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCRPLM.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCRPLM.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCRPLM.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCRPLM.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCRPLM.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCRPLM.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCRPLM.header.fcCT.revision-42',
        'FcCTInId': 'fCRPLM.header.fcCT.inId-43',
        'FcCTGsType': 'fCRPLM.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCRPLM.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCRPLM.header.fcCT.options-46',
        'FcCTReserved': 'fCRPLM.header.fcCT.reserved-47',
        'FCSOpcode': 'fCRPLM.header.FCS.opcode-48',
        'FCSMaxsize': 'fCRPLM.header.FCS.maxsize-49',
        'FCSReserved': 'fCRPLM.header.FCS.reserved-50',
        'FCSPlatformName': 'fCRPLM.header.FCS.platformName-51',
        'FCSPlatformManagementAddress': 'fCRPLM.header.FCS.platformManagementAddress-52',
        'FcCRCAutoCRC': 'fCRPLM.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCRPLM.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCRPLM.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCRPLM, self).__init__(parent, list_op)
    ...
    @property
    def FCSPlatformManagementAddress(self):
        """
        Display Name: Platform Management Address
        Default Value: 0x00
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FCSPlatformManagementAddress']))
