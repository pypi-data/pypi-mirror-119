...
class FcMRSWACC(Base):
    __slots__ = ()
    _SDM_NAME = 'fcMRSWACC'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcMRSWACC.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcMRSWACC.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcMRSWACC.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcMRSWACC.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcMRSWACC.header.fcHeader.type-5',
        'FcHeaderSof': 'fcMRSWACC.header.fcHeader.sof-6',
        'FCTLCustom': 'fcMRSWACC.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcMRSWACC.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcMRSWACC.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcMRSWACC.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcMRSWACC.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcMRSWACC.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcMRSWACC.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcMRSWACC.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcMRSWACC.header.fcCmd-34',
        'HeaderReserved1': 'fcMRSWACC.header.reserved1-35',
        'HeaderReserved2': 'fcMRSWACC.header.reserved2-36',
    }

    def __init__(self, parent, list_op=False):
        super(FcMRSWACC, self).__init__(parent, list_op)
