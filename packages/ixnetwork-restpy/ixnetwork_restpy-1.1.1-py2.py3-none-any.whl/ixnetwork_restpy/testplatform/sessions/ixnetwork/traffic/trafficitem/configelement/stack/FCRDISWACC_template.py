...
class FcRDISWACC(Base):
    __slots__ = ()
    _SDM_NAME = 'fcRDISWACC'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcRDISWACC.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcRDISWACC.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcRDISWACC.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcRDISWACC.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcRDISWACC.header.fcHeader.type-5',
        'FcHeaderSof': 'fcRDISWACC.header.fcHeader.sof-6',
        'FCTLCustom': 'fcRDISWACC.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcRDISWACC.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcRDISWACC.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcRDISWACC.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcRDISWACC.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcRDISWACC.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcRDISWACC.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcRDISWACC.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcRDISWACC.header.fcCmd-34',
        'HeaderReserved1': 'fcRDISWACC.header.reserved1-35',
        'HeaderReserved2': 'fcRDISWACC.header.reserved2-36',
        'HeaderLength': 'fcRDISWACC.header.length-37',
        'HeaderReserved3': 'fcRDISWACC.header.reserved3-38',
        'HeaderGrantedDID': 'fcRDISWACC.header.grantedDID-39',
    }

    def __init__(self, parent, list_op=False):
        super(FcRDISWACC, self).__init__(parent, list_op)
    ...
    @property
    def HeaderGrantedDID(self):
        """
        Display Name: Granted Domain_ID
        Default Value: 0
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderGrantedDID']))
