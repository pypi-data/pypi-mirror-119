...
class FCGPT(Base):
    ...
    _SDM_NAME = 'fCGPT'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPT.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPT.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPT.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPT.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPT.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPT.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPT.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPT.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPT.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPT.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPT.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPT.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPT.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPT.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPT.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPT.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPT.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPT.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPT.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPT.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPT.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPT.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPT.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPT.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPT.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPT.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPT.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPT.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPT.header.fcCT.revision-42',
        'FcCTInId': 'fCGPT.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPT.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPT.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPT.header.fcCT.options-46',
        'FcCTReserved': 'fCGPT.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGPT.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGPT.header.FCS.maxsize-49',
        'FCSReserved': 'fCGPT.header.FCS.reserved-50',
        'FCSPortName': 'fCGPT.header.FCS.portName-51',
        'FcCRCAutoCRC': 'fCGPT.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGPT.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGPT.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPT, self).__init__(parent, list_op)
