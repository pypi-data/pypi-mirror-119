...
class FCGCSID(Base):
    ...
    _SDM_NAME = 'fCGCSID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGCSID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGCSID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGCSID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGCSID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGCSID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGCSID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGCSID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGCSID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGCSID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGCSID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGCSID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGCSID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGCSID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGCSID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGCSID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGCSID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGCSID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGCSID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGCSID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGCSID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGCSID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGCSID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGCSID.header.fcCT.revision-42',
        'FcCTInId': 'fCGCSID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGCSID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGCSID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGCSID.header.fcCT.options-46',
        'FcCTReserved': 'fCGCSID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGCSID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGCSID.header.dNS.maxsize-49',
        'DNSReserved': 'fCGCSID.header.dNS.reserved-50',
        'DNSPortId': 'fCGCSID.header.dNS.portId-51',
        'FcCRCAutoCRC': 'fCGCSID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGCSID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGCSID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGCSID, self).__init__(parent, list_op)
