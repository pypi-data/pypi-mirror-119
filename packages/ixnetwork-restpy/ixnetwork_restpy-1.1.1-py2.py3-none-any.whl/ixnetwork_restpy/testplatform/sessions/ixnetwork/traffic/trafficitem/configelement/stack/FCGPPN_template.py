...
class FCGPPN(Base):
    ...
    _SDM_NAME = 'fCGPPN'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPPN.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPPN.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPPN.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPPN.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPPN.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPPN.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPPN.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPPN.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPPN.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPPN.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPPN.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPPN.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPPN.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPPN.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPPN.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPPN.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPPN.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPPN.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPPN.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPPN.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPPN.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPPN.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPPN.header.fcCT.revision-42',
        'FcCTInId': 'fCGPPN.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPPN.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPPN.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPPN.header.fcCT.options-46',
        'FcCTReserved': 'fCGPPN.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGPPN.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGPPN.header.FCS.maxsize-49',
        'FCSReserved': 'fCGPPN.header.FCS.reserved-50',
        'FCSPortName': 'fCGPPN.header.FCS.portName-51',
        'FcCRCAutoCRC': 'fCGPPN.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGPPN.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGPPN.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPPN, self).__init__(parent, list_op)
