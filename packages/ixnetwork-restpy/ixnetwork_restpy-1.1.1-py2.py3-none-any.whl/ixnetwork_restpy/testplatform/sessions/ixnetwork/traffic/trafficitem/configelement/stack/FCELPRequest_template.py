...
class FcELPRequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fcELPRequest'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcELPRequest.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcELPRequest.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcELPRequest.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcELPRequest.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcELPRequest.header.fcHeader.type-5',
        'FcHeaderSof': 'fcELPRequest.header.fcHeader.sof-6',
        'FCTLCustom': 'fcELPRequest.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcELPRequest.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcELPRequest.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcELPRequest.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcELPRequest.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcELPRequest.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcELPRequest.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcELPRequest.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcELPRequest.header.fcCmd-34',
        'HeaderReserved1': 'fcELPRequest.header.reserved1-35',
        'HeaderRevision': 'fcELPRequest.header.revision-36',
        'HeaderFlags': 'fcELPRequest.header.flags-37',
        'HeaderBbScN': 'fcELPRequest.header.bbScN-38',
        'HeaderRATov': 'fcELPRequest.header.rATov-39',
        'HeaderEDTov': 'fcELPRequest.header.eDTov-40',
        'HeaderReqInterconnectPortName': 'fcELPRequest.header.reqInterconnectPortName-41',
        'HeaderReqSwitchName': 'fcELPRequest.header.reqSwitchName-42',
        'HeaderServiceParams': 'fcELPRequest.header.serviceParams-43',
        'HeaderClass1PortParams': 'fcELPRequest.header.class1PortParams-44',
        'HeaderClass2PortParams': 'fcELPRequest.header.class2PortParams-45',
        'HeaderClass3PortParams': 'fcELPRequest.header.class3PortParams-46',
        'HeaderReserved2': 'fcELPRequest.header.reserved2-47',
        'HeaderIslFlowControlMode': 'fcELPRequest.header.islFlowControlMode-48',
        'HeaderFlowControlParamLength': 'fcELPRequest.header.flowControlParamLength-49',
        'HeaderFlowControlParams': 'fcELPRequest.header.flowControlParams-50',
    }

    def __init__(self, parent, list_op=False):
        super(FcELPRequest, self).__init__(parent, list_op)
    ...
    def HeaderReqInterconnectPortName(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderReqInterconnectPortName']))
    ...
    def HeaderReqSwitchName(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderReqSwitchName']))
