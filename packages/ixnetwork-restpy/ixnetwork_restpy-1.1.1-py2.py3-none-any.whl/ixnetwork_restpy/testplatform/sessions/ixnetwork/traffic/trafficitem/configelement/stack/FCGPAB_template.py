...
class FCGPAB(Base):
    ...
    _SDM_NAME = 'fCGPAB'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPAB.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPAB.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPAB.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPAB.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPAB.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPAB.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPAB.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPAB.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPAB.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPAB.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPAB.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPAB.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPAB.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPAB.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPAB.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPAB.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPAB.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPAB.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPAB.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPAB.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPAB.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPAB.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPAB.header.fcCT.revision-42',
        'FcCTInId': 'fCGPAB.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPAB.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPAB.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPAB.header.fcCT.options-46',
        'FcCTReserved': 'fCGPAB.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGPAB.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGPAB.header.FCS.maxsize-49',
        'FCSReserved': 'fCGPAB.header.FCS.reserved-50',
        'FCSPlatformName': 'fCGPAB.header.FCS.platformName-51',
        'FcCRCAutoCRC': 'fCGPAB.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGPAB.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGPAB.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPAB, self).__init__(parent, list_op)
