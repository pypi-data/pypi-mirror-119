...
class FCGPLNL(Base):
    ...
    _SDM_NAME = 'fCGPLNL'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPLNL.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPLNL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPLNL.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPLNL.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPLNL.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPLNL.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPLNL.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPLNL.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPLNL.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPLNL.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPLNL.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPLNL.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPLNL.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPLNL.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPLNL.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPLNL.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPLNL.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPLNL.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPLNL.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPLNL.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPLNL.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPLNL.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPLNL.header.fcCT.revision-42',
        'FcCTInId': 'fCGPLNL.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPLNL.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPLNL.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPLNL.header.fcCT.options-46',
        'FcCTReserved': 'fCGPLNL.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGPLNL.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGPLNL.header.FCS.maxsize-49',
        'FCSReserved': 'fCGPLNL.header.FCS.reserved-50',
        'FCSPlatformName': 'fCGPLNL.header.FCS.platformName-51',
        'FcCRCAutoCRC': 'fCGPLNL.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGPLNL.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGPLNL.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPLNL, self).__init__(parent, list_op)
