...
class FCGDID(Base):
    ...
    _SDM_NAME = 'fCGDID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGDID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGDID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGDID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGDID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGDID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGDID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGDID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGDID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGDID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGDID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGDID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGDID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGDID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGDID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGDID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGDID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGDID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGDID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGDID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGDID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGDID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGDID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGDID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGDID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGDID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGDID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGDID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGDID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGDID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGDID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGDID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGDID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGDID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGDID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGDID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGDID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGDID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGDID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGDID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGDID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGDID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGDID.header.fcCT.revision-42',
        'FcCTInId': 'fCGDID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGDID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGDID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGDID.header.fcCT.options-46',
        'FcCTReserved': 'fCGDID.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGDID.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGDID.header.FCS.maxsize-49',
        'FCSReserved': 'fCGDID.header.FCS.reserved-50',
        'FCSInterconnectElementName': 'fCGDID.header.FCS.interconnectElementName-51',
        'FcCRCAutoCRC': 'fCGDID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGDID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGDID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGDID, self).__init__(parent, list_op)
