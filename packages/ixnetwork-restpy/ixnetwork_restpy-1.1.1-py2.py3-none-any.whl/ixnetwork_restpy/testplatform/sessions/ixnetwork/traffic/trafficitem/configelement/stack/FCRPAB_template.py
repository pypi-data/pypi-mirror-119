...
class FCRPAB(Base):
    ...
    _SDM_NAME = 'fCRPAB'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCRPAB.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCRPAB.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCRPAB.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCRPAB.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCRPAB.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCRPAB.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCRPAB.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCRPAB.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCRPAB.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCRPAB.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCRPAB.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCRPAB.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCRPAB.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCRPAB.header.fcHeader.type-14',
        'FCTLCustom': 'fCRPAB.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCRPAB.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCRPAB.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCRPAB.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCRPAB.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCRPAB.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCRPAB.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCRPAB.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCRPAB.header.fcCT.revision-42',
        'FcCTInId': 'fCRPAB.header.fcCT.inId-43',
        'FcCTGsType': 'fCRPAB.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCRPAB.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCRPAB.header.fcCT.options-46',
        'FcCTReserved': 'fCRPAB.header.fcCT.reserved-47',
        'FCSOpcode': 'fCRPAB.header.FCS.opcode-48',
        'FCSMaxsize': 'fCRPAB.header.FCS.maxsize-49',
        'FCSReserved': 'fCRPAB.header.FCS.reserved-50',
        'FCSPlatformName': 'fCRPAB.header.FCS.platformName-51',
        'FCSPlatformAttributeBlock': 'fCRPAB.header.FCS.platformAttributeBlock-52',
        'FcCRCAutoCRC': 'fCRPAB.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCRPAB.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCRPAB.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCRPAB, self).__init__(parent, list_op)
    ...
    @property
    def FCSPlatformAttributeBlock(self):
        """
        Display Name: Platform Attribute Block
        Default Value: 0x00
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FCSPlatformAttributeBlock']))
