...
class FCGTIN(Base):
    ...
    _SDM_NAME = 'fCGTIN'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGTIN.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGTIN.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGTIN.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGTIN.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGTIN.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGTIN.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGTIN.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGTIN.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGTIN.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGTIN.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGTIN.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGTIN.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGTIN.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGTIN.header.fcHeader.type-14',
        'FCTLCustom': 'fCGTIN.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGTIN.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGTIN.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGTIN.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGTIN.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGTIN.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGTIN.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGTIN.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGTIN.header.fcCT.revision-42',
        'FcCTInId': 'fCGTIN.header.fcCT.inId-43',
        'FcCTGsType': 'fCGTIN.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGTIN.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGTIN.header.fcCT.options-46',
        'FcCTReserved': 'fCGTIN.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGTIN.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGTIN.header.FCS.maxsize-49',
        'FCSReserved': 'fCGTIN.header.FCS.reserved-50',
        'FCSInterconnectElementDomainId': 'fCGTIN.header.FCS.interconnectElementDomainId-51',
        'FCSReserved2': 'fCGTIN.header.FCS.reserved2-52',
        'FcCRCAutoCRC': 'fCGTIN.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCGTIN.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCGTIN.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCGTIN, self).__init__(parent, list_op)
    ...
    @property
    def FCSInterconnectElementDomainId(self):
        """
        Display Name: Interconnect Element Domain ID
        Default Value: 0x00
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FCSInterconnectElementDomainId']))
