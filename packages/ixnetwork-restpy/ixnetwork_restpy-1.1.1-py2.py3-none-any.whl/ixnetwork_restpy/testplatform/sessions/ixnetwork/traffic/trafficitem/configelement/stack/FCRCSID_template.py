...
class FCRCSID(Base):
    ...
    _SDM_NAME = 'fCRCSID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCRCSID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCRCSID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCRCSID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCRCSID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCRCSID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCRCSID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCRCSID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCRCSID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCRCSID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCRCSID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCRCSID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCRCSID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCRCSID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCRCSID.header.fcHeader.type-14',
        'FCTLCustom': 'fCRCSID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCRCSID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCRCSID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCRCSID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCRCSID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCRCSID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCRCSID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCRCSID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCRCSID.header.fcCT.revision-42',
        'FcCTInId': 'fCRCSID.header.fcCT.inId-43',
        'FcCTGsType': 'fCRCSID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCRCSID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCRCSID.header.fcCT.options-46',
        'FcCTReserved': 'fCRCSID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCRCSID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCRCSID.header.dNS.maxsize-49',
        'DNSReserved': 'fCRCSID.header.dNS.reserved-50',
        'DNSPortId': 'fCRCSID.header.dNS.portId-51',
        'DNSClassOfService': 'fCRCSID.header.dNS.classOfService-52',
        'FcCRCAutoCRC': 'fCRCSID.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCRCSID.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCRCSID.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCRCSID, self).__init__(parent, list_op)
    ...
    def DNSClassOfService(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['DNSClassOfService']))
