...
class FCGPTID(Base):
    ...
    _SDM_NAME = 'fCGPTID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPTID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPTID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPTID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPTID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPTID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPTID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPTID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPTID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPTID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPTID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPTID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPTID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPTID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPTID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPTID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPTID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPTID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPTID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPTID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPTID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPTID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPTID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPTID.header.fcCT.revision-42',
        'FcCTInId': 'fCGPTID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPTID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPTID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPTID.header.fcCT.options-46',
        'FcCTReserved': 'fCGPTID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGPTID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGPTID.header.dNS.maxsize-49',
        'DNSReserved': 'fCGPTID.header.dNS.reserved-50',
        'DNSPortId': 'fCGPTID.header.dNS.portId-51',
        'FcCRCAutoCRC': 'fCGPTID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGPTID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGPTID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPTID, self).__init__(parent, list_op)
