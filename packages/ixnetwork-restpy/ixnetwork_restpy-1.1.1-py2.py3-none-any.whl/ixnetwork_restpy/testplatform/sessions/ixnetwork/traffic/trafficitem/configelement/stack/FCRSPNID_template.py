...
class FCRSPNID(Base):
    ...
    _SDM_NAME = 'fCRSPNID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCRSPNID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCRSPNID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCRSPNID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCRSPNID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCRSPNID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCRSPNID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCRSPNID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCRSPNID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCRSPNID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCRSPNID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCRSPNID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCRSPNID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCRSPNID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCRSPNID.header.fcHeader.type-14',
        'FCTLCustom': 'fCRSPNID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCRSPNID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCRSPNID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCRSPNID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCRSPNID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCRSPNID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCRSPNID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCRSPNID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCRSPNID.header.fcCT.revision-42',
        'FcCTInId': 'fCRSPNID.header.fcCT.inId-43',
        'FcCTGsType': 'fCRSPNID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCRSPNID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCRSPNID.header.fcCT.options-46',
        'FcCTReserved': 'fCRSPNID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCRSPNID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCRSPNID.header.dNS.maxsize-49',
        'DNSReserved': 'fCRSPNID.header.dNS.reserved-50',
        'DNSPortId': 'fCRSPNID.header.dNS.portId-51',
        'FcCRCAutoCRC': 'fCRSPNID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCRSPNID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCRSPNID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCRSPNID, self).__init__(parent, list_op)
