...
class FcMRRequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fcMRRequest'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcMRRequest.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcMRRequest.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcMRRequest.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcMRRequest.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcMRRequest.header.fcHeader.type-5',
        'FcHeaderSof': 'fcMRRequest.header.fcHeader.sof-6',
        'FCTLCustom': 'fcMRRequest.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcMRRequest.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcMRRequest.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcMRRequest.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcMRRequest.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcMRRequest.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcMRRequest.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcMRRequest.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcMRRequest.header.fcCmd-34',
        'HeaderReserved1': 'fcMRRequest.header.reserved1-35',
        'HeaderVersion': 'fcMRRequest.header.version-36',
        'HeaderLength': 'fcMRRequest.header.length-37',
    }

    def __init__(self, parent, list_op=False):
        super(FcMRRequest, self).__init__(parent, list_op)
