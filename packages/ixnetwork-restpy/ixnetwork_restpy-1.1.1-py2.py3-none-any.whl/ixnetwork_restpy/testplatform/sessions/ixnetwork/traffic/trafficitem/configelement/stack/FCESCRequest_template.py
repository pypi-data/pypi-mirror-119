...
class FcESCRequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fcESCRequest'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcESCRequest.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcESCRequest.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcESCRequest.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcESCRequest.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcESCRequest.header.fcHeader.type-5',
        'FcHeaderSof': 'fcESCRequest.header.fcHeader.sof-6',
        'FCTLCustom': 'fcESCRequest.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcESCRequest.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcESCRequest.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcESCRequest.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcESCRequest.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcESCRequest.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcESCRequest.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcESCRequest.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcESCRequest.header.fcCmd-34',
        'HeaderReserved1': 'fcESCRequest.header.reserved1-35',
        'HeaderFlags': 'fcESCRequest.header.flags-36',
        'HeaderLength': 'fcESCRequest.header.length-37',
        'HeaderVendorId': 'fcESCRequest.header.vendorId-38',
        'HeaderProtocolDescriptor': 'fcESCRequest.header.protocolDescriptor-39',
    }

    def __init__(self, parent, list_op=False):
        super(FcESCRequest, self).__init__(parent, list_op)
    ...
    @property
    def HeaderVendorId(self):
        """
        Display Name: Vendor Id String
        Default Value: 0
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderVendorId']))

    @property
    def HeaderProtocolDescriptor(self):
        """
        Display Name: Protocol Descriptor
        Default Value: 0
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderProtocolDescriptor']))
