...
class FCRIELN(Base):
    ...
    _SDM_NAME = 'fCRIELN'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCRIELN.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCRIELN.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCRIELN.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCRIELN.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCRIELN.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCRIELN.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCRIELN.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCRIELN.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCRIELN.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCRIELN.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCRIELN.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCRIELN.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCRIELN.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCRIELN.header.fcHeader.type-14',
        'FCTLCustom': 'fCRIELN.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCRIELN.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCRIELN.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCRIELN.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCRIELN.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCRIELN.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCRIELN.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCRIELN.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCRIELN.header.fcCT.revision-42',
        'FcCTInId': 'fCRIELN.header.fcCT.inId-43',
        'FcCTGsType': 'fCRIELN.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCRIELN.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCRIELN.header.fcCT.options-46',
        'FcCTReserved': 'fCRIELN.header.fcCT.reserved-47',
        'FCSOpcode': 'fCRIELN.header.FCS.opcode-48',
        'FCSMaxsize': 'fCRIELN.header.FCS.maxsize-49',
        'FCSReserved': 'fCRIELN.header.FCS.reserved-50',
        'FCSInterconnectElementName': 'fCRIELN.header.FCS.interconnectElementName-51',
        'FCSLogicalName': 'fCRIELN.header.FCS.logicalName-52',
        'FcCRCAutoCRC': 'fCRIELN.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCRIELN.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCRIELN.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCRIELN, self).__init__(parent, list_op)
    ...
    def FCSLogicalName(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FCSLogicalName']))
