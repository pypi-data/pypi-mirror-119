...
class FCGPFCP(Base):
    ...
    _SDM_NAME = 'fCGPFCP'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPFCP.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPFCP.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPFCP.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPFCP.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPFCP.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPFCP.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPFCP.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPFCP.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPFCP.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPFCP.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPFCP.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPFCP.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPFCP.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPFCP.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPFCP.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPFCP.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPFCP.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPFCP.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPFCP.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPFCP.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPFCP.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPFCP.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPFCP.header.fcCT.revision-42',
        'FcCTInId': 'fCGPFCP.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPFCP.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPFCP.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPFCP.header.fcCT.options-46',
        'FcCTReserved': 'fCGPFCP.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGPFCP.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGPFCP.header.FCS.maxsize-49',
        'FCSReserved': 'fCGPFCP.header.FCS.reserved-50',
        'FCSPlatformName': 'fCGPFCP.header.FCS.platformName-51',
        'FcCRCAutoCRC': 'fCGPFCP.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGPFCP.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGPFCP.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPFCP, self).__init__(parent, list_op)
