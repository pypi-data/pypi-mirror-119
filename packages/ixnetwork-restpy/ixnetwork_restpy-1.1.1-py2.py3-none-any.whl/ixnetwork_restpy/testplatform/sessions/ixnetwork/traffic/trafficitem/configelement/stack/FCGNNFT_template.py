...
class FCGNNFT(Base):
    ...
    _SDM_NAME = 'fCGNNFT'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGNNFT.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGNNFT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGNNFT.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGNNFT.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGNNFT.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGNNFT.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGNNFT.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGNNFT.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGNNFT.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGNNFT.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGNNFT.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGNNFT.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGNNFT.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGNNFT.header.fcHeader.type-14',
        'FCTLCustom': 'fCGNNFT.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGNNFT.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGNNFT.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGNNFT.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGNNFT.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGNNFT.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGNNFT.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGNNFT.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGNNFT.header.fcCT.revision-42',
        'FcCTInId': 'fCGNNFT.header.fcCT.inId-43',
        'FcCTGsType': 'fCGNNFT.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGNNFT.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGNNFT.header.fcCT.options-46',
        'FcCTReserved': 'fCGNNFT.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGNNFT.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGNNFT.header.dNS.maxsize-49',
        'DNSReserved': 'fCGNNFT.header.dNS.reserved-50',
        'DNSFlags': 'fCGNNFT.header.dNS.flags-51',
        'DNSDomainIdScope': 'fCGNNFT.header.dNS.domainIdScope-52',
        'DNSAreaIdScope': 'fCGNNFT.header.dNS.areaIdScope-53',
        'DNSFc4TypeCode': 'fCGNNFT.header.dNS.fc4TypeCode-54',
        'FcCRCAutoCRC': 'fCGNNFT.header.fcCRC.autoCRC-55',
        'FcCRCGenerateBadCRC': 'fCGNNFT.header.fcCRC.generateBadCRC-56',
        'FcTrailerEof': 'fCGNNFT.header.fcTrailer.eof-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCGNNFT, self).__init__(parent, list_op)
