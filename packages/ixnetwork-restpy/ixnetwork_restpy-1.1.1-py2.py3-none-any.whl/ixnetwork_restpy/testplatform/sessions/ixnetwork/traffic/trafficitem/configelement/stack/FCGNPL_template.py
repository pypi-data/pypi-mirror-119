...
class FCGNPL(Base):
    ...
    _SDM_NAME = 'fCGNPL'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGNPL.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGNPL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGNPL.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGNPL.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGNPL.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGNPL.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGNPL.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGNPL.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGNPL.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGNPL.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGNPL.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGNPL.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGNPL.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGNPL.header.fcHeader.type-14',
        'FCTLCustom': 'fCGNPL.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGNPL.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGNPL.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGNPL.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGNPL.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGNPL.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGNPL.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGNPL.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGNPL.header.fcCT.revision-42',
        'FcCTInId': 'fCGNPL.header.fcCT.inId-43',
        'FcCTGsType': 'fCGNPL.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGNPL.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGNPL.header.fcCT.options-46',
        'FcCTReserved': 'fCGNPL.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGNPL.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGNPL.header.FCS.maxsize-49',
        'FCSReserved': 'fCGNPL.header.FCS.reserved-50',
        'FcCRCAutoCRC': 'fCGNPL.header.fcCRC.autoCRC-51',
        'FcCRCGenerateBadCRC': 'fCGNPL.header.fcCRC.generateBadCRC-52',
        'FcTrailerEof': 'fCGNPL.header.fcTrailer.eof-53',
    }

    def __init__(self, parent, list_op=False):
        super(FCGNPL, self).__init__(parent, list_op)
