...
class FCRPNL(Base):
    ...
    _SDM_NAME = 'fCRPNL'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCRPNL.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCRPNL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCRPNL.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCRPNL.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCRPNL.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCRPNL.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCRPNL.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCRPNL.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCRPNL.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCRPNL.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCRPNL.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCRPNL.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCRPNL.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCRPNL.header.fcHeader.type-14',
        'FCTLCustom': 'fCRPNL.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCRPNL.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCRPNL.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCRPNL.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCRPNL.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCRPNL.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCRPNL.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCRPNL.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCRPNL.header.fcCT.revision-42',
        'FcCTInId': 'fCRPNL.header.fcCT.inId-43',
        'FcCTGsType': 'fCRPNL.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCRPNL.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCRPNL.header.fcCT.options-46',
        'FcCTReserved': 'fCRPNL.header.fcCT.reserved-47',
        'FCSOpcode': 'fCRPNL.header.FCS.opcode-48',
        'FCSMaxsize': 'fCRPNL.header.FCS.maxsize-49',
        'FCSReserved': 'fCRPNL.header.FCS.reserved-50',
        'FCSPlatformName': 'fCRPNL.header.FCS.platformName-51',
        'FCSPlatformNodeName': 'fCRPNL.header.FCS.platformNodeName-52',
        'FcCRCAutoCRC': 'fCRPNL.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCRPNL.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCRPNL.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCRPNL, self).__init__(parent, list_op)
