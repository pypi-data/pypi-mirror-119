...
class FCGPLT(Base):
    ...
    _SDM_NAME = 'fCGPLT'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPLT.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPLT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPLT.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPLT.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPLT.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPLT.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPLT.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPLT.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPLT.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPLT.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPLT.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPLT.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPLT.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPLT.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPLT.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPLT.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPLT.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPLT.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPLT.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPLT.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPLT.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPLT.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPLT.header.fcCT.revision-42',
        'FcCTInId': 'fCGPLT.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPLT.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPLT.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPLT.header.fcCT.options-46',
        'FcCTReserved': 'fCGPLT.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGPLT.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGPLT.header.FCS.maxsize-49',
        'FCSReserved': 'fCGPLT.header.FCS.reserved-50',
        'FCSPlatformName': 'fCGPLT.header.FCS.platformName-51',
        'FcCRCAutoCRC': 'fCGPLT.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGPLT.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGPLT.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPLT, self).__init__(parent, list_op)
