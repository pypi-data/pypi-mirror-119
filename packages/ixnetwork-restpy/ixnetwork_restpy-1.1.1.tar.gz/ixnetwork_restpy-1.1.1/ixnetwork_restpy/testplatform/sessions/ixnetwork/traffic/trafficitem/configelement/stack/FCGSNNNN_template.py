...
class FCGSNNNN(Base):
    ...
    _SDM_NAME = 'fCGSNNNN'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGSNNNN.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGSNNNN.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGSNNNN.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGSNNNN.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGSNNNN.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGSNNNN.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGSNNNN.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGSNNNN.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGSNNNN.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGSNNNN.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGSNNNN.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGSNNNN.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGSNNNN.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGSNNNN.header.fcHeader.type-14',
        'FCTLCustom': 'fCGSNNNN.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGSNNNN.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGSNNNN.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGSNNNN.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGSNNNN.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGSNNNN.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGSNNNN.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGSNNNN.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGSNNNN.header.fcCT.revision-42',
        'FcCTInId': 'fCGSNNNN.header.fcCT.inId-43',
        'FcCTGsType': 'fCGSNNNN.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGSNNNN.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGSNNNN.header.fcCT.options-46',
        'FcCTReserved': 'fCGSNNNN.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGSNNNN.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGSNNNN.header.dNS.maxsize-49',
        'DNSReserved': 'fCGSNNNN.header.dNS.reserved-50',
        'DNSNodeName': 'fCGSNNNN.header.dNS.nodeName-51',
        'FcCRCAutoCRC': 'fCGSNNNN.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGSNNNN.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGSNNNN.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGSNNNN, self).__init__(parent, list_op)
