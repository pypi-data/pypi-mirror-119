...
class FcLSARequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fcLSARequest'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcLSARequest.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcLSARequest.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcLSARequest.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcLSARequest.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcLSARequest.header.fcHeader.type-5',
        'FcHeaderSof': 'fcLSARequest.header.fcHeader.sof-6',
        'FCTLCustom': 'fcLSARequest.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcLSARequest.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcLSARequest.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcLSARequest.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcLSARequest.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcLSARequest.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcLSARequest.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcLSARequest.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcLSARequest.header.fcCmd-34',
        'FspfHeaderFspfCommand': 'fcLSARequest.header.fspfHeader.fspfCommand-35',
        'FspfHeaderFspVersion': 'fcLSARequest.header.fspfHeader.fspVersion-36',
        'FspfHeaderFspfObsolete': 'fcLSARequest.header.fspfHeader.fspfObsolete-37',
        'FspfHeaderFspfAuthType': 'fcLSARequest.header.fspfHeader.fspfAuthType-38',
        'FspfHeaderFspfReserved': 'fcLSARequest.header.fspfHeader.fspfReserved-39',
        'FspfHeaderFspfOrigDID': 'fcLSARequest.header.fspfHeader.fspfOrigDID-40',
        'FspfHeaderFspfAuth': 'fcLSARequest.header.fspfHeader.fspfAuth-41',
        'HeaderReserved': 'fcLSARequest.header.reserved-42',
        'HeaderFlags': 'fcLSARequest.header.flags-43',
        'HeaderNrLSRhs': 'fcLSARequest.header.nrLSRhs-44',
        'LinkStateHeaderLsrType': 'fcLSARequest.header.linkStateHeader.lsrType-45',
        'LinkStateHeaderLsrReserved1': 'fcLSARequest.header.linkStateHeader.lsrReserved1-46',
        'LinkStateHeaderLsrAge': 'fcLSARequest.header.linkStateHeader.lsrAge-47',
        'LinkStateHeaderLsrReserved2': 'fcLSARequest.header.linkStateHeader.lsrReserved2-48',
        'LinkStateHeaderLsrIdentifier': 'fcLSARequest.header.linkStateHeader.lsrIdentifier-49',
        'LinkStateHeaderLsrAdvertisingDID': 'fcLSARequest.header.linkStateHeader.lsrAdvertisingDID-50',
        'LinkStateHeaderLsrIncarnationNr': 'fcLSARequest.header.linkStateHeader.lsrIncarnationNr-51',
        'LinkStateHeaderLsrChecksum': 'fcLSARequest.header.linkStateHeader.lsrChecksum-52',
        'LinkStateHeaderLsrLength': 'fcLSARequest.header.linkStateHeader.lsrLength-53',
    }

    def __init__(self, parent, list_op=False):
        super(FcLSARequest, self).__init__(parent, list_op)
