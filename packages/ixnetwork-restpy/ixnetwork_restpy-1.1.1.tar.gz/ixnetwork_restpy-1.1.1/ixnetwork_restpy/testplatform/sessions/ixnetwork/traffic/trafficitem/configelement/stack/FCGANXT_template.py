...
class FCGANXT(Base):
    ...
    _SDM_NAME = 'fCGANXT'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGANXT.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGANXT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGANXT.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGANXT.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGANXT.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGANXT.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGANXT.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGANXT.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGANXT.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGANXT.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGANXT.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGANXT.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGANXT.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGANXT.header.fcHeader.type-14',
        'FCTLCustom': 'fCGANXT.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGANXT.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGANXT.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGANXT.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGANXT.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGANXT.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGANXT.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGANXT.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGANXT.header.fcCT.revision-42',
        'FcCTInId': 'fCGANXT.header.fcCT.inId-43',
        'FcCTGsType': 'fCGANXT.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGANXT.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGANXT.header.fcCT.options-46',
        'FcCTReserved': 'fCGANXT.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGANXT.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGANXT.header.dNS.maxsize-49',
        'DNSReserved': 'fCGANXT.header.dNS.reserved-50',
        'DNSPortId': 'fCGANXT.header.dNS.portId-51',
        'FcCRCAutoCRC': 'fCGANXT.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGANXT.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGANXT.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGANXT, self).__init__(parent, list_op)
