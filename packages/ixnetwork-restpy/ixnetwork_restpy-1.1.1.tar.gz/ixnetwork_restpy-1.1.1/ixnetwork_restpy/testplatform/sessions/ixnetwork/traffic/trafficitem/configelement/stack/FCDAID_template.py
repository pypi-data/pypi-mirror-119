...
class FCDAID(Base):
    ...
    _SDM_NAME = 'fCDAID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCDAID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCDAID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCDAID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCDAID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCDAID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCDAID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCDAID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCDAID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCDAID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCDAID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCDAID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCDAID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCDAID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCDAID.header.fcHeader.type-14',
        'FCTLCustom': 'fCDAID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCDAID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCDAID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCDAID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCDAID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCDAID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCDAID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCDAID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCDAID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCDAID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCDAID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCDAID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCDAID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCDAID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCDAID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCDAID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCDAID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCDAID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCDAID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCDAID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCDAID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCDAID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCDAID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCDAID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCDAID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCDAID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCDAID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCDAID.header.fcCT.revision-42',
        'FcCTInId': 'fCDAID.header.fcCT.inId-43',
        'FcCTGsType': 'fCDAID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCDAID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCDAID.header.fcCT.options-46',
        'FcCTReserved': 'fCDAID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCDAID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCDAID.header.dNS.maxsize-49',
        'DNSReserved': 'fCDAID.header.dNS.reserved-50',
        'DNSPortId': 'fCDAID.header.dNS.portId-51',
        'FcCRCAutoCRC': 'fCDAID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCDAID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCDAID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCDAID, self).__init__(parent, list_op)
