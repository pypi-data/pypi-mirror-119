...
class FCGSES(Base):
    ...
    _SDM_NAME = 'fCGSES'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGSES.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGSES.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGSES.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGSES.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGSES.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGSES.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGSES.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGSES.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGSES.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGSES.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGSES.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGSES.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGSES.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGSES.header.fcHeader.type-14',
        'FCTLCustom': 'fCGSES.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGSES.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGSES.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGSES.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGSES.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGSES.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGSES.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGSES.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGSES.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGSES.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGSES.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGSES.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGSES.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGSES.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGSES.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGSES.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGSES.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGSES.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGSES.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGSES.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGSES.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGSES.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGSES.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGSES.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGSES.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGSES.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGSES.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGSES.header.fcCT.revision-42',
        'FcCTInId': 'fCGSES.header.fcCT.inId-43',
        'FcCTGsType': 'fCGSES.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGSES.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGSES.header.fcCT.options-46',
        'FcCTReserved': 'fCGSES.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGSES.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGSES.header.FCS.maxsize-49',
        'FCSReserved': 'fCGSES.header.FCS.reserved-50',
        'FCSInterconnectElementName': 'fCGSES.header.FCS.interconnectElementName-51',
        'FcCRCAutoCRC': 'fCGSES.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGSES.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGSES.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGSES, self).__init__(parent, list_op)
