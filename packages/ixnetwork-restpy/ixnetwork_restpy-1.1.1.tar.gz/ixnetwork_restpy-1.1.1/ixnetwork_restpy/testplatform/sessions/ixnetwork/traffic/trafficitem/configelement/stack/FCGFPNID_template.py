...
class FCGFPNID(Base):
    ...
    _SDM_NAME = 'fCGFPNID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGFPNID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGFPNID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGFPNID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGFPNID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGFPNID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGFPNID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGFPNID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGFPNID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGFPNID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGFPNID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGFPNID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGFPNID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGFPNID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGFPNID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGFPNID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGFPNID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGFPNID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGFPNID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGFPNID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGFPNID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGFPNID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGFPNID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGFPNID.header.fcCT.revision-42',
        'FcCTInId': 'fCGFPNID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGFPNID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGFPNID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGFPNID.header.fcCT.options-46',
        'FcCTReserved': 'fCGFPNID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGFPNID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGFPNID.header.dNS.maxsize-49',
        'DNSReserved': 'fCGFPNID.header.dNS.reserved-50',
        'DNSPortId': 'fCGFPNID.header.dNS.portId-51',
        'FcCRCAutoCRC': 'fCGFPNID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGFPNID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGFPNID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGFPNID, self).__init__(parent, list_op)
