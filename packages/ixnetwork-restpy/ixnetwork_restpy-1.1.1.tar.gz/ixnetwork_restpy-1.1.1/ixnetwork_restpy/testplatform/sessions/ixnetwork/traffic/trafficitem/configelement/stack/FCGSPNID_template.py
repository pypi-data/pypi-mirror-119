...
class FCGSPNID(Base):
    ...
    _SDM_NAME = 'fCGSPNID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGSPNID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGSPNID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGSPNID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGSPNID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGSPNID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGSPNID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGSPNID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGSPNID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGSPNID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGSPNID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGSPNID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGSPNID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGSPNID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGSPNID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGSPNID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGSPNID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGSPNID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGSPNID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGSPNID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGSPNID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGSPNID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGSPNID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGSPNID.header.fcCT.revision-42',
        'FcCTInId': 'fCGSPNID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGSPNID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGSPNID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGSPNID.header.fcCT.options-46',
        'FcCTReserved': 'fCGSPNID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGSPNID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGSPNID.header.dNS.maxsize-49',
        'DNSReserved': 'fCGSPNID.header.dNS.reserved-50',
        'DNSPortId': 'fCGSPNID.header.dNS.portId-51',
        'FcCRCAutoCRC': 'fCGSPNID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGSPNID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGSPNID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGSPNID, self).__init__(parent, list_op)
