...
class FCGIET(Base):
    ...
    _SDM_NAME = 'fCGIET'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGIET.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGIET.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGIET.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGIET.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGIET.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGIET.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGIET.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGIET.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGIET.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGIET.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGIET.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGIET.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGIET.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGIET.header.fcHeader.type-14',
        'FCTLCustom': 'fCGIET.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGIET.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGIET.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGIET.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGIET.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGIET.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGIET.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGIET.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGIET.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGIET.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGIET.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGIET.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGIET.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGIET.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGIET.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGIET.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGIET.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGIET.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGIET.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGIET.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGIET.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGIET.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGIET.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGIET.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGIET.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGIET.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGIET.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGIET.header.fcCT.revision-42',
        'FcCTInId': 'fCGIET.header.fcCT.inId-43',
        'FcCTGsType': 'fCGIET.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGIET.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGIET.header.fcCT.options-46',
        'FcCTReserved': 'fCGIET.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGIET.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGIET.header.FCS.maxsize-49',
        'FCSReserved': 'fCGIET.header.FCS.reserved-50',
        'FCSInterconnectElementName': 'fCGIET.header.FCS.interconnectElementName-51',
        'FcCRCAutoCRC': 'fCGIET.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGIET.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGIET.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGIET, self).__init__(parent, list_op)
