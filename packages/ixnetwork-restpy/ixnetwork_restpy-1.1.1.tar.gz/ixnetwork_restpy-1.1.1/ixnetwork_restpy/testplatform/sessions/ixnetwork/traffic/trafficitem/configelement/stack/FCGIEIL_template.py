...
class FCGIEIL(Base):
    ...
    _SDM_NAME = 'fCGIEIL'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGIEIL.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGIEIL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGIEIL.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGIEIL.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGIEIL.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGIEIL.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGIEIL.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGIEIL.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGIEIL.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGIEIL.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGIEIL.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGIEIL.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGIEIL.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGIEIL.header.fcHeader.type-14',
        'FCTLCustom': 'fCGIEIL.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGIEIL.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGIEIL.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGIEIL.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGIEIL.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGIEIL.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGIEIL.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGIEIL.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGIEIL.header.fcCT.revision-42',
        'FcCTInId': 'fCGIEIL.header.fcCT.inId-43',
        'FcCTGsType': 'fCGIEIL.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGIEIL.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGIEIL.header.fcCT.options-46',
        'FcCTReserved': 'fCGIEIL.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGIEIL.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGIEIL.header.FCS.maxsize-49',
        'FCSReserved': 'fCGIEIL.header.FCS.reserved-50',
        'FCSInterconnectElementName': 'fCGIEIL.header.FCS.interconnectElementName-51',
        'FcCRCAutoCRC': 'fCGIEIL.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGIEIL.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGIEIL.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGIEIL, self).__init__(parent, list_op)
