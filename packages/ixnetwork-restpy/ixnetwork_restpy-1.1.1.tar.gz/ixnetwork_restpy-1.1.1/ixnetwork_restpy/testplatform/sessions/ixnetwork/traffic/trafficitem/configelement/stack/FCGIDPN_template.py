...
class FCGIDPN(Base):
    ...
    _SDM_NAME = 'fCGIDPN'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGIDPN.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGIDPN.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGIDPN.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGIDPN.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGIDPN.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGIDPN.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGIDPN.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGIDPN.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGIDPN.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGIDPN.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGIDPN.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGIDPN.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGIDPN.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGIDPN.header.fcHeader.type-14',
        'FCTLCustom': 'fCGIDPN.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGIDPN.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGIDPN.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGIDPN.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGIDPN.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGIDPN.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGIDPN.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGIDPN.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGIDPN.header.fcCT.revision-42',
        'FcCTInId': 'fCGIDPN.header.fcCT.inId-43',
        'FcCTGsType': 'fCGIDPN.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGIDPN.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGIDPN.header.fcCT.options-46',
        'FcCTReserved': 'fCGIDPN.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGIDPN.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGIDPN.header.dNS.maxsize-49',
        'DNSReserved': 'fCGIDPN.header.dNS.reserved-50',
        'DNSPortName': 'fCGIDPN.header.dNS.portName-51',
        'FcCRCAutoCRC': 'fCGIDPN.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGIDPN.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGIDPN.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGIDPN, self).__init__(parent, list_op)
