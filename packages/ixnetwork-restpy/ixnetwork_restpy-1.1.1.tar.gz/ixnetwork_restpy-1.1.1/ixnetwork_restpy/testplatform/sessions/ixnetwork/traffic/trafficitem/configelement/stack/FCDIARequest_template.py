...
class FcDIARequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fcDIARequest'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcDIARequest.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcDIARequest.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcDIARequest.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcDIARequest.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcDIARequest.header.fcHeader.type-5',
        'FcHeaderSof': 'fcDIARequest.header.fcHeader.sof-6',
        'FCTLCustom': 'fcDIARequest.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcDIARequest.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcDIARequest.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcDIARequest.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcDIARequest.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcDIARequest.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcDIARequest.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcDIARequest.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcDIARequest.header.fcCmd-34',
        'HeaderReserved1': 'fcDIARequest.header.reserved1-35',
        'HeaderOrigSwitchName': 'fcDIARequest.header.origSwitchName-36',
        'HeaderReserved2': 'fcDIARequest.header.reserved2-37',
    }

    def __init__(self, parent, list_op=False):
        super(FcDIARequest, self).__init__(parent, list_op)
    ...
    def HeaderOrigSwitchName(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderOrigSwitchName']))
