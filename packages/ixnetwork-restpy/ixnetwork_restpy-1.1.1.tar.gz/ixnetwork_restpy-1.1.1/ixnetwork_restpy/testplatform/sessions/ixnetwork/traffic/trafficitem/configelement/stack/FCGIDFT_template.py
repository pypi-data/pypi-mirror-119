...
class FCGIDFT(Base):
    ...
    _SDM_NAME = 'fCGIDFT'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGIDFT.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGIDFT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGIDFT.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGIDFT.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGIDFT.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGIDFT.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGIDFT.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGIDFT.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGIDFT.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGIDFT.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGIDFT.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGIDFT.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGIDFT.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGIDFT.header.fcHeader.type-14',
        'FCTLCustom': 'fCGIDFT.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGIDFT.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGIDFT.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGIDFT.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGIDFT.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGIDFT.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGIDFT.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGIDFT.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGIDFT.header.fcCT.revision-42',
        'FcCTInId': 'fCGIDFT.header.fcCT.inId-43',
        'FcCTGsType': 'fCGIDFT.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGIDFT.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGIDFT.header.fcCT.options-46',
        'FcCTReserved': 'fCGIDFT.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGIDFT.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGIDFT.header.dNS.maxsize-49',
        'DNSReserved': 'fCGIDFT.header.dNS.reserved-50',
        'DNSFlags': 'fCGIDFT.header.dNS.flags-51',
        'DNSDomainIdScope': 'fCGIDFT.header.dNS.domainIdScope-52',
        'DNSAreaIdScope': 'fCGIDFT.header.dNS.areaIdScope-53',
        'DNSFc4TypeCode': 'fCGIDFT.header.dNS.fc4TypeCode-54',
        'FcCRCAutoCRC': 'fCGIDFT.header.fcCRC.autoCRC-55',
        'FcCRCGenerateBadCRC': 'fCGIDFT.header.fcCRC.generateBadCRC-56',
        'FcTrailerEof': 'fCGIDFT.header.fcTrailer.eof-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCGIDFT, self).__init__(parent, list_op)
