...
class FcEFPRequest(Base):
    __slots__ = ()
    _SDM_NAME = 'fcEFPRequest'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcEFPRequest.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcEFPRequest.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcEFPRequest.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcEFPRequest.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcEFPRequest.header.fcHeader.type-5',
        'FcHeaderSof': 'fcEFPRequest.header.fcHeader.sof-6',
        'FCTLCustom': 'fcEFPRequest.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcEFPRequest.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcEFPRequest.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcEFPRequest.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcEFPRequest.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcEFPRequest.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcEFPRequest.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcEFPRequest.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcEFPRequest.header.fcCmd-34',
        'HeaderReserved1': 'fcEFPRequest.header.reserved1-35',
        'HeaderReserved2': 'fcEFPRequest.header.reserved2-36',
        'HeaderLength': 'fcEFPRequest.header.length-37',
        'HeaderReserved3': 'fcEFPRequest.header.reserved3-38',
        'HeaderPrincipalSwitchPriority': 'fcEFPRequest.header.principalSwitchPriority-39',
        'HeaderPrincipalSwitchName': 'fcEFPRequest.header.principalSwitchName-40',
        'HeaderRecordType': 'fcEFPRequest.header.recordType-41',
        'HeaderDomainID': 'fcEFPRequest.header.domainID-42',
        'HeaderReserved4': 'fcEFPRequest.header.reserved4-43',
        'HeaderReserved5': 'fcEFPRequest.header.reserved5-44',
        'HeaderSwitchName': 'fcEFPRequest.header.switchName-45',
    }

    def __init__(self, parent, list_op=False):
        super(FcEFPRequest, self).__init__(parent, list_op)
