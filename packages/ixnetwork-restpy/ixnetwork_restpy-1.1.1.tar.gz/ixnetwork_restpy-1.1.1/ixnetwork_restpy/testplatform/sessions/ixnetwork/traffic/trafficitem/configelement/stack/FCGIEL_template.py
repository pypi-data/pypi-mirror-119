...
class FCGIEL(Base):
    ...
    _SDM_NAME = 'fCGIEL'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGIEL.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGIEL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGIEL.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGIEL.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGIEL.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGIEL.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGIEL.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGIEL.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGIEL.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGIEL.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGIEL.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGIEL.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGIEL.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGIEL.header.fcHeader.type-14',
        'FCTLCustom': 'fCGIEL.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGIEL.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGIEL.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGIEL.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGIEL.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGIEL.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGIEL.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGIEL.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGIEL.header.fcCT.revision-42',
        'FcCTInId': 'fCGIEL.header.fcCT.inId-43',
        'FcCTGsType': 'fCGIEL.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGIEL.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGIEL.header.fcCT.options-46',
        'FcCTReserved': 'fCGIEL.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGIEL.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGIEL.header.FCS.maxsize-49',
        'FCSReserved': 'fCGIEL.header.FCS.reserved-50',
        'FcCRCAutoCRC': 'fCGIEL.header.fcCRC.autoCRC-51',
        'FcCRCGenerateBadCRC': 'fCGIEL.header.fcCRC.generateBadCRC-52',
        'FcTrailerEof': 'fCGIEL.header.fcTrailer.eof-53',
    }

    def __init__(self, parent, list_op=False):
        super(FCGIEL, self).__init__(parent, list_op)
