...
class FcELPSWRJT(Base):
    __slots__ = ()
    _SDM_NAME = 'fcELPSWRJT'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcELPSWRJT.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcELPSWRJT.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcELPSWRJT.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcELPSWRJT.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcELPSWRJT.header.fcHeader.type-5',
        'FcHeaderSof': 'fcELPSWRJT.header.fcHeader.sof-6',
        'FCTLCustom': 'fcELPSWRJT.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcELPSWRJT.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcELPSWRJT.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcELPSWRJT.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcELPSWRJT.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcELPSWRJT.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcELPSWRJT.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcELPSWRJT.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcELPSWRJT.header.fcCmd-34',
        'HeaderReserved1': 'fcELPSWRJT.header.reserved1-35',
        'HeaderReserved2': 'fcELPSWRJT.header.reserved2-36',
        'HeaderReasonCode': 'fcELPSWRJT.header.reasonCode-37',
        'HeaderReasonExplain': 'fcELPSWRJT.header.reasonExplain-38',
        'HeaderVendor': 'fcELPSWRJT.header.vendor-39',
    }

    def __init__(self, parent, list_op=False):
        super(FcELPSWRJT, self).__init__(parent, list_op)
