...
class FCRNNID(Base):
    ...
    _SDM_NAME = 'fCRNNID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCRNNID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCRNNID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCRNNID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCRNNID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCRNNID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCRNNID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCRNNID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCRNNID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCRNNID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCRNNID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCRNNID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCRNNID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCRNNID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCRNNID.header.fcHeader.type-14',
        'FCTLCustom': 'fCRNNID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCRNNID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCRNNID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCRNNID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCRNNID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCRNNID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCRNNID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCRNNID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCRNNID.header.fcCT.revision-42',
        'FcCTInId': 'fCRNNID.header.fcCT.inId-43',
        'FcCTGsType': 'fCRNNID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCRNNID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCRNNID.header.fcCT.options-46',
        'FcCTReserved': 'fCRNNID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCRNNID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCRNNID.header.dNS.maxsize-49',
        'DNSReserved': 'fCRNNID.header.dNS.reserved-50',
        'DNSPortId': 'fCRNNID.header.dNS.portId-51',
        'DNSNodeName': 'fCRNNID.header.dNS.nodeName-52',
        'FcCRCAutoCRC': 'fCRNNID.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCRNNID.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCRNNID.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCRNNID, self).__init__(parent, list_op)
