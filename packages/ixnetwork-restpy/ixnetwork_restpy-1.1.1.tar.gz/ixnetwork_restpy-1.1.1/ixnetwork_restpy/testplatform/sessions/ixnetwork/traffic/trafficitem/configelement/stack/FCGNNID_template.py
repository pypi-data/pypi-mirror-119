...
class FCGNNID(Base):
    ...
    _SDM_NAME = 'fCGNNID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGNNID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGNNID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGNNID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGNNID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGNNID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGNNID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGNNID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGNNID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGNNID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGNNID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGNNID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGNNID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGNNID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGNNID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGNNID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGNNID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGNNID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGNNID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGNNID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGNNID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGNNID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGNNID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGNNID.header.fcCT.revision-42',
        'FcCTInId': 'fCGNNID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGNNID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGNNID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGNNID.header.fcCT.options-46',
        'FcCTReserved': 'fCGNNID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGNNID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGNNID.header.dNS.maxsize-49',
        'DNSReserved': 'fCGNNID.header.dNS.reserved-50',
        'DNSPortId': 'fCGNNID.header.dNS.portId-51',
        'FcCRCAutoCRC': 'fCGNNID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGNNID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGNNID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGNNID, self).__init__(parent, list_op)
