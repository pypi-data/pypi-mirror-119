...
class FCGPLML(Base):
    ...
    _SDM_NAME = 'fCGPLML'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPLML.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPLML.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPLML.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPLML.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPLML.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPLML.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPLML.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPLML.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPLML.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPLML.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPLML.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPLML.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPLML.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPLML.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPLML.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPLML.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPLML.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPLML.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPLML.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPLML.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPLML.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPLML.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPLML.header.fcCT.revision-42',
        'FcCTInId': 'fCGPLML.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPLML.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPLML.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPLML.header.fcCT.options-46',
        'FcCTReserved': 'fCGPLML.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGPLML.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGPLML.header.FCS.maxsize-49',
        'FCSReserved': 'fCGPLML.header.FCS.reserved-50',
        'FCSPlatformName': 'fCGPLML.header.FCS.platformName-51',
        'FcCRCAutoCRC': 'fCGPLML.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGPLML.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGPLML.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPLML, self).__init__(parent, list_op)
