...
class FcESCSWRJT(Base):
    __slots__ = ()
    _SDM_NAME = 'fcESCSWRJT'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcESCSWRJT.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcESCSWRJT.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcESCSWRJT.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcESCSWRJT.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcESCSWRJT.header.fcHeader.type-5',
        'FcHeaderSof': 'fcESCSWRJT.header.fcHeader.sof-6',
        'FCTLCustom': 'fcESCSWRJT.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcESCSWRJT.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcESCSWRJT.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcESCSWRJT.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcESCSWRJT.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcESCSWRJT.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcESCSWRJT.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcESCSWRJT.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcESCSWRJT.header.fcCmd-34',
        'HeaderReserved1': 'fcESCSWRJT.header.reserved1-35',
        'HeaderReserved2': 'fcESCSWRJT.header.reserved2-36',
        'HeaderReasonCode': 'fcESCSWRJT.header.reasonCode-37',
        'HeaderReasonExplain': 'fcESCSWRJT.header.reasonExplain-38',
        'HeaderVendor': 'fcESCSWRJT.header.vendor-39',
    }

    def __init__(self, parent, list_op=False):
        super(FcESCSWRJT, self).__init__(parent, list_op)
