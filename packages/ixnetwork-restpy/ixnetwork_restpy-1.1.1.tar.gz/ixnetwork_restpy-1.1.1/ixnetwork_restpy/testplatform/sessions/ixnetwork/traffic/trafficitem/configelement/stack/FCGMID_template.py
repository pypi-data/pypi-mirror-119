...
class FCGMID(Base):
    ...
    _SDM_NAME = 'fCGMID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGMID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGMID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGMID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGMID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGMID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGMID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGMID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGMID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGMID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGMID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGMID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGMID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGMID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGMID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGMID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGMID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGMID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGMID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGMID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGMID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGMID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGMID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGMID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGMID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGMID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGMID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGMID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGMID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGMID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGMID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGMID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGMID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGMID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGMID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGMID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGMID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGMID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGMID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGMID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGMID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGMID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGMID.header.fcCT.revision-42',
        'FcCTInId': 'fCGMID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGMID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGMID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGMID.header.fcCT.options-46',
        'FcCTReserved': 'fCGMID.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGMID.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGMID.header.FCS.maxsize-49',
        'FCSReserved': 'fCGMID.header.FCS.reserved-50',
        'FCSInterconnectElementName': 'fCGMID.header.FCS.interconnectElementName-51',
        'FcCRCAutoCRC': 'fCGMID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGMID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGMID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGMID, self).__init__(parent, list_op)
