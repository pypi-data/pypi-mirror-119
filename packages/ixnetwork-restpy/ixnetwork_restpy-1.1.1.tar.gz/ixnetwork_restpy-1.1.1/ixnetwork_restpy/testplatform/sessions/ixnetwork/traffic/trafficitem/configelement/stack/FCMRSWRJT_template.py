...
class FcMRSWRJT(Base):
    __slots__ = ()
    _SDM_NAME = 'fcMRSWRJT'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcMRSWRJT.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcMRSWRJT.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcMRSWRJT.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcMRSWRJT.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcMRSWRJT.header.fcHeader.type-5',
        'FcHeaderSof': 'fcMRSWRJT.header.fcHeader.sof-6',
        'FCTLCustom': 'fcMRSWRJT.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcMRSWRJT.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcMRSWRJT.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcMRSWRJT.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcMRSWRJT.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcMRSWRJT.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcMRSWRJT.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcMRSWRJT.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcMRSWRJT.header.fcCmd-34',
        'HeaderReserved1': 'fcMRSWRJT.header.reserved1-35',
        'HeaderReserved2': 'fcMRSWRJT.header.reserved2-36',
        'HeaderReasonCode': 'fcMRSWRJT.header.reasonCode-37',
        'HeaderReasonExplain': 'fcMRSWRJT.header.reasonExplain-38',
        'HeaderVendor': 'fcMRSWRJT.header.vendor-39',
    }

    def __init__(self, parent, list_op=False):
        super(FcMRSWRJT, self).__init__(parent, list_op)
