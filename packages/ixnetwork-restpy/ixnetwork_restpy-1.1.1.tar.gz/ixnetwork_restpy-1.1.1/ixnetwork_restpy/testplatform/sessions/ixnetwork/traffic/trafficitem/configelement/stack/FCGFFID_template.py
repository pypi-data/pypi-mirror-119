...
class FCGFFID(Base):
    ...
    _SDM_NAME = 'fCGFFID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGFFID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGFFID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGFFID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGFFID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGFFID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGFFID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGFFID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGFFID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGFFID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGFFID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGFFID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGFFID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGFFID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGFFID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGFFID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGFFID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGFFID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGFFID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGFFID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGFFID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGFFID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGFFID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGFFID.header.fcCT.revision-42',
        'FcCTInId': 'fCGFFID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGFFID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGFFID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGFFID.header.fcCT.options-46',
        'FcCTReserved': 'fCGFFID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGFFID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGFFID.header.dNS.maxsize-49',
        'DNSReserved': 'fCGFFID.header.dNS.reserved-50',
        'DNSPortId': 'fCGFFID.header.dNS.portId-51',
        'FcCRCAutoCRC': 'fCGFFID.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGFFID.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGFFID.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGFFID, self).__init__(parent, list_op)
