...
class FCGPNL(Base):
    ...
    _SDM_NAME = 'fCGPNL'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPNL.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPNL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPNL.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPNL.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPNL.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPNL.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPNL.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPNL.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPNL.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPNL.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPNL.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPNL.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPNL.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPNL.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPNL.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPNL.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPNL.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPNL.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPNL.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPNL.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPNL.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPNL.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPNL.header.fcCT.revision-42',
        'FcCTInId': 'fCGPNL.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPNL.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPNL.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPNL.header.fcCT.options-46',
        'FcCTReserved': 'fCGPNL.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGPNL.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGPNL.header.FCS.maxsize-49',
        'FCSReserved': 'fCGPNL.header.FCS.reserved-50',
        'FcCRCAutoCRC': 'fCGPNL.header.fcCRC.autoCRC-51',
        'FcCRCGenerateBadCRC': 'fCGPNL.header.fcCRC.generateBadCRC-52',
        'FcTrailerEof': 'fCGPNL.header.fcTrailer.eof-53',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPNL, self).__init__(parent, list_op)
