...
class FcRDISWRJT(Base):
    __slots__ = ()
    _SDM_NAME = 'fcRDISWRJT'
    _SDM_ATT_MAP = {
        'FcHeaderRCTL': 'fcRDISWRJT.header.fcHeader.rCTL-1',
        'FcHeaderDstId': 'fcRDISWRJT.header.fcHeader.dstId-2',
        'FcHeaderCsCTLPriority': 'fcRDISWRJT.header.fcHeader.csCTLPriority-3',
        'FcHeaderSrcId': 'fcRDISWRJT.header.fcHeader.srcId-4',
        'FcHeaderType': 'fcRDISWRJT.header.fcHeader.type-5',
        'FcHeaderSof': 'fcRDISWRJT.header.fcHeader.sof-6',
        'FCTLCustom': 'fcRDISWRJT.header.fcHeader.fCTL.custom-7',
        'BuildFCTLExchangeContext': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.exchangeContext-8',
        'BuildFCTLSequenceContext': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.sequenceContext-9',
        'BuildFCTLFirstSequence': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.firstSequence-10',
        'BuildFCTLLastSequence': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.lastSequence-11',
        'BuildFCTLEndSequence': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.endSequence-12',
        'BuildFCTLEndConnection': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.endConnection-13',
        'BuildFCTLCsCTLPriority': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-14',
        'BuildFCTLSequenceInitiative': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-15',
        'BuildFCTLFcXIDReassigned': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-16',
        'BuildFCTLFcInvalidateXID': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-17',
        'BuildFCTLAckForm': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.ackForm-18',
        'BuildFCTLFcDataCompression': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-19',
        'BuildFCTLFcDataEncryption': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-20',
        'BuildFCTLRetransmittedSequence': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-21',
        'BuildFCTLUnidirectionalTransmit': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-22',
        'BuildFCTLContinueSeqCondition': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-23',
        'BuildFCTLAbortSeqCondition': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-24',
        'BuildFCTLRelativeOffsetPresent': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-25',
        'BuildFCTLExchangeReassembly': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-26',
        'BuildFCTLFillBytes': 'fcRDISWRJT.header.fcHeader.fCTL.buildFCTL.fillBytes-27',
        'FcHeaderSeqID': 'fcRDISWRJT.header.fcHeader.seqID-28',
        'FcHeaderDfCTL': 'fcRDISWRJT.header.fcHeader.dfCTL-29',
        'FcHeaderSeqCNT': 'fcRDISWRJT.header.fcHeader.seqCNT-30',
        'FcHeaderOxID': 'fcRDISWRJT.header.fcHeader.oxID-31',
        'FcHeaderRxID': 'fcRDISWRJT.header.fcHeader.rxID-32',
        'FcHeaderParameter': 'fcRDISWRJT.header.fcHeader.parameter-33',
        'HeaderFcCmd': 'fcRDISWRJT.header.fcCmd-34',
        'HeaderReserved1': 'fcRDISWRJT.header.reserved1-35',
        'HeaderReserved2': 'fcRDISWRJT.header.reserved2-36',
        'HeaderReasonCode': 'fcRDISWRJT.header.reasonCode-37',
        'HeaderReasonExplain': 'fcRDISWRJT.header.reasonExplain-38',
        'HeaderVendor': 'fcRDISWRJT.header.vendor-39',
    }

    def __init__(self, parent, list_op=False):
        super(FcRDISWRJT, self).__init__(parent, list_op)
    ...
    def HeaderReasonCode(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderReasonCode']))
    ...
    def HeaderReasonExplain(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['HeaderReasonExplain']))
