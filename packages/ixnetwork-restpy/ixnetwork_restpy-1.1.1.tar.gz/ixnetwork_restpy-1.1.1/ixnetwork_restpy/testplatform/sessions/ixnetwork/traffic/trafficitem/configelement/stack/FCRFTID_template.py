...
class FCRFTID(Base):
    ...
    _SDM_NAME = 'fCRFTID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCRFTID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCRFTID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCRFTID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCRFTID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCRFTID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCRFTID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCRFTID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCRFTID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCRFTID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCRFTID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCRFTID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCRFTID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCRFTID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCRFTID.header.fcHeader.type-14',
        'FCTLCustom': 'fCRFTID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCRFTID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCRFTID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCRFTID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCRFTID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCRFTID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCRFTID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCRFTID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCRFTID.header.fcCT.revision-42',
        'FcCTInId': 'fCRFTID.header.fcCT.inId-43',
        'FcCTGsType': 'fCRFTID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCRFTID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCRFTID.header.fcCT.options-46',
        'FcCTReserved': 'fCRFTID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCRFTID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCRFTID.header.dNS.maxsize-49',
        'DNSReserved': 'fCRFTID.header.dNS.reserved-50',
        'DNSPortId': 'fCRFTID.header.dNS.portId-51',
        'DNSFc4Types': 'fCRFTID.header.dNS.fc4Types-52',
        'FcCRCAutoCRC': 'fCRFTID.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCRFTID.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCRFTID.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCRFTID, self).__init__(parent, list_op)
    ...
    @property
    def DNSFc4Types(self):
        """
        Display Name: FC-4 TYPEs
        Default Value: 0x00000000
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['DNSFc4Types']))
