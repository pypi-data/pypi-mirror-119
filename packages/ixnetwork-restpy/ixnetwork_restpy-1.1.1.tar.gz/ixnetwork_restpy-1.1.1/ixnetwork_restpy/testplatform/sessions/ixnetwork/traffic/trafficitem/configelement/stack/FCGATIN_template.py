...
class FCGATIN(Base):
    ...
    _SDM_NAME = 'fCGATIN'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGATIN.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGATIN.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGATIN.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGATIN.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGATIN.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGATIN.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGATIN.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGATIN.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGATIN.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGATIN.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGATIN.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGATIN.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGATIN.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGATIN.header.fcHeader.type-14',
        'FCTLCustom': 'fCGATIN.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGATIN.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGATIN.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGATIN.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGATIN.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGATIN.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGATIN.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGATIN.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGATIN.header.fcCT.revision-42',
        'FcCTInId': 'fCGATIN.header.fcCT.inId-43',
        'FcCTGsType': 'fCGATIN.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGATIN.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGATIN.header.fcCT.options-46',
        'FcCTReserved': 'fCGATIN.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGATIN.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGATIN.header.FCS.maxsize-49',
        'FCSReserved': 'fCGATIN.header.FCS.reserved-50',
        'FCSInterconnectElementPortName': 'fCGATIN.header.FCS.interconnectElementPortName-51',
        'FcCRCAutoCRC': 'fCGATIN.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGATIN.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGATIN.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGATIN, self).__init__(parent, list_op)
    ...
    @property
    def FCSInterconnectElementPortName(self):
        """
        Display Name: Interconnect Element Port Name
        Default Value: 0x00
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FCSInterconnectElementPortName']))
