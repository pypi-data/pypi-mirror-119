...
class FCGPLI(Base):
    ...
    _SDM_NAME = 'fCGPLI'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPLI.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPLI.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPLI.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPLI.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPLI.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPLI.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPLI.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPLI.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPLI.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPLI.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPLI.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPLI.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPLI.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPLI.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPLI.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPLI.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPLI.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPLI.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPLI.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPLI.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPLI.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPLI.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPLI.header.fcCT.revision-42',
        'FcCTInId': 'fCGPLI.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPLI.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPLI.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPLI.header.fcCT.options-46',
        'FcCTReserved': 'fCGPLI.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGPLI.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGPLI.header.FCS.maxsize-49',
        'FCSReserved': 'fCGPLI.header.FCS.reserved-50',
        'FCSPlatformName': 'fCGPLI.header.FCS.platformName-51',
        'FcCRCAutoCRC': 'fCGPLI.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGPLI.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGPLI.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPLI, self).__init__(parent, list_op)
