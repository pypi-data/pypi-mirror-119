...
class FCGAPNL(Base):
    ...
    _SDM_NAME = 'fCGAPNL'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGAPNL.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGAPNL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGAPNL.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGAPNL.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGAPNL.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGAPNL.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGAPNL.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGAPNL.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGAPNL.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGAPNL.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGAPNL.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGAPNL.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGAPNL.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGAPNL.header.fcHeader.type-14',
        'FCTLCustom': 'fCGAPNL.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGAPNL.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGAPNL.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGAPNL.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGAPNL.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGAPNL.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGAPNL.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGAPNL.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGAPNL.header.fcCT.revision-42',
        'FcCTInId': 'fCGAPNL.header.fcCT.inId-43',
        'FcCTGsType': 'fCGAPNL.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGAPNL.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGAPNL.header.fcCT.options-46',
        'FcCTReserved': 'fCGAPNL.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGAPNL.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGAPNL.header.FCS.maxsize-49',
        'FCSReserved': 'fCGAPNL.header.FCS.reserved-50',
        'FCSPortName': 'fCGAPNL.header.FCS.portName-51',
        'FcCRCAutoCRC': 'fCGAPNL.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGAPNL.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGAPNL.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGAPNL, self).__init__(parent, list_op)
