...
class FCGMAL(Base):
    ...
    _SDM_NAME = 'fCGMAL'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGMAL.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGMAL.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGMAL.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGMAL.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGMAL.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGMAL.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGMAL.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGMAL.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGMAL.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGMAL.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGMAL.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGMAL.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGMAL.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGMAL.header.fcHeader.type-14',
        'FCTLCustom': 'fCGMAL.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGMAL.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGMAL.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGMAL.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGMAL.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGMAL.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGMAL.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGMAL.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGMAL.header.fcCT.revision-42',
        'FcCTInId': 'fCGMAL.header.fcCT.inId-43',
        'FcCTGsType': 'fCGMAL.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGMAL.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGMAL.header.fcCT.options-46',
        'FcCTReserved': 'fCGMAL.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGMAL.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGMAL.header.FCS.maxsize-49',
        'FCSReserved': 'fCGMAL.header.FCS.reserved-50',
        'FCSInterconnectElementName': 'fCGMAL.header.FCS.interconnectElementName-51',
        'FcCRCAutoCRC': 'fCGMAL.header.fcCRC.autoCRC-52',
        'FcCRCGenerateBadCRC': 'fCGMAL.header.fcCRC.generateBadCRC-53',
        'FcTrailerEof': 'fCGMAL.header.fcTrailer.eof-54',
    }

    def __init__(self, parent, list_op=False):
        super(FCGMAL, self).__init__(parent, list_op)
