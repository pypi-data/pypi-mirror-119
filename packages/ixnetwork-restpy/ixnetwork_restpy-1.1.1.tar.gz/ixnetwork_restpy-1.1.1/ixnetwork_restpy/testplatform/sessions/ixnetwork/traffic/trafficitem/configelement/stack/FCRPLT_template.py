...
class FCRPLT(Base):
    ...
    _SDM_NAME = 'fCRPLT'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCRPLT.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCRPLT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCRPLT.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCRPLT.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCRPLT.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCRPLT.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCRPLT.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCRPLT.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCRPLT.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCRPLT.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCRPLT.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCRPLT.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCRPLT.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCRPLT.header.fcHeader.type-14',
        'FCTLCustom': 'fCRPLT.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCRPLT.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCRPLT.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCRPLT.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCRPLT.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCRPLT.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCRPLT.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCRPLT.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCRPLT.header.fcCT.revision-42',
        'FcCTInId': 'fCRPLT.header.fcCT.inId-43',
        'FcCTGsType': 'fCRPLT.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCRPLT.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCRPLT.header.fcCT.options-46',
        'FcCTReserved': 'fCRPLT.header.fcCT.reserved-47',
        'FCSOpcode': 'fCRPLT.header.FCS.opcode-48',
        'FCSMaxsize': 'fCRPLT.header.FCS.maxsize-49',
        'FCSReserved': 'fCRPLT.header.FCS.reserved-50',
        'FCSPlatformName': 'fCRPLT.header.FCS.platformName-51',
        'FCSPlatformType': 'fCRPLT.header.FCS.platformType-52',
        'FcCRCAutoCRC': 'fCRPLT.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCRPLT.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCRPLT.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCRPLT, self).__init__(parent, list_op)
