...
class FCGPNID(Base):
    ...
    _SDM_NAME = 'fCGPNID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPNID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPNID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPNID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPNID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPNID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPNID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPNID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPNID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPNID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPNID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPNID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPNID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPNID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPNID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPNID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPNID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPNID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPNID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPNID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPNID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPNID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPNID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPNID.header.fcCT.revision-42',
        'FcCTInId': 'fCGPNID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPNID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPNID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPNID.header.fcCT.options-46',
        'FcCTReserved': 'fCGPNID.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGPNID.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGPNID.header.dNS.maxsize-49',
        'DNSReserved': 'fCGPNID.header.dNS.reserved-50',
        'DNSPortId': 'fCGPNID.header.dNS.portId-51',
        'DNSPortName': 'fCGPNID.header.dNS.portName-52',
        'FcCRCAutoCRC': 'fCGPNID.header.fcCRC.autoCRC-53',
        'FcCRCGenerateBadCRC': 'fCGPNID.header.fcCRC.generateBadCRC-54',
        'FcTrailerEof': 'fCGPNID.header.fcTrailer.eof-55',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPNID, self).__init__(parent, list_op)
    ...
    def DNSPortName(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['DNSPortName']))
