...
class FCGPNFT(Base):
    ...
    _SDM_NAME = 'fCGPNFT'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGPNFT.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGPNFT.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGPNFT.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGPNFT.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGPNFT.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGPNFT.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGPNFT.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGPNFT.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGPNFT.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGPNFT.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGPNFT.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGPNFT.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGPNFT.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGPNFT.header.fcHeader.type-14',
        'FCTLCustom': 'fCGPNFT.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGPNFT.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGPNFT.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGPNFT.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGPNFT.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGPNFT.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGPNFT.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGPNFT.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGPNFT.header.fcCT.revision-42',
        'FcCTInId': 'fCGPNFT.header.fcCT.inId-43',
        'FcCTGsType': 'fCGPNFT.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGPNFT.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGPNFT.header.fcCT.options-46',
        'FcCTReserved': 'fCGPNFT.header.fcCT.reserved-47',
        'DNSOpcode': 'fCGPNFT.header.dNS.opcode-48',
        'DNSMaxsize': 'fCGPNFT.header.dNS.maxsize-49',
        'DNSReserved': 'fCGPNFT.header.dNS.reserved-50',
        'DNSFlags': 'fCGPNFT.header.dNS.flags-51',
        'DNSDomainIdScope': 'fCGPNFT.header.dNS.domainIdScope-52',
        'DNSAreaIdScope': 'fCGPNFT.header.dNS.areaIdScope-53',
        'DNSFc4TypeCode': 'fCGPNFT.header.dNS.fc4TypeCode-54',
        'FcCRCAutoCRC': 'fCGPNFT.header.fcCRC.autoCRC-55',
        'FcCRCGenerateBadCRC': 'fCGPNFT.header.fcCRC.generateBadCRC-56',
        'FcTrailerEof': 'fCGPNFT.header.fcTrailer.eof-57',
    }

    def __init__(self, parent, list_op=False):
        super(FCGPNFT, self).__init__(parent, list_op)
    ...
    def DNSDomainIdScope(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['DNSDomainIdScope']))
    ...
    def DNSAreaIdScope(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['DNSAreaIdScope']))
    ...
    def DNSFc4TypeCode(self):
        ...
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['DNSFc4TypeCode']))
