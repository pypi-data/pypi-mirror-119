...
class FCGNID(Base):
    ...
    _SDM_NAME = 'fCGNID'
    _SDM_ATT_MAP = {
        'FcHeaderSof': 'fCGNID.header.fcHeader.sof-1',
        'DeviceDataFramesDeviceDataInfo': 'fCGNID.header.fcHeader.rCTL.deviceDataFrames.deviceDataInfo-2',
        'RCTLReserved': 'fCGNID.header.fcHeader.rCTL.reserved-3',
        'ExtendedLinkServicesInfo': 'fCGNID.header.fcHeader.rCTL.extendedLinkServices.info-4',
        'Fc4LinkDataInfo': 'fCGNID.header.fcHeader.rCTL.fc4LinkData.info-5',
        'VideoDataInfo': 'fCGNID.header.fcHeader.rCTL.videoData.info-6',
        'ExtendedHeaderInfo': 'fCGNID.header.fcHeader.rCTL.extendedHeader.info-7',
        'BasicLinkServicesInfo': 'fCGNID.header.fcHeader.rCTL.basicLinkServices.info-8',
        'LinkControlFramesInfo': 'fCGNID.header.fcHeader.rCTL.linkControlFrames.info-9',
        'ExtendedRoutingInfo': 'fCGNID.header.fcHeader.rCTL.extendedRouting.info-10',
        'FcHeaderDstId': 'fCGNID.header.fcHeader.dstId-11',
        'FcHeaderCsCTLPriority': 'fCGNID.header.fcHeader.csCTLPriority-12',
        'FcHeaderSrcId': 'fCGNID.header.fcHeader.srcId-13',
        'FcHeaderType': 'fCGNID.header.fcHeader.type-14',
        'FCTLCustom': 'fCGNID.header.fcHeader.fCTL.custom-15',
        'BuildFCTLExchangeContext': 'fCGNID.header.fcHeader.fCTL.buildFCTL.exchangeContext-16',
        'BuildFCTLSequenceContext': 'fCGNID.header.fcHeader.fCTL.buildFCTL.sequenceContext-17',
        'BuildFCTLFirstSequence': 'fCGNID.header.fcHeader.fCTL.buildFCTL.firstSequence-18',
        'BuildFCTLLastSequence': 'fCGNID.header.fcHeader.fCTL.buildFCTL.lastSequence-19',
        'BuildFCTLEndSequence': 'fCGNID.header.fcHeader.fCTL.buildFCTL.endSequence-20',
        'BuildFCTLEndConnection': 'fCGNID.header.fcHeader.fCTL.buildFCTL.endConnection-21',
        'BuildFCTLCsCTLPriority': 'fCGNID.header.fcHeader.fCTL.buildFCTL.csCTLPriority-22',
        'BuildFCTLSequenceInitiative': 'fCGNID.header.fcHeader.fCTL.buildFCTL.sequenceInitiative-23',
        'BuildFCTLFcXIDReassigned': 'fCGNID.header.fcHeader.fCTL.buildFCTL.fcXIDReassigned-24',
        'BuildFCTLFcInvalidateXID': 'fCGNID.header.fcHeader.fCTL.buildFCTL.fcInvalidateXID-25',
        'BuildFCTLAckForm': 'fCGNID.header.fcHeader.fCTL.buildFCTL.ackForm-26',
        'BuildFCTLFcDataCompression': 'fCGNID.header.fcHeader.fCTL.buildFCTL.fcDataCompression-27',
        'BuildFCTLFcDataEncryption': 'fCGNID.header.fcHeader.fCTL.buildFCTL.fcDataEncryption-28',
        'BuildFCTLRetransmittedSequence': 'fCGNID.header.fcHeader.fCTL.buildFCTL.retransmittedSequence-29',
        'BuildFCTLUnidirectionalTransmit': 'fCGNID.header.fcHeader.fCTL.buildFCTL.unidirectionalTransmit-30',
        'BuildFCTLContinueSeqCondition': 'fCGNID.header.fcHeader.fCTL.buildFCTL.continueSeqCondition-31',
        'BuildFCTLAbortSeqCondition': 'fCGNID.header.fcHeader.fCTL.buildFCTL.abortSeqCondition-32',
        'BuildFCTLRelativeOffsetPresent': 'fCGNID.header.fcHeader.fCTL.buildFCTL.relativeOffsetPresent-33',
        'BuildFCTLExchangeReassembly': 'fCGNID.header.fcHeader.fCTL.buildFCTL.exchangeReassembly-34',
        'BuildFCTLFillBytes': 'fCGNID.header.fcHeader.fCTL.buildFCTL.fillBytes-35',
        'FcHeaderSeqID': 'fCGNID.header.fcHeader.seqID-36',
        'FcHeaderDfCTL': 'fCGNID.header.fcHeader.dfCTL-37',
        'FcHeaderSeqCNT': 'fCGNID.header.fcHeader.seqCNT-38',
        'FcHeaderOxID': 'fCGNID.header.fcHeader.oxID-39',
        'FcHeaderRxID': 'fCGNID.header.fcHeader.rxID-40',
        'FcHeaderParameter': 'fCGNID.header.fcHeader.parameter-41',
        'FcCTRevision': 'fCGNID.header.fcCT.revision-42',
        'FcCTInId': 'fCGNID.header.fcCT.inId-43',
        'FcCTGsType': 'fCGNID.header.fcCT.gsType-44',
        'FcCTGsSubtype': 'fCGNID.header.fcCT.gsSubtype-45',
        'FcCTOptions': 'fCGNID.header.fcCT.options-46',
        'FcCTReserved': 'fCGNID.header.fcCT.reserved-47',
        'FCSOpcode': 'fCGNID.header.FCS.opcode-48',
        'FCSMaxsize': 'fCGNID.header.FCS.maxsize-49',
        'FCSReserved': 'fCGNID.header.FCS.reserved-50',
        'FCSPlatformNodeName': 'fCGNID.header.FCS.platformNodeName-51',
        'FCSNodeIdentificationDataFormat': 'fCGNID.header.FCS.nodeIdentificationDataFormat-52',
        'FCSReserved2': 'fCGNID.header.FCS.reserved2-53',
        'FcCRCAutoCRC': 'fCGNID.header.fcCRC.autoCRC-54',
        'FcCRCGenerateBadCRC': 'fCGNID.header.fcCRC.generateBadCRC-55',
        'FcTrailerEof': 'fCGNID.header.fcTrailer.eof-56',
    }

    def __init__(self, parent, list_op=False):
        super(FCGNID, self).__init__(parent, list_op)
    ...
    @property
    def FCSPlatformNodeName(self):
        """
        Display Name: Platform Node Name
        Default Value: 0x00
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FCSPlatformNodeName']))

    @property
    def FCSNodeIdentificationDataFormat(self):
        """
        Display Name: Node Identification Data Format
        Default Value: 0x00
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FCSNodeIdentificationDataFormat']))

    @property
    def FCSReserved2(self):
        """
        Display Name: Reserved
        Default Value: 0x00
        Value Format: hex
        """
        from ixnetwork_restpy.multivalue import Multivalue
        return Multivalue(self, self._get_attribute(self._SDM_ATT_MAP['FCSReserved2']))
