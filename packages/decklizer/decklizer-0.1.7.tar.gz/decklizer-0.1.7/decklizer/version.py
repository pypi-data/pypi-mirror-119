...
description = "Decklizer"
# Long description will go up on the pypi page
long_description = """
License
=======
``decklizer`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/wesleybeckner/decklizer"
DOWNLOAD_URL = ""
LICENSE = "MIT"
...
VERSION = __version__
PACKAGE_DATA = {'decklizer': [pjoin('data', '*')]}
