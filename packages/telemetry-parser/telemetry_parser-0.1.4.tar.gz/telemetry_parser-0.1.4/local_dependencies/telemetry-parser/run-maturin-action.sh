...
curl -L https://github.com/PyO3/maturin/releases/download/v0.11.3/maturin-x86_64-unknown-linux-musl.tar.gz | tar -xz -C /usr/local/bin
maturin --version
echo "::endgroup::"
...
echo "::endgroup::"
maturin build -m bin/python-module/Cargo.toml --release --target i686-unknown-linux-gnu