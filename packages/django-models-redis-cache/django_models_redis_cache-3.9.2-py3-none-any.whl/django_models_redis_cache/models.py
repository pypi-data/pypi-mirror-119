...
class RedisQuerySet(django_models.query.QuerySet):
    ...
    def update(self, **kwargs):
        ...
        concrete_model = list(self.model._meta.concrete_model)[0]
        print('update', concrete_model, concrete_model.id)
    ...
    def create(self, **kwargs):
        ...
        create_result = list(create_result)[0]
        print('create', concrete_model, create_result.id)
        existing_fields = {}
        redis_root = get_redis_root()
