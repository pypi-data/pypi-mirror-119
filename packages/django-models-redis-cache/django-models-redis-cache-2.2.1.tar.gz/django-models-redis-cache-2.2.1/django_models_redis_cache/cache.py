    ...
    #     )
        ...
        for redis_field_name, redis_field_value in django_params.items():
            ...
            if django_instance_fields_value.__class__ == datetime.datetime:
                ...
                print(django_instance_fields_value.isoformat(), redis_field_value.replace(microsecond=0).replace(tzinfo=None).isoformat())
                if django_instance_fields_value.isoformat() != redis_field_value.replace(microsecond=0).replace(tzinfo=None).isoformat():
