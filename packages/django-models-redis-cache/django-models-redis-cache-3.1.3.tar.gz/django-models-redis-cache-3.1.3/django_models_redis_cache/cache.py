    ...
    async def run_django_to_cache(
        ...
        if django_instances:
            ...
            for django_instance in django_instances:
                await update_or_create_redis_instance_from_django_instance(
                    redis_root,
                    django_instance,
                    django_fields,
                    all_redis_instances,
...
async def update_or_create_redis_instance_from_django_instance(
    ...
    print(django_instance_model, django_instance.id)
...
async def get_or_create_redis_instance_from_django_instance(
    ...
    django_instance_model = django_instance.__class__
    print('Foreign', django_instance_model, django_instance.id)

    print(not redis_instance)
