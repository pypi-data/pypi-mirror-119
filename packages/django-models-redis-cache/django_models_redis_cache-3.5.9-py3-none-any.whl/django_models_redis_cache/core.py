...
from .cache import default_cache_func, django_sync_to_async_list, django_sync_to_async_get
...
class RedisRoot:
    ...
    def _get_allowed_redis_model_params(self, params, redis_model):
        redis_model_fields_names = redis_model.__model_data__.keys()
        result_params = list(filter(lambda param_name: param_name in redis_model_fields_names, params.keys()))
