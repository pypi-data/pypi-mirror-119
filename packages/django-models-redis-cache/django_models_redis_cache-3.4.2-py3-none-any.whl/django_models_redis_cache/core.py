...
from .cache import default_cache_func, django_sync_to_async_list
...
class RedisRoot:
    ...
    def django_to_cache(
        ...
        for django_model, cache_conf in self.registered_django_models.items():
    ...
    def update(self, django_model, instanes=None, return_dict=False, renew_ttl=False, new_ttl=None,
               **fields_to_update):
