...
class RedisRoot:
    ...
    def __init__(
        ...
        self.redis_instance.set(f'{self.prefix}:_paused', 'null')
    ...
    def set_pause(self, paused=False):
        self.redis_instance.set(f'{self.prefix}:_paused', int(bool(paused)))

    @property
    def is_paused(self):
        raw_paused = self.redis_instance.get(f'{self.prefix}:_paused')
        paused = bool(int(raw_paused))
        return paused
