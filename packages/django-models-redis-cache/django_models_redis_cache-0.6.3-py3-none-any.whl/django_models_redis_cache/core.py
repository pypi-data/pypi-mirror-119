    ...
    def check_cache(self):
        ...
        for django_model, cache_conf in django_models_to_cache.items():
            ...
            def get_or_create_redis_model_from_django_model(django_model, redis_root):
                ...
                for model in redis_root.registered_models:
                    print()
                    print(model)
                    print(model.__model_data__['fields'])
            ...
            def create_redis_model_from_redis_fields(redis_fields, redis_root):
                ...
                print(new_redis_model, new_redis_model.__class__.__name__)
...
class RedisModel:
    ...
    def _renew_fields(self):
        ...
        print(self, self.__class__.__name__, fields)
