...
def sync_to_async_update_or_create_django_instance_from_redis_instance(
    ...
    #     )
        ...
        for redis_field_name, redis_field_value in django_params.items():
            ...
            if django_instance_fields_value.__class__ == django_models.DateTimeField:
                if django_instance_fields_value.isoformat() != redis_field_value.isoformat():
                    changed_fields_to_update[redis_field_name] = redis_field_value
            elif django_instance_fields_value != redis_field_value:
                print(django_instance_fields_value, redis_field_value, type(django_instance_fields_value), type(redis_field_value))
                changed_fields_to_update[redis_field_name] = redis_field_value
