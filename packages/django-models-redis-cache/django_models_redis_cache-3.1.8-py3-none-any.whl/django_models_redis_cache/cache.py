    ...
    async def run_django_to_cache(
        ...
        if django_instances:
            ...
            for django_instance in django_instances:
                print('run_django_to_cache', getsizeof(run_django_to_cache))
                async_tasks.append(
...
async def update_or_create_redis_instance_from_django_instance(
    ...
    print(redis_root, getsizeof(redis_root))
    print('django_fields', getsizeof(django_fields))
    print('update_or_create_redis_instance_from_django_instance', getsizeof(update_or_create_redis_instance_from_django_instance))
