...
def django_instance_field_to_redis_value(
    ...
    elif django_field.__class__.__name__.endswith('File'):
        try:
            redis_value = django_field_value.path
        except:
            print(django_field.__class__.__name__, django_field_value.__dict__)
    else:
        print(django_field, django_field.__class__.__name__)
    return redis_value
