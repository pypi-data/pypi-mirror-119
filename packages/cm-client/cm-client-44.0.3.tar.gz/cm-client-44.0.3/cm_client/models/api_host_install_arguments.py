...
class ApiHostInstallArguments(object):
    ...
    def __init__(self, host_names=None, ssh_port=None, user_name=None, password=None, private_key=None, passphrase=None, parallel_install_count=None, cm_repo_url=None, gpg_key_custom_url=None, java_install_strategy=None, unlimited_jce=None, gpg_key_override_bundle=None, agent_reported_hostnames=None, subject_alt_names=None):
        ...
        self._agent_reported_hostnames = None
        ...
        if agent_reported_hostnames is not None:
          self.agent_reported_hostnames = agent_reported_hostnames
    ...
    @property
    def agent_reported_hostnames(self):
        """
        Gets the agent_reported_hostnames of this ApiHostInstallArguments.
        Optional. A map from hostname to reported_hostname value to be set in the agent configuration file.

        :return: The agent_reported_hostnames of this ApiHostInstallArguments.
        :rtype: list[ApiMapEntry]
        """
        return self._agent_reported_hostnames

    @agent_reported_hostnames.setter
    def agent_reported_hostnames(self, agent_reported_hostnames):
        """
        Sets the agent_reported_hostnames of this ApiHostInstallArguments.
        Optional. A map from hostname to reported_hostname value to be set in the agent configuration file.

        :param agent_reported_hostnames: The agent_reported_hostnames of this ApiHostInstallArguments.
        :type: list[ApiMapEntry]
        """

        self._agent_reported_hostnames = agent_reported_hostnames

    @property
    def subject_alt_names(self):
        """
        Gets the subject_alt_names of this ApiHostInstallArguments.
        

        :return: The subject_alt_names of this ApiHostInstallArguments.
        :rtype: list[str]
        """
    ...
    def subject_alt_names(self, subject_alt_names):
        """
        Sets the subject_alt_names of this ApiHostInstallArguments.
        

        :param subject_alt_names: The subject_alt_names of this ApiHostInstallArguments.
        :type: list[str]
        """
