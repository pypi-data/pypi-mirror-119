...
class ApiImpalaQueryDetailsResponse(object):
    """
    ...
    def __init__(self, details=None):
        """
        ApiImpalaQueryDetailsResponse - a model defined in Swagger
        """
    ...
    def details(self):
        """
        Gets the details of this ApiImpalaQueryDetailsResponse.
        ...
        :return: The details of this ApiImpalaQueryDetailsResponse.
        :rtype: str
        """
    ...
    def details(self, details):
        """
        Sets the details of this ApiImpalaQueryDetailsResponse.
        The details for this query. Two formats are supported: <ul> <li> 'text': this is a text based, human readable representation of the Impala runtime profile. </li> <li> 'thrift_encoded': this a compact-thrift, base64 encoded representation of the impala RuntimeProfile.thrift object. See the Impala documentation for more details. </li> </ul>

        :param details: The details of this ApiImpalaQueryDetailsResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiImpalaQueryDetailsResponse):
            return False
