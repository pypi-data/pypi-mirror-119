...
class ApiReplicationCommand(object):
    ...
    swagger_types = {
        ...
        'hive_on_tez_result': 'ApiHiveOnTezReplicationResult',
        'hbase_info': 'ApiHBaseReplicationInfo'
    }
    ...
    attribute_map = {
        ...
        'hive_on_tez_result': 'hiveOnTezResult',
        'hbase_info': 'hbaseInfo'
    }

    def __init__(self, id=None, name=None, start_time=None, end_time=None, active=None, success=None, result_message=None, result_data_url=None, cluster_ref=None, service_ref=None, role_ref=None, host_ref=None, parent=None, children=None, can_retry=None, hdfs_result=None, hive_result=None, hive_on_tez_result=None, hbase_info=None):
        """
        ...
        self._hive_on_tez_result = None
        self._hbase_info = None
        ...
        if hive_on_tez_result is not None:
          self.hive_on_tez_result = hive_on_tez_result
        if hbase_info is not None:
          self.hbase_info = hbase_info
    ...
    @property
    def hive_on_tez_result(self):
        """
        Gets the hive_on_tez_result of this ApiReplicationCommand.
        Results for replication commands on HiveOnTez services.

        :return: The hive_on_tez_result of this ApiReplicationCommand.
        :rtype: ApiHiveOnTezReplicationResult
        """
        return self._hive_on_tez_result

    @hive_on_tez_result.setter
    def hive_on_tez_result(self, hive_on_tez_result):
        """
        Sets the hive_on_tez_result of this ApiReplicationCommand.
        Results for replication commands on HiveOnTez services.

        :param hive_on_tez_result: The hive_on_tez_result of this ApiReplicationCommand.
        :type: ApiHiveOnTezReplicationResult
        """

        self._hive_on_tez_result = hive_on_tez_result

    @property
    def hbase_info(self):
        """
        Gets the hbase_info of this ApiReplicationCommand.
        

        :return: The hbase_info of this ApiReplicationCommand.
        :rtype: ApiHBaseReplicationInfo
        """
        return self._hbase_info

    @hbase_info.setter
    def hbase_info(self, hbase_info):
        """
        Sets the hbase_info of this ApiReplicationCommand.
        

        :param hbase_info: The hbase_info of this ApiReplicationCommand.
        :type: ApiHBaseReplicationInfo
        """

        self._hbase_info = hbase_info
