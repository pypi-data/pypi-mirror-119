...
class ApiHive3ReplicationMetricsStatus(object):
    """
    ...
    def __init__(self):
        """
        ApiHive3ReplicationMetricsStatus - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiHive3ReplicationMetricsStatus):
            return False
