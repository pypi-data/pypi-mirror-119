...
class ApiUser2Ref(object):
    ...
    def __init__(self, name=None):
        """
        ApiUser2Ref - a model defined in Swagger
        """
    ...
    def name(self, name):
        """
        Sets the name of this ApiUser2Ref.
        The name of the user, which uniquely identifies it in a CM installation.

        :param name: The name of this ApiUser2Ref.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiUser2Ref):
            return False
