...
class ApiAudit(object):
    ...
    def __init__(self, timestamp=None, service=None, username=None, impersonator=None, ip_address=None, command=None, resource=None, operation_text=None, allowed=None, service_values=None):
        """
    ...
    def service_values(self):
        """
        Gets the service_values of this ApiAudit.
        

        :return: The service_values of this ApiAudit.
        :rtype: dict(str, str)
        """
        return self._service_values

    @service_values.setter
    def service_values(self, service_values):
        """
        Sets the service_values of this ApiAudit.
        

        :param service_values: The service_values of this ApiAudit.
        :type: dict(str, str)
        """
