...
class ApiYarnKillResponse(object):
    """
    ...
    def __init__(self, warning=None):
        """
        ApiYarnKillResponse - a model defined in Swagger
        """
    ...
    def warning(self):
        """
        Gets the warning of this ApiYarnKillResponse.
        ...
        :return: The warning of this ApiYarnKillResponse.
        :rtype: str
        """
    ...
    def warning(self, warning):
        """
        Sets the warning of this ApiYarnKillResponse.
        The warning, if any, from the call. We will return a warning if the caller attempts to cancel an application that has already completed.

        :param warning: The warning of this ApiYarnKillResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiYarnKillResponse):
            return False
