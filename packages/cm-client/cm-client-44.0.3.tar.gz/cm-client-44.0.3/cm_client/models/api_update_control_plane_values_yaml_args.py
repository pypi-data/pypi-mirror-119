...
class ApiUpdateControlPlaneValuesYamlArgs(object):
    """
    ...
    def __init__(self, kube_config=None, remote_repo_url=None):
        """
        ApiUpdateControlPlaneValuesYamlArgs - a model defined in Swagger
        """
    ...
    def kube_config(self):
        """
        Gets the kube_config of this ApiUpdateControlPlaneValuesYamlArgs.
        ...
        :return: The kube_config of this ApiUpdateControlPlaneValuesYamlArgs.
        :rtype: str
        """
    ...
    def kube_config(self, kube_config):
        """
        Sets the kube_config of this ApiUpdateControlPlaneValuesYamlArgs.
        The content of the kubeconfig file of the kubernetes environment on which the control plane is running Simplified example:<br> <br> apiVersion: v1<br> clusters:<br> - cluster:<br> &emsp;&emsp;certificate-authority-data: abc123<br> &emsp;&emsp;server: https://example-server.domain.com:6443<br> &emsp;name: example-cluster.domain.com:6443<br> contexts:<br> - context:<br> &emsp;&emsp;cluster: ocp-cluster1<br> &emsp;&emsp;user: admin<br> &emsp;name: admin<br> current-context: admin<br> kind: Config<br> preferences: {}<br> users:<br> - name: admin<br> &emsp;user:<br> &emsp;&emsp;client-certificate-data: abc123<br> &emsp;&emsp;client-key-data: xyz987<br> <br> For more information on the kubeconfig file, read the documentation <a target=\"_blank\" href=http://tiny.cloudera.com/cdp-pvc.kubernetes>here</a>.

        :param kube_config: The kube_config of this ApiUpdateControlPlaneValuesYamlArgs.
        :type: str
        """
    ...
    def remote_repo_url(self):
        """
        Gets the remote_repo_url of this ApiUpdateControlPlaneValuesYamlArgs.
        The url of the remote repository where the private cloud artifacts are hosted.

        :return: The remote_repo_url of this ApiUpdateControlPlaneValuesYamlArgs.
        :rtype: str
        """
    ...
    def remote_repo_url(self, remote_repo_url):
        """
        Sets the remote_repo_url of this ApiUpdateControlPlaneValuesYamlArgs.
        The url of the remote repository where the private cloud artifacts are hosted.

        :param remote_repo_url: The remote_repo_url of this ApiUpdateControlPlaneValuesYamlArgs.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiUpdateControlPlaneValuesYamlArgs):
            return False
