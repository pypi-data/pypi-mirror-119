...
class ApiRollingUpgradeClusterArgs(object):
    """
    ...
    def __init__(self, slave_batch_size=None, sleep_seconds=None, slave_fail_count_threshold=None):
        """
        ApiRollingUpgradeClusterArgs - a model defined in Swagger
        """
    ...
    def slave_batch_size(self):
        """
        Gets the slave_batch_size of this ApiRollingUpgradeClusterArgs.
        ...
        :return: The slave_batch_size of this ApiRollingUpgradeClusterArgs.
        :rtype: int
        """
    ...
    def slave_batch_size(self, slave_batch_size):
        """
        Sets the slave_batch_size of this ApiRollingUpgradeClusterArgs.
        Number of slave roles to restart at a time. Must be greater than zero. Default is 1.  Please note that for HDFS, this number should be less than the replication factor (default 3) to ensure data availability during rolling restart.

        :param slave_batch_size: The slave_batch_size of this ApiRollingUpgradeClusterArgs.
        :type: int
        """
    ...
    def sleep_seconds(self):
        """
        Gets the sleep_seconds of this ApiRollingUpgradeClusterArgs.
        Number of seconds to sleep between restarts of slave role batches.  Must be greater than or equal to 0. Default is 0.

        :return: The sleep_seconds of this ApiRollingUpgradeClusterArgs.
        :rtype: int
        """
    ...
    def sleep_seconds(self, sleep_seconds):
        """
        Sets the sleep_seconds of this ApiRollingUpgradeClusterArgs.
        Number of seconds to sleep between restarts of slave role batches.  Must be greater than or equal to 0. Default is 0.

        :param sleep_seconds: The sleep_seconds of this ApiRollingUpgradeClusterArgs.
        :type: int
        """
    ...
    def slave_fail_count_threshold(self):
        """
        Gets the slave_fail_count_threshold of this ApiRollingUpgradeClusterArgs.
        ...
        :return: The slave_fail_count_threshold of this ApiRollingUpgradeClusterArgs.
        :rtype: int
        """
    ...
    def slave_fail_count_threshold(self, slave_fail_count_threshold):
        """
        Sets the slave_fail_count_threshold of this ApiRollingUpgradeClusterArgs.
        The threshold for number of slave batches that are allowed to fail to restart before the entire command is considered failed.  Must be greather than or equal to 0. Default is 0. <p> This argument is for ADVANCED users only. </p>

        :param slave_fail_count_threshold: The slave_fail_count_threshold of this ApiRollingUpgradeClusterArgs.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiRollingUpgradeClusterArgs):
            return False
