...
class ApiServiceList(object):
    ...
    def __init__(self, items=None):
        """
        ApiServiceList - a model defined in Swagger
        """
    ...
    def items(self):
        """
        Gets the items of this ApiServiceList.
        

        :return: The items of this ApiServiceList.
    ...
    def items(self, items):
        """
        Sets the items of this ApiServiceList.
        

        :param items: The items of this ApiServiceList.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiServiceList):
            return False
