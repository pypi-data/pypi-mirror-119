...
class ApiUpgradeControlPlaneArgs(object):
    """
    ...
    def __init__(self, kube_config=None, values_yaml=None, remote_repo_url=None):
        """
        ApiUpgradeControlPlaneArgs - a model defined in Swagger
        """
    ...
    def kube_config(self):
        """
        Gets the kube_config of this ApiUpgradeControlPlaneArgs.
        ...
        :return: The kube_config of this ApiUpgradeControlPlaneArgs.
        :rtype: str
        """
    ...
    def kube_config(self, kube_config):
        """
        Sets the kube_config of this ApiUpgradeControlPlaneArgs.
        The content of the kubeconfig file of the kubernetes environment on which the control plane is running Simplified example:<br> <br> apiVersion: v1<br> clusters:<br> - cluster:<br> &emsp;&emsp;certificate-authority-data: abc123<br> &emsp;&emsp;server: https://example-server.domain.com:6443<br> &emsp;name: example-cluster.domain.com:6443<br> contexts:<br> - context:<br> &emsp;&emsp;cluster: ocp-cluster1<br> &emsp;&emsp;user: admin<br> &emsp;name: admin<br> current-context: admin<br> kind: Config<br> preferences: {}<br> users:<br> - name: admin<br> &emsp;user:<br> &emsp;&emsp;client-certificate-data: abc123<br> &emsp;&emsp;client-key-data: xyz987<br> <br> For more information on the kubeconfig file, read the documentation <a target=\"_blank\" href=http://tiny.cloudera.com/cdp-pvc.kubernetes>here</a>.

        :param kube_config: The kube_config of this ApiUpgradeControlPlaneArgs.
        :type: str
        """
    ...
    def values_yaml(self):
        """
        Gets the values_yaml of this ApiUpgradeControlPlaneArgs.
        To see sample values.yaml files, read the documentation <a target=\"_blank\" href=http://tiny.cloudera.com/cdp-pvc.upgrade-values-yaml>here</a>.

        :return: The values_yaml of this ApiUpgradeControlPlaneArgs.
        :rtype: str
        """
    ...
    def values_yaml(self, values_yaml):
        """
        Sets the values_yaml of this ApiUpgradeControlPlaneArgs.
        To see sample values.yaml files, read the documentation <a target=\"_blank\" href=http://tiny.cloudera.com/cdp-pvc.upgrade-values-yaml>here</a>.

        :param values_yaml: The values_yaml of this ApiUpgradeControlPlaneArgs.
        :type: str
        """
    ...
    def remote_repo_url(self):
        """
        Gets the remote_repo_url of this ApiUpgradeControlPlaneArgs.
        The url of the remote repository where the private cloud artifacts for the target version of the upgrade are hosted

        :return: The remote_repo_url of this ApiUpgradeControlPlaneArgs.
        :rtype: str
        """
    ...
    def remote_repo_url(self, remote_repo_url):
        """
        Sets the remote_repo_url of this ApiUpgradeControlPlaneArgs.
        The url of the remote repository where the private cloud artifacts for the target version of the upgrade are hosted

        :param remote_repo_url: The remote_repo_url of this ApiUpgradeControlPlaneArgs.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiUpgradeControlPlaneArgs):
            return False
