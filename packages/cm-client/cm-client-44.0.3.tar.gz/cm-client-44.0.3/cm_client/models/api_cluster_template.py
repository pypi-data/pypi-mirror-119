...
class ApiClusterTemplate(object):
    ...
    def __init__(self, cdh_version=None, experience_version=None, products=None, services=None, host_templates=None, display_name=None, cm_version=None, instantiator=None, repositories=None, cluster_spec=None, tags=None):
        """
        ApiClusterTemplate - a model defined in Swagger
        """

        self._cdh_version = None
        self._experience_version = None
        self._products = None
        self._services = None
        ...
        if experience_version is not None:
    ...
    def experience_version(self):
        """
        Gets the experience_version of this ApiClusterTemplate.
        Experience version

        :return: The experience_version of this ApiClusterTemplate.
        :rtype: str
        """
        return self._experience_version

    @experience_version.setter
    def experience_version(self, experience_version):
        """
        Sets the experience_version of this ApiClusterTemplate.
        Experience version

        :param experience_version: The experience_version of this ApiClusterTemplate.
        :type: str
        """
