...
class ApiCertificateRequest(object):
    ...
    def __init__(self, hostname=None, csr=None, token=None, subject_alt_names=None):
        """
    ...
    def subject_alt_names(self):
        """
        Gets the subject_alt_names of this ApiCertificateRequest.
        

        :return: The subject_alt_names of this ApiCertificateRequest.
        :rtype: list[str]
        """
    ...
    def subject_alt_names(self, subject_alt_names):
        """
        Sets the subject_alt_names of this ApiCertificateRequest.
        

        :param subject_alt_names: The subject_alt_names of this ApiCertificateRequest.
        :type: list[str]
        """
