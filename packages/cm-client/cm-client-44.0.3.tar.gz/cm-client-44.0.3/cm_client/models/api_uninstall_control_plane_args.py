...
class ApiUninstallControlPlaneArgs(object):
    ...
    def __init__(self, kube_config=None, values_yaml=None):
        """
    ...
    def values_yaml(self):
        """
        Gets the values_yaml of this ApiUninstallControlPlaneArgs.
        Currently, we only support the following content in the values.yaml: other: forceCleanup: true|false

        :return: The values_yaml of this ApiUninstallControlPlaneArgs.
        :rtype: str
        """
    ...
    def values_yaml(self, values_yaml):
        """
        Sets the values_yaml of this ApiUninstallControlPlaneArgs.
        Currently, we only support the following content in the values.yaml: other: forceCleanup: true|false

        :param values_yaml: The values_yaml of this ApiUninstallControlPlaneArgs.
        :type: str
        """
