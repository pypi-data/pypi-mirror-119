...
class ApiRollEditsArgs(object):
    ...
    def __init__(self, nameservice=None):
        """
        ApiRollEditsArgs - a model defined in Swagger
        """
    ...
    def nameservice(self):
        """
        Gets the nameservice of this ApiRollEditsArgs.
        Nameservice whose edits need to be rolled. Required only if HDFS service is federated.

        :return: The nameservice of this ApiRollEditsArgs.
        :rtype: str
        """
    ...
    def nameservice(self, nameservice):
        """
        Sets the nameservice of this ApiRollEditsArgs.
        Nameservice whose edits need to be rolled. Required only if HDFS service is federated.

        :param nameservice: The nameservice of this ApiRollEditsArgs.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ApiRollEditsArgs):
            return False
