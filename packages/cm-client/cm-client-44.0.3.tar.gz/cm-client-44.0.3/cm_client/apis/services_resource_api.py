...
class ServicesResourceApi(object):
    ...
    def create_hdfs_file_with_http_info(self, cluster_name, service_name, **kwargs):
        ...
        all_params = ['cluster_name', 'service_name', 'overwrite', 'path', 'body']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def export_sentry_permissions_command(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.export_sentry_permissions_command(cluster_name, service_name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.export_sentry_permissions_command_with_http_info(cluster_name, service_name, **kwargs)
        else:
            (data) = self.export_sentry_permissions_command_with_http_info(cluster_name, service_name, **kwargs)
            return data

    def export_sentry_permissions_command_with_http_info(self, cluster_name, service_name, **kwargs):
        """
        Export Sentry Permissions.
        Export Sentry Permissions.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.export_sentry_permissions_command_with_http_info(cluster_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method export_sentry_permissions_command" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `export_sentry_permissions_command`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `export_sentry_permissions_command`")
        ...
        return self.api_client.call_api('/clusters/{clusterName}/services/{serviceName}/commands/exportSentryPermissions', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def hbase_replication_first_time_setup_automatic(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_automatic(cluster_name, service_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_name:  (required)
        :param str service_name: The local HBase service name (required)
        :param ApiHBaseReplicationSetupCommandArgs body: Replication setup parameters such as the source peer, source service, and passphrase for the keystore
        :return: ApiCommand
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hbase_replication_first_time_setup_automatic_with_http_info(cluster_name, service_name, **kwargs)
        else:
            (data) = self.hbase_replication_first_time_setup_automatic_with_http_info(cluster_name, service_name, **kwargs)
            return data

    def hbase_replication_first_time_setup_automatic_with_http_info(self, cluster_name, service_name, **kwargs):
        """
        Starts an automatic HBase replication first time setup.
        Starts an automatic HBase replication first time setup. After doing some configuration (see #hbaseReplicationSetup(String, boolean, ApiHBaseReplicationSetupCommandArgs)), it restarts both the source and target clusters.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_automatic_with_http_info(cluster_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hbase_replication_first_time_setup_automatic" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `hbase_replication_first_time_setup_automatic`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `hbase_replication_first_time_setup_automatic`")
        ...
        return self.api_client.call_api('/clusters/{clusterName}/services/{serviceName}/commands/hbaseReplicationFirstTimeSetupAutomatic', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def hbase_replication_first_time_setup_force_ready(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_force_ready(cluster_name, service_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_name:  (required)
        :param str service_name: The local HBase service name (required)
        :param ApiServiceRef body: contains the source peer, source cluster, source sourceService
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hbase_replication_first_time_setup_force_ready_with_http_info(cluster_name, service_name, **kwargs)
        else:
            (data) = self.hbase_replication_first_time_setup_force_ready_with_http_info(cluster_name, service_name, **kwargs)
            return data

    def hbase_replication_first_time_setup_force_ready_with_http_info(self, cluster_name, service_name, **kwargs):
        """
        Force sets the HBase replication first time setup status to be READY for the given source and target.
        Force sets the HBase replication first time setup status to be READY for the given source and target. Note that after this operation, the pending HBase replication policies, which have the waitForHBaseReplicationSetup flag set to true, will NOT be completed.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_force_ready_with_http_info(cluster_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hbase_replication_first_time_setup_force_ready" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `hbase_replication_first_time_setup_force_ready`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `hbase_replication_first_time_setup_force_ready`")
        ...
        return self.api_client.call_api('/clusters/{clusterName}/services/{serviceName}/commands/hbaseReplicationFirstTimeSetupForceReady', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def hbase_replication_first_time_setup_manual(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_manual(cluster_name, service_name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hbase_replication_first_time_setup_manual_with_http_info(cluster_name, service_name, **kwargs)
        else:
            (data) = self.hbase_replication_first_time_setup_manual_with_http_info(cluster_name, service_name, **kwargs)
            return data

    def hbase_replication_first_time_setup_manual_with_http_info(self, cluster_name, service_name, **kwargs):
        """
        Starts a manual HBase replication first time setup.
        Starts a manual HBase replication first time setup. After doing some configuration (see #hbaseReplicationSetup(String, boolean, ApiHBaseReplicationSetupCommandArgs)), it restarts the target cluster only. Source cluster has to be restarted manually, after which the #hbaseReplicationFirstTimeSetupManualContinue(String, ApiServiceRef) API endpoint should be called to finish the HBase replication first time setup.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_manual_with_http_info(cluster_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hbase_replication_first_time_setup_manual" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `hbase_replication_first_time_setup_manual`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `hbase_replication_first_time_setup_manual`")
        ...
        return self.api_client.call_api('/clusters/{clusterName}/services/{serviceName}/commands/hbaseReplicationFirstTimeSetupManual', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def hbase_replication_first_time_setup_manual_continue(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_manual_continue(cluster_name, service_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_name:  (required)
        :param str service_name: The local HBase service name (required)
        :param ApiServiceRef body: contains the source peer, source cluster, source service
        :return: ApiCommand
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hbase_replication_first_time_setup_manual_continue_with_http_info(cluster_name, service_name, **kwargs)
        else:
            (data) = self.hbase_replication_first_time_setup_manual_continue_with_http_info(cluster_name, service_name, **kwargs)
            return data

    def hbase_replication_first_time_setup_manual_continue_with_http_info(self, cluster_name, service_name, **kwargs):
        """
        Should be called after #hbaseReplicationFirstTimeSetupManual(String, ApiHBaseReplicationSetupCommandArgs) to finish the manual HBase replication first time setup.
        Should be called after #hbaseReplicationFirstTimeSetupManual(String, ApiHBaseReplicationSetupCommandArgs) to finish the manual HBase replication first time setup.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_manual_continue_with_http_info(cluster_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hbase_replication_first_time_setup_manual_continue" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `hbase_replication_first_time_setup_manual_continue`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `hbase_replication_first_time_setup_manual_continue`")
        ...
        return self.api_client.call_api('/clusters/{clusterName}/services/{serviceName}/commands/hbaseReplicationFirstTimeSetupManualContinue', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def hbase_replication_first_time_setup_reset(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_reset(cluster_name, service_name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hbase_replication_first_time_setup_reset_with_http_info(cluster_name, service_name, **kwargs)
        else:
            (data) = self.hbase_replication_first_time_setup_reset_with_http_info(cluster_name, service_name, **kwargs)
            return data

    def hbase_replication_first_time_setup_reset_with_http_info(self, cluster_name, service_name, **kwargs):
        """
        Resets/removes the HBase replication first time setup status for the given source and target.
        Resets/removes the HBase replication first time setup status for the given source and target.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_reset_with_http_info(cluster_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hbase_replication_first_time_setup_reset" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `hbase_replication_first_time_setup_reset`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `hbase_replication_first_time_setup_reset`")
        ...
        return self.api_client.call_api('/clusters/{clusterName}/services/{serviceName}/commands/hbaseReplicationFirstTimeSetupReset', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def hbase_replication_first_time_setup_status(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_status(cluster_name, service_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_name:  (required)
        :param str service_name: The local HBase service name (required)
        :param str source_cluster: The source cluster's name
        :param str source_peer: The source peer's name
        :param str source_service: The source service's name
        :return: ApiHBaseReplicationSetupStatus
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hbase_replication_first_time_setup_status_with_http_info(cluster_name, service_name, **kwargs)
        else:
            (data) = self.hbase_replication_first_time_setup_status_with_http_info(cluster_name, service_name, **kwargs)
            return data

    def hbase_replication_first_time_setup_status_with_http_info(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_first_time_setup_status_with_http_info(cluster_name, service_name, callback=callback_function)
        ...
        all_params = ['cluster_name', 'service_name', 'source_cluster', 'source_peer', 'source_service']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hbase_replication_first_time_setup_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `hbase_replication_first_time_setup_status`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `hbase_replication_first_time_setup_status`")
        ...
        query_params = []
        if 'source_cluster' in params:
            query_params.append(('sourceCluster', params['source_cluster']))
        if 'source_peer' in params:
            query_params.append(('sourcePeer', params['source_peer']))
        if 'source_service' in params:
            query_params.append(('sourceService', params['source_service']))
        ...
        return self.api_client.call_api('/clusters/{clusterName}/services/{serviceName}/commands/hbaseReplicationFirstTimeSetupStatus', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ApiHBaseReplicationSetupStatus',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def hbase_replication_setup(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_setup(cluster_name, service_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_name:  (required)
        :param str service_name: The service name. (required)
        :param bool force: If true, perform setup even if already setup. (Default false)
        :param ApiHBaseReplicationSetupCommandArgs body: 
        :return: ApiCommand
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hbase_replication_setup_with_http_info(cluster_name, service_name, **kwargs)
        else:
            (data) = self.hbase_replication_setup_with_http_info(cluster_name, service_name, **kwargs)
            return data

    def hbase_replication_setup_with_http_info(self, cluster_name, service_name, **kwargs):
        """
        Perform one time setup for HBase replication.
        Perform one time setup for HBase replication.  Generate the a keystore to HDFS for use by replication and transfer the keystore to HDFS on the the peer.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_setup_with_http_info(cluster_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hbase_replication_setup" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `hbase_replication_setup`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `hbase_replication_setup`")
        ...
        return self.api_client.call_api('/clusters/{clusterName}/services/{serviceName}/commands/hbaseReplicationSetup', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def hbase_replication_setup_admin(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_setup_admin(cluster_name, service_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_name:  (required)
        :param str service_name:  (required)
        :param str cm_peer_definition: 
        :param str op: 
        :param str path: 
        :param str user: 
        :return: ApiCommand
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hbase_replication_setup_admin_with_http_info(cluster_name, service_name, **kwargs)
        else:
            (data) = self.hbase_replication_setup_admin_with_http_info(cluster_name, service_name, **kwargs)
            return data

    def hbase_replication_setup_admin_with_http_info(self, cluster_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hbase_replication_setup_admin_with_http_info(cluster_name, service_name, callback=callback_function)
        ...
        all_params = ['cluster_name', 'service_name', 'cm_peer_definition', 'op', 'path', 'user']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hbase_replication_setup_admin" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `hbase_replication_setup_admin`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `hbase_replication_setup_admin`")
        ...
        query_params = []
        if 'cm_peer_definition' in params:
            query_params.append(('cmPeerDefinition', params['cm_peer_definition']))
        if 'op' in params:
            query_params.append(('op', params['op']))
        if 'path' in params:
            query_params.append(('path', params['path']))
        if 'user' in params:
        ...
        return self.api_client.call_api('/clusters/{clusterName}/services/{serviceName}/commands/hbaseReplicationSetupAdmin', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
