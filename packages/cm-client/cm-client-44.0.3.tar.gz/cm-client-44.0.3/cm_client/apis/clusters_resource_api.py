...
class ClustersResourceApi(object):
    ...
    def read_clusters(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_type: Type of cluster, either \"any\", \"base\", \"compute\" or \"experience\". Default is \"base\".
        :param str view: The view of the data to materialize, either \"summary\" or \"full\".
        :return: ApiClusterList
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def tear_down_workload_cluster(self, cluster_name, workload_cluster_name, **kwargs):
        """
        Tear Down Workload cluster.
        Tear Down Workload cluster. <p> Tear Down Ranger plugin service (repository) associated with the workload cluster.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.tear_down_workload_cluster(cluster_name, workload_cluster_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str cluster_name: The name of the cluster. (required)
        :param str workload_cluster_name: The name of the workload cluster. (required)
        :return: ApiCommand
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.tear_down_workload_cluster_with_http_info(cluster_name, workload_cluster_name, **kwargs)
        else:
            (data) = self.tear_down_workload_cluster_with_http_info(cluster_name, workload_cluster_name, **kwargs)
            return data

    def tear_down_workload_cluster_with_http_info(self, cluster_name, workload_cluster_name, **kwargs):
        """
        Tear Down Workload cluster.
        Tear Down Workload cluster. <p> Tear Down Ranger plugin service (repository) associated with the workload cluster.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.tear_down_workload_cluster_with_http_info(cluster_name, workload_cluster_name, callback=callback_function)
        ...
        all_params = ['cluster_name', 'workload_cluster_name']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tear_down_workload_cluster" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `tear_down_workload_cluster`")
        # verify the required parameter 'workload_cluster_name' is set
        if ('workload_cluster_name' not in params) or (params['workload_cluster_name'] is None):
            raise ValueError("Missing the required parameter `workload_cluster_name` when calling `tear_down_workload_cluster`")
        ...
        if 'cluster_name' in params:
            path_params['clusterName'] = params['cluster_name']
        if 'workload_cluster_name' in params:
            path_params['workloadClusterName'] = params['workload_cluster_name']
        ...
        return self.api_client.call_api('/clusters/{clusterName}/commands/tearDownWorkload/{workloadClusterName}', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
