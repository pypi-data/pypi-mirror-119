...
class ClouderaManagerResourceApi(object):
    ...
    def get_deployment2(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str view: May be one of \"export\" (default) or \"export_redacted\".  The latter replaces configurations that are sensitive with the word \"REDACTED\". Other filter options are not supported.
    ...
    def hosts_offline_or_decommission_command(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int offline_timeout: offline timeout in seconds. Specify as null to get the default timeout (4 hours). Ignored if service does not support he offline operation.
    ...
    def import_kerberos_principal(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int kvno: Key-version number of the password.  return Information about the submitted command.
    ...
    def test_external_authentication(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.test_external_authentication(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param ApiTestCmExternalAuthArguments body: 
        :return: ApiCommand
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.test_external_authentication_with_http_info(**kwargs)
        else:
            (data) = self.test_external_authentication_with_http_info(**kwargs)
            return data

    def test_external_authentication_with_http_info(self, **kwargs):
        """
        Launches a command to test the currently configured external authentication.
        Launches a command to test the currently configured external authentication
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.test_external_authentication_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method test_external_authentication" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/cm/commands/testExternalAuthentication', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
