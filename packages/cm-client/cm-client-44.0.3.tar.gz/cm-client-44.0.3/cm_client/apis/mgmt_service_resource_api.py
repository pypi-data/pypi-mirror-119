...
class MgmtServiceResourceApi(object):
    """
    ...
    def auto_assign_roles_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/autoAssignRoles', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def auto_configure_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/autoConfigure', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_cms(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_cms(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_cms_with_http_info(**kwargs)
        else:
            (data) = self.delete_cms_with_http_info(**kwargs)
            return data

    def delete_cms_with_http_info(self, **kwargs):
        """
        Delete the Cloudera Management Services.
        Delete the Cloudera Management Services. <p> This method will fail if a CMS instance doesn't already exist.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_cms_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/cm/service', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def enter_maintenance_mode_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/commands/enterMaintenanceMode', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def exit_maintenance_mode_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/commands/exitMaintenanceMode', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_active_commands_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/commands', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_role_types_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/roleTypes', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def read_service_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def read_service_config_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/config', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def restart_command_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/commands/restart', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def setup_cms(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.setup_cms(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.setup_cms_with_http_info(**kwargs)
        else:
            (data) = self.setup_cms_with_http_info(**kwargs)
            return data

    def setup_cms_with_http_info(self, **kwargs):
        """
        Setup the Cloudera Management Services.
        Setup the Cloudera Management Services. <p> Configure the CMS instance and create all the management roles. The provided configuration data can be used to set up host mappings for each role, and required configuration such as database connection information for specific roles. <p> Regardless of the list of roles provided in the input data, all management roles are created by this call. The input is used to override any default settings for the specific roles. <p> This method needs a valid CM license to be installed beforehand. <p> This method does not start any services or roles. <p> This method will fail if a CMS instance already exists. <p> Available role types: <ul> <li>SERVICEMONITOR</li> <li>ACTIVITYMONITOR</li> <li>HOSTMONITOR</li> <li>REPORTSMANAGER</li> <li>EVENTSERVER</li> <li>ALERTPUBLISHER</li> <li>NAVIGATOR</li> <li>NAVIGATORMETASERVER</li> </ul>  <p/> REPORTSMANAGER, NAVIGATOR and NAVIGATORMETASERVER are only available with Cloudera Manager Enterprise Edition.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.setup_cms_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/cm/service', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def start_command_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/commands/start', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def stop_command_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/commands/stop', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_service_config_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/cm/service/config', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
