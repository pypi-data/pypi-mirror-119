...
from cm_client.models.api_parcel import ApiParcel


class TestApiParcel(unittest.TestCase):
    """ ApiParcel unit test stubs """
    ...
    def testApiParcel(self):
        """
        Test ApiParcel
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = cm_client.models.api_parcel.ApiParcel()
        pass
