...
class TestApiTimeSeriesData(unittest.TestCase):
    """ ApiTimeSeriesData unit test stubs """
    ...
    def testApiTimeSeriesData(self):
        """
        Test ApiTimeSeriesData
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = cm_client.models.api_time_series_data.ApiTimeSeriesData()
        pass
