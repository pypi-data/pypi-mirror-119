...
class TestReplicationsResourceApi(unittest.TestCase):
    ...
    def test_reschedule_hive3_replication_metrics_getter(self):
        """
        Test case for reschedule_hive3_replication_metrics_getter
    ...
    def test_run_h_base_replication_security_tool(self):
        """
        Test case for run_h_base_replication_security_tool

        Run the hbase replication security tool.
        """
        pass

    def test_run_hive_replication_query(self):
        """
        Test case for run_hive_replication_query
