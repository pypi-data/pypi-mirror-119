...
from cm_client.apis.batch_resource_api import BatchResourceApi


class TestBatchResourceApi(unittest.TestCase):
    """ BatchResourceApi unit test stubs """

    def setUp(self):
        self.api = cm_client.apis.batch_resource_api.BatchResourceApi()
