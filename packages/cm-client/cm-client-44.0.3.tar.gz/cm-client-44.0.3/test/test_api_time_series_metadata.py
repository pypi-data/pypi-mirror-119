...
class TestApiTimeSeriesMetadata(unittest.TestCase):
    """ ApiTimeSeriesMetadata unit test stubs """
    ...
    def testApiTimeSeriesMetadata(self):
        """
        Test ApiTimeSeriesMetadata
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = cm_client.models.api_time_series_metadata.ApiTimeSeriesMetadata()
        pass
