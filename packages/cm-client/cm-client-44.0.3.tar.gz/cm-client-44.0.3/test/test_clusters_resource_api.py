...
class TestClustersResourceApi(unittest.TestCase):
    ...
    def test_get_ozone_s3_gateway_info(self):
        """
        Test case for get_ozone_s3_gateway_info
    ...
    def test_tear_down_workload_cluster(self):
        """
        Test case for tear_down_workload_cluster
