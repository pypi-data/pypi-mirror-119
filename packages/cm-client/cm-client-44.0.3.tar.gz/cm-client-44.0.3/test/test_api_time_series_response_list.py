...
class TestApiTimeSeriesResponseList(unittest.TestCase):
    """ ApiTimeSeriesResponseList unit test stubs """
    ...
    def testApiTimeSeriesResponseList(self):
        """
        Test ApiTimeSeriesResponseList
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = cm_client.models.api_time_series_response_list.ApiTimeSeriesResponseList()
        pass
