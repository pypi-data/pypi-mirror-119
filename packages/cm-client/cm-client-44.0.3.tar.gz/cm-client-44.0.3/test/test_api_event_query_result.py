...
class TestApiEventQueryResult(unittest.TestCase):
    """ ApiEventQueryResult unit test stubs """
    ...
    def testApiEventQueryResult(self):
        """
        Test ApiEventQueryResult
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = cm_client.models.api_event_query_result.ApiEventQueryResult()
        pass
