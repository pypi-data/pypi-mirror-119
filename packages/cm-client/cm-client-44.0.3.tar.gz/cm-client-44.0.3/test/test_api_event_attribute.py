...
class TestApiEventAttribute(unittest.TestCase):
    """ ApiEventAttribute unit test stubs """
    ...
    def testApiEventAttribute(self):
        """
        Test ApiEventAttribute
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = cm_client.models.api_event_attribute.ApiEventAttribute()
        pass
