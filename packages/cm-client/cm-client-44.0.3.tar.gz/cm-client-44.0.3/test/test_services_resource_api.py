...
class TestServicesResourceApi(unittest.TestCase):
    ...
    def test_copy_hdfs_file(self):
        """
        Test case for copy_hdfs_file
    ...
    def test_create_hdfs_file(self):
        """
        Test case for create_hdfs_file
    ...
    def test_create_hive_warehouse_external_command(self):
        """
        Test case for create_hive_warehouse_external_command
    ...
    def test_export_sentry_permissions_command(self):
        """
        Test case for export_sentry_permissions_command
    ...
    def test_hbase_replication_first_time_setup_automatic(self):
        """
        Test case for hbase_replication_first_time_setup_automatic

        Starts an automatic HBase replication first time setup.
        """
        pass

    def test_hbase_replication_first_time_setup_force_ready(self):
        """
        Test case for hbase_replication_first_time_setup_force_ready

        Force sets the HBase replication first time setup status to be READY for the given source and target.
        """
        pass

    def test_hbase_replication_first_time_setup_manual(self):
        """
        Test case for hbase_replication_first_time_setup_manual

        Starts a manual HBase replication first time setup.
        """
        pass

    def test_hbase_replication_first_time_setup_manual_continue(self):
        """
        Test case for hbase_replication_first_time_setup_manual_continue
    ...
    def test_hbase_replication_first_time_setup_reset(self):
        """
        Test case for hbase_replication_first_time_setup_reset

        Resets/removes the HBase replication first time setup status for the given source and target.
        """
        pass

    def test_hbase_replication_first_time_setup_status(self):
        """
        Test case for hbase_replication_first_time_setup_status

        
        """
        pass

    def test_hbase_replication_setup(self):
        """
        Test case for hbase_replication_setup

        Perform one time setup for HBase replication.
        """
        pass

    def test_hbase_replication_setup_admin(self):
        """
        Test case for hbase_replication_setup_admin
