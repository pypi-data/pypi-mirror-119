...
class TestApiTimeSeriesResponse(unittest.TestCase):
    """ ApiTimeSeriesResponse unit test stubs """
    ...
    def testApiTimeSeriesResponse(self):
        """
        Test ApiTimeSeriesResponse
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = cm_client.models.api_time_series_response.ApiTimeSeriesResponse()
        pass
