...
def run_time(func: FunctionType):
    r"""
    A python decorator.
    Runs the given function and returns the running time and results at the same time.

    Args:
        func (FunctionType): The function to run.

    Returns:
        cost_time (float): The running time, measured by second.
