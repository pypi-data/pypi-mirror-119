...
def pointmerge(bm: bmesh.types.BMesh, verts: typing.List[typing.Any], merge_co: mathutils.Vector) -> None:
...
def create_vert(bm: bmesh.types.BMesh, co: mathutils.Vector) -> typing.Dict[str, typing.Any]:
...
def rotate(bm: bmesh.types.BMesh, cent: mathutils.Vector, matrix: mathutils.Matrix, verts: typing.List[typing.Any], space: mathutils.Matrix, use_shapekey: bool) -> None:
...
def translate(bm: bmesh.types.BMesh, vec: mathutils.Vector, space: mathutils.Matrix, verts: typing.List[typing.Any], use_shapekey: bool) -> None:
...
def scale(bm: bmesh.types.BMesh, vec: mathutils.Vector, space: mathutils.Matrix, verts: typing.List[typing.Any], use_shapekey: bool) -> None:
...
def bisect_plane(bm: bmesh.types.BMesh, geom: typing.List[typing.Any], dist: float, plane_co: mathutils.Vector, plane_no: mathutils.Vector, use_snap_center: bool, clear_outer: bool, clear_inner: bool) -> typing.Dict[str, typing.Any]:
...
def spin(bm: bmesh.types.BMesh, geom: typing.List[typing.Any], cent: mathutils.Vector, axis: mathutils.Vector, dvec: mathutils.Vector, angle: float, space: mathutils.Matrix, steps: int, use_merge: bool, use_normal_flip: bool, use_duplicate: bool) -> typing.Dict[str, typing.Any]:
...
def create_uvsphere(bm: bmesh.types.BMesh, u_segments: int, v_segments: int, diameter: float, matrix: mathutils.Matrix, calc_uvs: bool) -> typing.Dict[str, typing.Any]:
...
def create_icosphere(bm: bmesh.types.BMesh, subdivisions: int, diameter: float, matrix: mathutils.Matrix, calc_uvs: bool) -> typing.Dict[str, typing.Any]:
...
def create_cone(bm: bmesh.types.BMesh, cap_ends: bool, cap_tris: bool, segments: int, diameter1: float, diameter2: float, depth: float, matrix: mathutils.Matrix, calc_uvs: bool) -> typing.Dict[str, typing.Any]:
...
def triangle_fill(bm: bmesh.types.BMesh, use_beauty: bool, use_dissolve: bool, edges: typing.List[typing.Any], normal: mathutils.Vector) -> typing.Dict[str, typing.Any]:
