...
class GPUTexture:
  ...
  def __init__(self, size: typing.Tuple[typing.Any, ...], layers: int = 0, is_cubemap: int = False, format: str = 'RGBA8', data: Buffer = None) -> None:
...
class GPUVertBuf:
  ...
  def attr_fill(self, id: int, data: typing.Sequence[float]) -> None:
