...
:class:`KX_GameObject <bge.types.KX_GameObject>`) one unit up.
...
a :class:`SCA_PythonController <bge.types.SCA_PythonController>` logic brick.
...
Obtained through :class:`BL_ArmatureObject <bge.types.BL_ArmatureObject>`.constraints.
  ...
  This name is also the key subscript on :class:`BL_ArmatureObject <bge.types.BL_ArmatureObject>`.
...
This header set the ``#version`` directive, so the user must not define his own *#version*.
  ...
  objectCallbacks: typing.List[typing.Callable] = ...
...
All the functions can expect as argument the object currently rendered.
  ...
  bindCallbacks: typing.List[typing.Callable] = ...
  ...
  def setAttrib(self, enum: int) -> None:
  ...
  def setSource(self, vertexProgram: str, fragmentProgram: str, apply: bool) -> None:
  ...
  def setSourceList(self, sources: typing.Dict[str, typing.Any], apply: bool) -> None:
  ...
  def setUniformMatrix3(self, name: str, mat: typing.Any, transpose: bool) -> None:
  ...
  def setUniformMatrix4(self, name: str, mat: typing.Any, transpose: bool) -> None:
  ...
  def setUniformEyef(self, name: str) -> None:
...
class KX_BlenderMaterial(EXP_PyObjectPlus):
  ...
  :class:`Material <bpy.types.Material>` corresponding to this KX_BlenderMaterial (read only).
...
The callbacks can take as argument the rendered camera, the camera could be temporary in case of stereo rendering.
  ...
  def addObject(self, object: KX_GameObject, reference: KX_GameObject, time: float = 0.0, dupli: bool = False) -> KX_GameObject:
...
class KX_2DFilter(BL_Shader):
  ...
  2D filter shader object. Can be alterated with :class:`BL_Shader <bge.types.BL_Shader>`'s functions.
  ...
  offScreen: KX_2DFilterOffScreen = ...
...
should be followed by a call to :data:`BL_Shader.setSampler <bge.types.BL_Shader.setSampler>` with the same :data:`index` if :data:`sampleName` is not specified.
  ...
  def addOffScreen(self, slots: int, width: int = -1, height: int = -1, mipmap: bool = False) -> None:
...
class KX_MeshProxy(EXP_Value):
  ...
  The correct method of iterating over every :class:`KX_VertexProxy <bge.types.KX_VertexProxy>` in a game object
  ...
  def transform(self, matid: int, matrix: typing.Any) -> None:
  ...
  def transformUV(self, matid: int, matrix: typing.Any, uv_index: int = -1, uv_index_from: int = -1) -> None:
...
and :data:`logicCulling` set to *True*.
  ...
  childrenRecursive: EXP_ListValue = ...
...
and can be optionally overridden as below:
  ...
  def replaceMesh(self, mesh: KX_MeshProxy, useDisplayMesh: bool = True, usePhysicsMesh: bool = False) -> None:
...
Control the shape status with the optional compound and ghost parameters:
  ...
  def getVectTo(self, other: KX_GameObject) -> typing.Any:
...
This index and the ones returned by getVertexIndex() are needed to retrieve the vertex proxy from :class:`KX_MeshProxy <bge.types.KX_MeshProxy>`.
...
This index and the one returned by getMaterialIndex() are needed to retrieve the vertex proxy from :class:`KX_MeshProxy <bge.types.KX_MeshProxy>`.
...
set to :data:`RAS_2DFILTER_DISABLED <bge.logic.RAS_2DFILTER_DISABLED>` or :data:`RAS_2DFILTER_NOFILTER <bge.logic.RAS_2DFILTER_NOFILTER>`.
...
class SCA_ArmatureActuator(SCA_IActuator):
  ...
  Note: A weight of 0 disables a constraint while still updating constraint runtime values (see :class:`BL_ArmatureConstraint <bge.types.BL_ArmatureConstraint>`)
...
class SCA_ReplaceMeshActuator(SCA_IActuator):
  ...
  :class:`KX_MeshProxy <bge.types.KX_MeshProxy>` or the name of the mesh that will replace the current one.
...
class SCA_SceneActuator(SCA_IActuator):
  ...
  Note: When setting the attribute, you can use either a :class:`KX_Camera <bge.types.KX_Camera>` or the name of the camera.
...
based on it's sensors.
  ...
  * Module: 1, Execite the :attr:`script` as a module and function.
  ...
  def activate(self, actuator: typing.Any) -> None:
  ...
  def deactivate(self, actuator: typing.Any) -> None:
...
levels of detail decrease.
  ...
  def getCameraToWorld(self) -> typing.Any:
  ...
  def getWorldToCamera(self) -> typing.Any:
...
class KX_FontObject(KX_GameObject):
  ...
  It is possible to use attributes from :type: :class:`TextCurve <bpy.types.TextCurve>`
