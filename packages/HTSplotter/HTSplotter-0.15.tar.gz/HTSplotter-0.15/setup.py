...
setup(
  ...
  download_url = 'https://github.com/CBIGR/HTSplotter/archive/refs/tags/HTSplotter_v0.15.tar.gz',    # I explain this later on
  keywords = ['High-throughput screening', 'drug combination',
              'genetic-chemical perturbation', 'dose-response', 'HTS', 'Bliss', 'synergism',
              'antagonism'],   # Keywords that define your package best
