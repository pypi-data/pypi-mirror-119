...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '3.0.0-alpha.1631186474+be2c5b05'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 3.0.0-alpha.1631186474+be2c5b05`
                """)
            else:
                raise
