...
class BroadsignClient(Client):
    ...
    def get_screen(self, last_modified=None, page=None):
        """Retrieve a page of screens from Broadsign

        Parameters:
            last modified: date
                The permission the company should have.
            page: int
                The campaign entity the company should permission for. If this parameter is None,
