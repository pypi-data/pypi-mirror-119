...
class vectoritkImageSSRTF22(collections.abc.MutableSequence):
    r"""Proxy of C++ std::vector< itkImageSSRTF22_Pointer > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22___nonzero__)
    __bool__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22___bool__)
    __len__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22___len__)
    __getslice__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22___getslice__)
    __setslice__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22___setslice__)
    __delslice__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22___delslice__)
    __delitem__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22___delitem__)
    __getitem__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22___getitem__)
    __setitem__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22___setitem__)
    pop = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_pop)
    append = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_append)
    empty = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_empty)
    size = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_size)
    swap = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_swap)
    begin = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_begin)
    end = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_end)
    rbegin = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_rbegin)
    rend = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_rend)
    clear = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_clear)
    get_allocator = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_get_allocator)
    pop_back = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_pop_back)
    erase = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_erase)
    ...
    push_back = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_push_back)
    front = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_front)
    back = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_back)
    assign = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_assign)
    resize = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_resize)
    insert = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_insert)
    reserve = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_reserve)
    capacity = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF22_capacity)
...
class vectoritkImageSSRTF33(collections.abc.MutableSequence):
    r"""Proxy of C++ std::vector< itkImageSSRTF33_Pointer > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33___nonzero__)
    __bool__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33___bool__)
    __len__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33___len__)
    __getslice__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33___getslice__)
    __setslice__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33___setslice__)
    __delslice__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33___delslice__)
    __delitem__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33___delitem__)
    __getitem__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33___getitem__)
    __setitem__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33___setitem__)
    pop = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_pop)
    append = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_append)
    empty = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_empty)
    size = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_size)
    swap = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_swap)
    begin = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_begin)
    end = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_end)
    rbegin = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_rbegin)
    rend = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_rend)
    clear = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_clear)
    get_allocator = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_get_allocator)
    pop_back = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_pop_back)
    erase = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_erase)
    ...
    push_back = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_push_back)
    front = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_front)
    back = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_back)
    assign = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_assign)
    resize = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_resize)
    insert = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_insert)
    reserve = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_reserve)
    capacity = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF33_capacity)
...
class vectoritkImageSSRTF44(collections.abc.MutableSequence):
    r"""Proxy of C++ std::vector< itkImageSSRTF44_Pointer > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44___nonzero__)
    __bool__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44___bool__)
    __len__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44___len__)
    __getslice__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44___getslice__)
    __setslice__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44___setslice__)
    __delslice__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44___delslice__)
    __delitem__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44___delitem__)
    __getitem__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44___getitem__)
    __setitem__ = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44___setitem__)
    pop = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_pop)
    append = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_append)
    empty = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_empty)
    size = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_size)
    swap = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_swap)
    begin = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_begin)
    end = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_end)
    rbegin = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_rbegin)
    rend = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_rend)
    clear = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_clear)
    get_allocator = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_get_allocator)
    pop_back = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_pop_back)
    erase = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_erase)
    ...
    push_back = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_push_back)
    front = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_front)
    back = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_back)
    assign = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_assign)
    resize = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_resize)
    insert = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_insert)
    reserve = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_reserve)
    capacity = _swig_new_instance_method(_itkImagePython.vectoritkImageSSRTF44_capacity)
...
class itkImageSSRTF22(itkImageBase2):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImagePython.itkImageSSRTF22___New_orig__)
    Clone = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_Clone)
    Allocate = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_Allocate)
    FillBuffer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_FillBuffer)
    SetPixel = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_SetPixel)
    GetPixel = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_GetPixel)
    GetBufferPointer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_GetBufferPointer)
    GetPixelContainer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_GetPixelContainer)
    SetPixelContainer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_SetPixelContainer)
    Graft = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_Graft)
    GetPixelAccessor = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_GetPixelAccessor)
    GetNeighborhoodAccessor = _swig_new_instance_method(_itkImagePython.itkImageSSRTF22_GetNeighborhoodAccessor)
    __swig_destroy__ = _itkImagePython.delete_itkImageSSRTF22
    cast = _swig_new_static_method(_itkImagePython.itkImageSSRTF22_cast)
...
itkImageSSRTF22___New_orig__ = _itkImagePython.itkImageSSRTF22___New_orig__
itkImageSSRTF22_cast = _itkImagePython.itkImageSSRTF22_cast
...
class itkImageSSRTF33(itkImageBase3):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImagePython.itkImageSSRTF33___New_orig__)
    Clone = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_Clone)
    Allocate = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_Allocate)
    FillBuffer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_FillBuffer)
    SetPixel = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_SetPixel)
    GetPixel = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_GetPixel)
    GetBufferPointer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_GetBufferPointer)
    GetPixelContainer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_GetPixelContainer)
    SetPixelContainer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_SetPixelContainer)
    Graft = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_Graft)
    GetPixelAccessor = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_GetPixelAccessor)
    GetNeighborhoodAccessor = _swig_new_instance_method(_itkImagePython.itkImageSSRTF33_GetNeighborhoodAccessor)
    __swig_destroy__ = _itkImagePython.delete_itkImageSSRTF33
    cast = _swig_new_static_method(_itkImagePython.itkImageSSRTF33_cast)
...
itkImageSSRTF33___New_orig__ = _itkImagePython.itkImageSSRTF33___New_orig__
itkImageSSRTF33_cast = _itkImagePython.itkImageSSRTF33_cast
...
class itkImageSSRTF44(itkImageBase4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImagePython.itkImageSSRTF44___New_orig__)
    Clone = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_Clone)
    Allocate = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_Allocate)
    FillBuffer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_FillBuffer)
    SetPixel = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_SetPixel)
    GetPixel = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_GetPixel)
    GetBufferPointer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_GetBufferPointer)
    GetPixelContainer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_GetPixelContainer)
    SetPixelContainer = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_SetPixelContainer)
    Graft = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_Graft)
    GetPixelAccessor = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_GetPixelAccessor)
    GetNeighborhoodAccessor = _swig_new_instance_method(_itkImagePython.itkImageSSRTF44_GetNeighborhoodAccessor)
    __swig_destroy__ = _itkImagePython.delete_itkImageSSRTF44
    cast = _swig_new_static_method(_itkImagePython.itkImageSSRTF44_cast)
...
itkImageSSRTF44___New_orig__ = _itkImagePython.itkImageSSRTF44___New_orig__
itkImageSSRTF44_cast = _itkImagePython.itkImageSSRTF44_cast
