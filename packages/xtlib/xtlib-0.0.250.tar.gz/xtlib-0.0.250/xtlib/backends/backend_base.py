    ...
    def create_wrapper_and_inner(self, cmds, user_cmd, sudo_available, args):
        ...
        if docker_cmd:
            ...
            if not self.is_windows:
                ...
                self.append(docker_cmds, 'test $(which nvidia-docker) && export DOCKER_NAME="nvidia-docker"' + 
            ...
            if timeout:
                ...
                pull_cmd = '''timeout {} bash -c "until sudo $DOCKER_NAME pull {}; do '''.format(timeout, image_name) + \
