...
class BaseDoc:
    ...
    def _indent(self, text: str) -> str:
        ...
        # Convert width to 75 if terminal_width is larger than 75
        # (and to 1 if terminal_width is reported as 0, otherwise
        # `fill` throws an error).
        width = max(1, min(75, terminal_width))
