...
def calc_density(matrix):
    ...
    return np.count_nonzero(rem_self)/(np.prod(rem_self.shape) - rem_self.shape[0])
...
def match_density(sample_matrix, target_matrix, start_t=0.2, step=0.05, iterations=100):
