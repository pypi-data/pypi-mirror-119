...
class V1AWSClusterDriverSpec(object):
    ...
    def __init__(
        self,
        bucket_name=None,
        enable_dns_firewall=None,
        external_id=None,
        guardduty_integration=None,
        instance_types=None,
        internal_gc_ttl=None,
        internal_test_cluster=None,
        kubernetes_version=None,
        original_cluster_name=None,
        region=None,
        role_arn=None,
        x_multi_az_count=None,
        _configuration=None
    ):  # noqa: E501
    ...
    def enable_dns_firewall(self, enable_dns_firewall):
    ...
    @property
    def guardduty_integration(self):
    ...
    def guardduty_integration(self, guardduty_integration):
    ...
    def internal_gc_ttl(self, internal_gc_ttl):
    ...
    @property
    def original_cluster_name(self):
    ...
    def original_cluster_name(self, original_cluster_name):
    ...
    def x_multi_az_count(self, x_multi_az_count):
